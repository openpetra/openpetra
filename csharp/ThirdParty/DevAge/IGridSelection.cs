...
namespace SourceGrid.Selection
{
	public interface IGridSelection
	{
        ...
        // AlanP: Sep 2013  Added an optional parameter to suppress the selection_changed event
        /// <summary>
		/// Reset the selection
		/// </summary>
		void ResetSelection(bool mantainFocus, bool suppressChangeEvent = false);
        ...
        /// <returns></returns>
		bool Focus(Position pCellToActivate, bool pResetSelection, bool suppressChangeEvent = false);
