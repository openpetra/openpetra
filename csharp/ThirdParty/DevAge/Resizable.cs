...
namespace SourceGrid.Cells.Controllers
{
    ...
    public class Resizable : ControllerBase
    {
        ...
        // AlanP: Dec 2013 create a flag that is set in the MousedDown event
        private bool m_MouseDownStartedWidthResize = false;

        /// <summary>
        /// Indicates if the most recent MouseDown started a resize of coulumn width
        /// </summary>
        public bool MouseDownStartedWidthResize
        {
            get { return m_MouseDownStartedWidthResize; }
        }
