...
namespace SourceGrid.Cells.Controllers
{
	...
	public class MouseSelection : ControllerBase
	{
		...
		public override void OnMouseMove(CellContext sender, MouseEventArgs e)
		{
            ...
            // AlanP: Sept 2013.  Modified the equality test to be .Row-based rather than simply cell position because our activePosition is typically always column 0
			if (sender.Grid.Selection.EnableMultiSelection == false ||
			    sender.Grid.MouseDownPosition.IsEmpty() ||
			    sender.Grid.MouseDownPosition.Row != sender.Grid.Selection.ActivePosition.Row)
				return;
