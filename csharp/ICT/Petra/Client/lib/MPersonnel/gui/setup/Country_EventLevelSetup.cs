// auto generated with nant generateWinforms from Country_EventLevelSetup.yaml and template windowMaintainCachableTable
//
...
namespace Ict.Petra.Client.MPersonnel.Gui.Setup
{
  ...
  /// auto generated: Maintain Country/Event Preference Levels
  public partial class TFrmCountry_EventLevelSetup: System.Windows.Forms.Form, IFrmPetraEdit
  {
    private TFrmPetraEditUtils FPetraUtilsObject;

    private class FMainDS
    {
        public static PtXyzTbdPreferenceLevelTable PtXyzTbdPreferenceLevel;
    }
    /// constructor
    public TFrmCountry_EventLevelSetup(IntPtr AParentFormHandle) : base()
    {
      ...
      this.lblDetailCode.Text = Catalog.GetString("Level Code:");
      ...
      this.tbbNew.Text = Catalog.GetString("New Country/Event Preference Level");
      ...
      this.Text = Catalog.GetString("Maintain Country/Event Preference Levels");
      #endregion
      ...
      FPetraUtilsObject = new TFrmPetraEditUtils(AParentFormHandle, this, stbMain);
            FPetraUtilsObject.SetStatusBarText(txtDetailCode, Catalog.GetString("Level of importance of country and activity choices."));
      FPetraUtilsObject.SetStatusBarText(txtDetailDescription, Catalog.GetString("This describes the preference level code."));
    ...
    private void LoadDataAndFinishScreenSetup()
    {
      ...
      // Load Data
      FMainDS.PtXyzTbdPreferenceLevel = new PtXyzTbdPreferenceLevelTable();
      DataTable CacheDT = TDataCache.GetCacheableDataTableFromCache("XyzTbdPreferenceLevelList", String.Empty, null, out DataTableType);
      FMainDS.PtXyzTbdPreferenceLevel.Merge(CacheDT);

      grdDetails.Columns.Clear();
      grdDetails.AddTextColumn("Preference Code", FMainDS.PtXyzTbdPreferenceLevel.ColumnCode);
      grdDetails.AddTextColumn("Description", FMainDS.PtXyzTbdPreferenceLevel.ColumnDescription);
      grdDetails.AddCheckBoxColumn("Unassignable?", FMainDS.PtXyzTbdPreferenceLevel.ColumnUnassignableFlag);
      grdDetails.AddDateColumn("Unassignable Date", FMainDS.PtXyzTbdPreferenceLevel.ColumnUnassignableDate);
      grdDetails.AddCheckBoxColumn("Deletable", FMainDS.PtXyzTbdPreferenceLevel.ColumnDeletableFlag);

      FPetraUtilsObject.ActionEnablingEvent += ActionEnabledEvent;

      DataView myDataView = FMainDS.PtXyzTbdPreferenceLevel.DefaultView;
      myDataView.AllowNew = false;
      grdDetails.DataSource = new DevAge.ComponentModel.BoundDataView(myDataView);

      // Ensure that the Details Panel is disabled if there are no records
      if (FMainDS.PtXyzTbdPreferenceLevel.Rows.Count == 0)
      {
        ShowDetails(null);
      }
    ...
    /// automatically generated, create a new record of PtXyzTbdPreferenceLevel and display on the edit screen
    /// we create the table locally, no dataset
    public bool CreateNewPtXyzTbdPreferenceLevel()
    {
        PtXyzTbdPreferenceLevelRow NewRow = FMainDS.PtXyzTbdPreferenceLevel.NewRowTyped();
        NewRowManual(ref NewRow);
        FMainDS.PtXyzTbdPreferenceLevel.Rows.Add(NewRow);

        FPetraUtilsObject.SetChangedFlag();

        grdDetails.DataSource = new DevAge.ComponentModel.BoundDataView(FMainDS.PtXyzTbdPreferenceLevel.DefaultView);
        grdDetails.Refresh();
        SelectDetailRowByDataTableIndex(FMainDS.PtXyzTbdPreferenceLevel.Rows.Count - 1);
    ...
    private void SelectDetailRowByDataTableIndex(Int32 ARowNumberInTable)
    {
        ...
        {
            bool found = true;
            foreach (DataColumn myColumn in FMainDS.PtXyzTbdPreferenceLevel.PrimaryKey)
            {
                string value1 = FMainDS.PtXyzTbdPreferenceLevel.Rows[ARowNumberInTable][myColumn].ToString();
    ...
    private PtXyzTbdPreferenceLevelRow GetSelectedDetailRow()
    {
        DataRowView[] SelectedGridRow = grdDetails.SelectedDataRowsAsDataRowView;

        if (SelectedGridRow.Length >= 1)
        {
            return (PtXyzTbdPreferenceLevelRow)SelectedGridRow[0].Row;
        }
    ...
    private void ShowDetails(PtXyzTbdPreferenceLevelRow ARow)
    {
    ...
    private PtXyzTbdPreferenceLevelRow FPreviouslySelectedDetailRow = null;
    ...
    private void GetDetailsFromControls(PtXyzTbdPreferenceLevelRow ARow)
    {
        if (ARow != null)
        {
...
//TODO?  still needed?      FMainDS.AApDocument.Rows[0].BeginEdit();
        ...
        {
            foreach (DataRow InspectDR in FMainDS.PtXyzTbdPreferenceLevel.Rows)
            {
                InspectDR.EndEdit();
            }
            ...
            else
            {
                ...
                Ict.Common.Data.TTypedDataTable SubmitDT = FMainDS.PtXyzTbdPreferenceLevel.GetChangesTyped();
                ...
                try
                {
                    SubmissionResult = TDataCache.SaveChangedCacheableDataTableToPetraServer("XyzTbdPreferenceLevelList", ref SubmitDT, out VerificationResult);
                }
...
*/
                ...
                switch (SubmissionResult)
                {
                    case TSubmitChangesResult.scrOK:
                        ...
                        FMainDS.PtXyzTbdPreferenceLevel.AcceptChanges();

                        // Merge back with data from the Server (eg. for getting Sequence values)
                        FMainDS.PtXyzTbdPreferenceLevel.Merge(SubmitDT, false);
