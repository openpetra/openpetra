// auto generated with nant generateWinforms from PassportTypeSetup.yaml and template windowMaintainCachableTable
//
...
namespace Ict.Petra.Client.MPersonnel.Gui.Setup
{
  ...
  /// auto generated: Maintain Passport Types
  public partial class TFrmPassportTypeSetup: System.Windows.Forms.Form, IFrmPetraEdit
  {
    private TFrmPetraEditUtils FPetraUtilsObject;

    private class FMainDS
    {
        public static PtPassportTypeTable PtPassportType;
    }
    /// constructor
    public TFrmPassportTypeSetup(IntPtr AParentFormHandle) : base()
    {
      ...
      this.lblDetailCode.Text = Catalog.GetString("Passport Type:");
      ...
      this.tbbNew.Text = Catalog.GetString("New Passport Type");
      ...
      this.Text = Catalog.GetString("Maintain Passport Types");
      #endregion
      ...
      FPetraUtilsObject = new TFrmPetraEditUtils(AParentFormHandle, this, stbMain);
            FPetraUtilsObject.SetStatusBarText(txtDetailCode, Catalog.GetString("This code indicates the type of passport a person holds."));
      FPetraUtilsObject.SetStatusBarText(txtDetailDescription, Catalog.GetString("This describes the passport type."));
    ...
    private void LoadDataAndFinishScreenSetup()
    {
      ...
      // Load Data
      FMainDS.PtPassportType = new PtPassportTypeTable();
      DataTable CacheDT = TDataCache.GetCacheableDataTableFromCache("PassportTypeList", String.Empty, null, out DataTableType);
      ...
      grdDetails.AddCheckBoxColumn("Deletable", FMainDS.PtPassportType.ColumnDeletableFlag);

      FPetraUtilsObject.ActionEnablingEvent += ActionEnabledEvent;

      DataView myDataView = FMainDS.PtPassportType.DefaultView;
      myDataView.AllowNew = false;
      grdDetails.DataSource = new DevAge.ComponentModel.BoundDataView(myDataView);

      // Ensure that the Details Panel is disabled if there are no records
      if (FMainDS.PtPassportType.Rows.Count == 0)
      {
        ShowDetails(null);
      }
    ...
    /// automatically generated, create a new record of PtPassportType and display on the edit screen
    /// we create the table locally, no dataset
    public bool CreateNewPtPassportType()
    {
        PtPassportTypeRow NewRow = FMainDS.PtPassportType.NewRowTyped();
        NewRowManual(ref NewRow);
        FMainDS.PtPassportType.Rows.Add(NewRow);

        FPetraUtilsObject.SetChangedFlag();

        grdDetails.DataSource = new DevAge.ComponentModel.BoundDataView(FMainDS.PtPassportType.DefaultView);
        grdDetails.Refresh();
        SelectDetailRowByDataTableIndex(FMainDS.PtPassportType.Rows.Count - 1);
    ...
    private void SelectDetailRowByDataTableIndex(Int32 ARowNumberInTable)
    {
        ...
        {
            bool found = true;
            foreach (DataColumn myColumn in FMainDS.PtPassportType.PrimaryKey)
            {
                string value1 = FMainDS.PtPassportType.Rows[ARowNumberInTable][myColumn].ToString();
    ...
    private PtPassportTypeRow GetSelectedDetailRow()
    {
        DataRowView[] SelectedGridRow = grdDetails.SelectedDataRowsAsDataRowView;

        if (SelectedGridRow.Length >= 1)
        {
            return (PtPassportTypeRow)SelectedGridRow[0].Row;
        }
    ...
    private void ShowDetails(PtPassportTypeRow ARow)
    {
    ...
    private PtPassportTypeRow FPreviouslySelectedDetailRow = null;
    ...
    private void GetDetailsFromControls(PtPassportTypeRow ARow)
    {
        if (ARow != null)
        {
...
//TODO?  still needed?      FMainDS.AApDocument.Rows[0].BeginEdit();
        ...
        {
            foreach (DataRow InspectDR in FMainDS.PtPassportType.Rows)
            {
                InspectDR.EndEdit();
            }
            ...
            else
            {
                ...
                Ict.Common.Data.TTypedDataTable SubmitDT = FMainDS.PtPassportType.GetChangesTyped();
                ...
                try
                {
                    SubmissionResult = TDataCache.SaveChangedCacheableDataTableToPetraServer("PassportTypeList", ref SubmitDT, out VerificationResult);
                }
...
*/
                ...
                switch (SubmissionResult)
                {
                    case TSubmitChangesResult.scrOK:
                        ...
                        FMainDS.PtPassportType.AcceptChanges();

                        // Merge back with data from the Server (eg. for getting Sequence values)
                        FMainDS.PtPassportType.Merge(SubmitDT, false);
