// auto generated with nant generateWinforms from UC_PartnerDetails_Bank.yaml and template usercontrol
//
...
namespace Ict.Petra.Client.MPartner.Gui
{
  ...
  public partial class TUC_PartnerDetails_Bank: System.Windows.Forms.UserControl, Ict.Petra.Client.CommonForms.IFrmPetra
  {
    ...
    /// constructor
    public TUC_PartnerDetails_Bank() : base()
    {
      //
      ...
      this.lblBIC.Text = Catalog.GetString("BIC/SWIFT Code:");
      this.lblEPFormatFile.Text = Catalog.GetString("EP Format File:");
      ...
      this.txtBranchCode.Font = TAppSettingsManager.GetDefaultBoldFont();
      this.txtBIC.Font = TAppSettingsManager.GetDefaultBoldFont();
      this.txtEPFormatFile.Font = TAppSettingsManager.GetDefaultBoldFont();
    }
    ...
    public void InitUserControl()
    {
        ...
        FPetraUtilsObject.SetStatusBarText(txtBranchCode, Catalog.GetString("The bank code/branch code/sort code (synonymous country-specific terms) for identifying a bank branch with a number/code."));
    ...
    private void ShowData(PBankRow ARow)
    {
        ...
        if (ARow.IsBranchCodeNull())
        {
            txtBranchCode.Text = String.Empty;
        }
        else
        {
            txtBranchCode.Text = ARow.BranchCode;
        }
    ...
    private void GetDataFromControls(PBankRow ARow)
    {
        ...
        {
            ARow.SetBranchCodeNull();
        }
        else
        {
            ARow.BranchCode = txtBranchCode.Text;
        }
        if ((FMainDS.PPartner != null) && (FMainDS.PPartner.Rows.Count > 0))
        {
