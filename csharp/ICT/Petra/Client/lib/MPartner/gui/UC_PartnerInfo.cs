...
//                             "; PartnerInfoScope: " + FPartnerInfoScope.ToString("G"));
        ...
        public TUC_PartnerInfo()
        {
            ...
            this.txtFax.Text = Catalog.GetString("0732 / 12345 Ext. 78");
            ...
            this.txtAlternate.Text = Catalog.GetString("0732 / 2345678");
            this.txtEmail.Text = Catalog.GetString("hans-peter@testinger.com");
            this.lblLocationType.Text = Catalog.GetString("Location Type:");
            this.txtLocationType.Text = Catalog.GetString("HOME");
            this.txtMobile.Text = Catalog.GetString("0699 / 107223892");
            this.lblMailingAddress.Text = Catalog.GetString("Mailing Addr.:");
            this.txtMailingAddress.Text = Catalog.GetString("Yes");
            this.lblUrl.Text = Catalog.GetString("URL:");
            this.txtUrl.Text = Catalog.GetString("http://www.testinger.com");
            this.lblValidFrom.Text = Catalog.GetString("Valid From:");
            this.txtValidFrom.Text = Catalog.GetString("31-JUL-2000");
            this.lblValidTo.Text = Catalog.GetString("Valid To:");
            this.txtValidTo.Text = Catalog.GetString("30-DEC-2008");
            this.txtTelephone.Text = Catalog.GetString("0732 / 12345 Ext. 56");
            ...
            this.txtSpecialTypes.Text = Catalog.GetString("WORKER, AIRMILES");
            this.lblSpecialTypes.Text = Catalog.GetString("Special Types:");
            this.txtSubscriptions.Text = Catalog.GetString("GLOBAL, INDIA, CURRENTS, MONTHLY, VERWER");
            ...
            this.txtNotes.Text = Catalog.GetString("This is a Very Important Partner. Very pleasant to speak to.");
            this.pnlOtherInfo.Text = Catalog.GetString("Other Information:");
            this.txtPreviousName.Text = Catalog.GetString("My previous name");
            ...
            this.txtField.Text = Catalog.GetString("Austria");
            this.lblField.Text = Catalog.GetString("Field:");
            this.txtPartnerUpdated.Text = Catalog.GetString("31-JUN-2000");
            ...
            this.txtLanguages.Text = Catalog.GetString("German, English, Ukrainian, Mandarin");
            this.txtLastContact.Text = Catalog.GetString("31-JUN-2008");
            this.tbpPersonFamily.Text = Catalog.GetString("Person / Family");
            this.txtFamily.Text = Catalog.GetString("Testinger, A   [0123456789]");
            this.lblFamily.Text = Catalog.GetString("Family:");
            this.txtDateOfBirth.Text = Catalog.GetString("31-JUL-2000");
            this.lblDateOfBirth.Text = Catalog.GetString("Date of Birth:");
            this.lblFamilyMembers.Text = Catalog.GetString("Family Members:");
            this.txtPartnerName.Text = Catalog.GetString("Testinger, Hans-Peter, Mr   (PERSON)");
            this.txtPartnerKey.LabelText = Catalog.GetString("Markus\' World");
            this.txtStatusCode.Text = Catalog.GetString("PRIVATE {MARLENE}");
