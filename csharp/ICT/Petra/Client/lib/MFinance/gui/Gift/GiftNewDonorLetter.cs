// auto generated with nant generateWinforms from GiftNewDonorLetter.yaml and template windowBrowsePrint
//
...
namespace Ict.Petra.Client.MFinance.Gui.Gift
{
  ...
  public partial class TFrmGiftNewDonorLetter: System.Windows.Forms.Form, Ict.Petra.Client.CommonForms.IFrmPetra
  {
    ...
    /// constructor
    public TFrmGiftNewDonorLetter(IntPtr AParentFormHandle) : base()
    {
      //
      ...
      this.lblPublicationCode.Text = Catalog.GetString("Publication Code:");
      ...
      this.tbbCreateExtract.Text = Catalog.GetString("Create Extract");
      this.tbbAddContactHistory.Text = Catalog.GetString("Add Contact History");
      ...
      this.txtPublicationCode.Font = TAppSettingsManager.GetDefaultBoldFont();
...
#region Action Handling
    ...
    public void ActionEnabledEvent(object sender, ActionEventArgs e)
    {
        ...
        if (e.ActionName == "actCreateExtract")
        {
            tbbCreateExtract.Enabled = e.Enabled;
        }
        if (e.ActionName == "actAddContactHistory")
        {
            tbbAddContactHistory.Enabled = e.Enabled;
        }
