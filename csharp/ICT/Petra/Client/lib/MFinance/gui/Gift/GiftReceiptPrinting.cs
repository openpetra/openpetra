// auto generated with nant generateWinforms from GiftReceiptPrinting.yaml and template windowPrint
//
...
namespace Ict.Petra.Client.MFinance.Gui.Gift
{
  ...
  /// auto generated: Print Annual Gift Receipts
  public partial class TFrmGiftReceiptPrinting: System.Windows.Forms.Form, Ict.Petra.Client.CommonForms.IFrmPetra
  {
    private Ict.Petra.Client.CommonForms.TFrmPetraUtils FPetraUtilsObject;

    /// constructor
    public TFrmGiftReceiptPrinting(IntPtr AParentFormHandle) : base()
    {
      //
      ...
      this.Text = Catalog.GetString("Print Annual Gift Receipts");
      #endregion
