...
namespace Ict.Petra.Client.MFinance.Gui.GL
{
    public partial class TUC_GLAttributes
    {
        ...
        {
        	if (ARow == null) return;
        	String sSave= cmbDetailAnalysisAttributeValue.GetSelectedString();
            ...
            cmbDetailAnalysisAttributeValue.SetSelectedString(sSave);
        ...
        public void CheckAnalysisAttributes(String AAccount)
        {
        	...
        	while (i<ANView.Count)
        	{
        		...
        		ATransAnalAttribRow myTableRow= (ATransAnalAttribRow)FMainDS.ATransAnalAttrib.Rows.Find(new object[] { FLedgerNumber, FBatchNumber, FJournalNumber, FTransactionNumber, TypeCode });
        		if (myTableRow == null)
        		{
        ...
        public void DeleteTransactionAttributes(ATransactionRow trans)
        {
            if (trans == null)
            {
                return;
            }
            foreach(ATransAnalAttribRow row in FMainDS.ATransAnalAttrib.DefaultView)
            {
            	row.Delete();
            }
            FPetraUtilsObject.SetChangedFlag();
