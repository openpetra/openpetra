// auto generated with nant generateWinforms from GLBatchExport.yaml
//
...
namespace Ict.Petra.Client.MFinance.Gui.GL
{
  ...
  /// auto generated: Export Batches
  public partial class TFrmGLBatchExport: System.Windows.Forms.Form, Ict.Petra.Client.CommonForms.IFrmPetra
  {
    private Ict.Petra.Client.CommonForms.TFrmPetraUtils FPetraUtilsObject;

    /// constructor
    public TFrmGLBatchExport(IntPtr AParentFormHandle) : base()
    {
      //
      ...
      this.Text = Catalog.GetString("Export Batches");
      #endregion
