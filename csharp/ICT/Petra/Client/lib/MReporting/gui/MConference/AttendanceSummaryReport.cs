...
namespace Ict.Petra.Client.MReporting.Gui.MConference
{
  ...
  /// </summary>
  public partial class TFrmAttendanceSummaryReport: System.Windows.Forms.Form, IFrmReporting
  {
    ...
    /// constructor
    /// </summary>
    public TFrmAttendanceSummaryReport(IntPtr AParentFormHandle) : base()
    {
      //
      ...
      this.Text = Catalog.GetString("Attendance Summary Report");
      #endregion

      FPetraUtilsObject = new TFrmPetraReportingUtils(AParentFormHandle, this, stbMain);

      FPetraUtilsObject.FXMLFiles = "Conference\\\\attendancesummaryreport.xml";
      FPetraUtilsObject.FReportName = "Attendance Summary Report";
      FPetraUtilsObject.FCurrentReport = "Attendance Summary Report";
