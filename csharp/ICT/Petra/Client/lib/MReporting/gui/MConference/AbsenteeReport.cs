// auto generated with nant generateWinforms from AbsenteeReport.yaml
//
...
namespace Ict.Petra.Client.MReporting.Gui.MConference
{
  ...
  /// </summary>
  public partial class TFrmAbsenteeReport: System.Windows.Forms.Form, IFrmReporting
  {
    ...
    /// constructor
    /// </summary>
    public TFrmAbsenteeReport(IntPtr AParentFormHandle) : base()
    {
      //
      ...
      this.Text = Catalog.GetString("Absentee Report");
      #endregion

      FPetraUtilsObject = new TFrmPetraReportingUtils(AParentFormHandle, this, stbMain);

      FPetraUtilsObject.FXMLFiles = "Conference\\\\absenteereport.xml,Conference\\\\conference.xml";
      FPetraUtilsObject.FReportName = "Absentee Report";
      FPetraUtilsObject.FCurrentReport = "Absentee Report";
