// auto generated with nant generateWinforms from NationalitySummaryReport.yaml
//
...
namespace Ict.Petra.Client.MReporting.Gui.MConference
{
  ...
  /// </summary>
  public partial class TFrmNationalitySummaryReport: System.Windows.Forms.Form, IFrmReporting
  {
    ...
    /// constructor
    /// </summary>
    public TFrmNationalitySummaryReport(IntPtr AParentFormHandle) : base()
    {
      //
      ...
      this.Text = Catalog.GetString("Nationality Summary Report");
      #endregion

      FPetraUtilsObject = new TFrmPetraReportingUtils(AParentFormHandle, this, stbMain);

      FPetraUtilsObject.FXMLFiles = "Conference\\\\nationalitysummaryreport.xml";
      FPetraUtilsObject.FReportName = "Nationality Summary Report";
      FPetraUtilsObject.FCurrentReport = "Nationality Summary Report";
