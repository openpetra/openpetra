// auto generated with nant generateWinforms from TransportReport.yaml
//
...
namespace Ict.Petra.Client.MReporting.Gui.MConference
{
  ...
  /// </summary>
  public partial class TFrmTransportReport: System.Windows.Forms.Form, IFrmReporting
  {
    ...
    /// constructor
    /// </summary>
    public TFrmTransportReport(IntPtr AParentFormHandle) : base()
    {
      //
      ...
      this.Text = Catalog.GetString("Transport Report");
      #endregion

      FPetraUtilsObject = new TFrmPetraReportingUtils(AParentFormHandle, this, stbMain);

      FPetraUtilsObject.FXMLFiles = "Conference\\\\transportreport.xml,Conference\\\\conference.xml";
      FPetraUtilsObject.FReportName = "Transport Report";
      FPetraUtilsObject.FCurrentReport = "Transport Report";
    ...
    */
    public void SetControls(TParameterList AParameters)
    {
      ...
      if ((dtpTravelDayDate <= DateTime.MinValue)
          || (dtpTravelDayDate >= DateTime.MaxValue))
      {
