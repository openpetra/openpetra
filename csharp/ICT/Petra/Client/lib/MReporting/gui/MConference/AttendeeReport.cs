// auto generated with nant generateWinforms from AttendeeReport.yaml
//
...
namespace Ict.Petra.Client.MReporting.Gui.MConference
{
  ...
  /// </summary>
  public partial class TFrmAttendeeReport: System.Windows.Forms.Form, IFrmReporting
  {
    ...
    /// constructor
    /// </summary>
    public TFrmAttendeeReport(IntPtr AParentFormHandle) : base()
    {
      //
      ...
      this.Text = Catalog.GetString("Attendee Report");
      #endregion

      FPetraUtilsObject = new TFrmPetraReportingUtils(AParentFormHandle, this, stbMain);

      FPetraUtilsObject.FXMLFiles = "Conference\\\\attendeereport.xml,Conference\\\\conference.xml";
      FPetraUtilsObject.FReportName = "Attendee Report";
      FPetraUtilsObject.FCurrentReport = "Attendee Report";
