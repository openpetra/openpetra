...
namespace Ict.Petra.Client.MReporting.Gui.MConference
{
  ...
  /// </summary>
  public partial class TFrmArrivalDepartureGroup: System.Windows.Forms.Form, IFrmReporting
  {
    ...
    /// constructor
    /// </summary>
    public TFrmArrivalDepartureGroup(IntPtr AParentFormHandle) : base()
    {
      //
      ...
      this.Text = Catalog.GetString("Arrival Departure Group");
      #endregion
