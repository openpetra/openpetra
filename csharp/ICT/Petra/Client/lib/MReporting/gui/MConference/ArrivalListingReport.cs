...
namespace Ict.Petra.Client.MReporting.Gui.MConference
{
  ...
  /// </summary>
  public partial class TFrmArrivalListingReport: System.Windows.Forms.Form, IFrmReporting
  {
    ...
    /// constructor
    /// </summary>
    public TFrmArrivalListingReport(IntPtr AParentFormHandle) : base()
    {
      //
      ...
      this.rbtArrival.Text = Catalog.GetString("Arrival");
      this.rbtDeparture.Text = Catalog.GetString("Departure");
      this.lblReportDate.Text = Catalog.GetString("Report Date:");
      ...
      this.Text = Catalog.GetString("Arrivals Listing Report");
      #endregion

      FPetraUtilsObject = new TFrmPetraReportingUtils(AParentFormHandle, this, stbMain);

      FPetraUtilsObject.FXMLFiles = "Conference\\\\arrivalslistingreport.xml,Conference\\\\conference.xml";
      FPetraUtilsObject.FReportName = "Arrivals Listing Report";
      FPetraUtilsObject.FCurrentReport = "Arrivals Listing Report";
...
#region Parameter/Settings Handling
    ...
    */
    public void SetControls(TParameterList AParameters)
    {
      ...
      DateTime dtpReportDateDate = AParameters.Get("param_dtpReportDate").ToDate();
      if ((dtpReportDateDate <= DateTime.MinValue)
          || (dtpReportDateDate >= DateTime.MaxValue))
      {
          dtpReportDateDate = DateTime.Now;
      }
