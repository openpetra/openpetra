// auto generated with nant generateWinforms from ExtraCostsReport.yaml
//
...
namespace Ict.Petra.Client.MReporting.Gui.MConference
{
  ...
  /// </summary>
  public partial class TFrmExtraCostsReport: System.Windows.Forms.Form, IFrmReporting
  {
    ...
    /// constructor
    /// </summary>
    public TFrmExtraCostsReport(IntPtr AParentFormHandle) : base()
    {
      //
      ...
      FPetraUtilsObject.FXMLFiles = "Conference\\\\extracostsreport.xml,Conference\\\\conference.xml";
      FPetraUtilsObject.FReportName = "Extra Costs Report";
      FPetraUtilsObject.FCurrentReport = "Extra Costs Report";
...
#region Column Functions and Calculations
    ...
    */
    public void SetAvailableFunctions()
    {
      ...
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Authorising Person", 3.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Cost Type", 2.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Cost Type Comment", 3.0));
