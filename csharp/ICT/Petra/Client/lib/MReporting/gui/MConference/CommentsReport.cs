// auto generated with nant generateWinforms from CommentsReport.yaml
//
...
namespace Ict.Petra.Client.MReporting.Gui.MConference
{
  ...
  /// </summary>
  public partial class TFrmCommentsReport: System.Windows.Forms.Form, IFrmReporting
  {
    ...
    /// constructor
    /// </summary>
    public TFrmCommentsReport(IntPtr AParentFormHandle) : base()
    {
      //
      ...
      this.Text = Catalog.GetString("Comments Report");
      #endregion

      FPetraUtilsObject = new TFrmPetraReportingUtils(AParentFormHandle, this, stbMain);

      FPetraUtilsObject.FXMLFiles = "Conference\\\\commentsreport.xml,Conference\\\\conference.xml";
      FPetraUtilsObject.FReportName = "Comments Report";
      FPetraUtilsObject.FCurrentReport = "Comments Report";
