// auto generated with nant generateWinforms from ConferenceRoleReport.yaml
//
...
namespace Ict.Petra.Client.MReporting.Gui.MConference
{
  ...
  /// </summary>
  public partial class TFrmConferenceRoleReport: System.Windows.Forms.Form, IFrmReporting
  {
    ...
    /// constructor
    /// </summary>
    public TFrmConferenceRoleReport(IntPtr AParentFormHandle) : base()
    {
      //
      ...
      this.Text = Catalog.GetString("Conference Role Report");
      #endregion

      FPetraUtilsObject = new TFrmPetraReportingUtils(AParentFormHandle, this, stbMain);

      FPetraUtilsObject.FXMLFiles = "Conference\\\\conferencerolereport.xml";
      FPetraUtilsObject.FReportName = "Conference Role Report";
      FPetraUtilsObject.FCurrentReport = "Conference Role Report";
