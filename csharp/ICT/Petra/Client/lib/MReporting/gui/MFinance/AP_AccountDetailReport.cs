...
namespace Ict.Petra.Client.MReporting.Gui.MFinance
{
  ...
  /// </summary>
  public partial class TFrmAP_AccountDetailReport: System.Windows.Forms.Form, IFrmReporting
  {
    ...
    /// constructor
    /// </summary>
    public TFrmAP_AccountDetailReport(IntPtr AParentFormHandle) : base()
    {
      //
      ...
      this.lblAccountFrom.Text = Catalog.GetString("Account Code:");
      this.lblAccountTo.Text = Catalog.GetString("To:");
      this.grpAccountSelection.Text = Catalog.GetString("Select Accounts");
      ...
      this.Text = Catalog.GetString("AP Account Detail Report");
      #endregion

      FPetraUtilsObject = new TFrmPetraReportingUtils(AParentFormHandle, this, stbMain);

      FPetraUtilsObject.FXMLFiles = "Finance\\\\AP_accountdetail.xml,Finance\\\\finance.xml,common.xml";
      FPetraUtilsObject.FReportName = "APAccountDetailReport";
      FPetraUtilsObject.FCurrentReport = "APAccountDetailReport";
...
#region Parameter/Settings Handling
    ...
    */
    public void ReadControls(TRptCalculator ACalc, TReportActionEnum AReportAction)
    {
      ...
      ACalc.AddParameter("param_account_from", this.cmbAccountFrom.GetSelectedString());
      ACalc.AddParameter("param_account_to", this.cmbAccountTo.GetSelectedString());
    ...
    */
    public void SetControls(TParameterList AParameters)
    {
      ...
      cmbAccountFrom.SetSelectedString(AParameters.Get("param_account_from").ToString());
      cmbAccountTo.SetSelectedString(AParameters.Get("param_account_to").ToString());
...
#region Column Functions and Calculations
    ...
    */
    public void SetAvailableFunctions()
    {
      ...
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Date", 2.0));
      ...
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Detail", 6.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Reference Number", 3.0));
