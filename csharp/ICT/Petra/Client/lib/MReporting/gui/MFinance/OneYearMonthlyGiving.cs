// auto generated with nant generateWinforms from OneYearMonthlyGiving.yaml
//
...
namespace Ict.Petra.Client.MReporting.Gui.MFinance
{
  ...
  /// </summary>
  public partial class TFrmOneYearMonthlyGiving: System.Windows.Forms.Form, IFrmReporting
  {
    ...
    /// constructor
    /// </summary>
    public TFrmOneYearMonthlyGiving(IntPtr AParentFormHandle) : base()
    {
      //
      ...
      this.rbtAllPartner.Text = Catalog.GetString("All Recipients");
      this.rbtExtract.Text = Catalog.GetString("From Extract");
      this.txtExtract.ButtonText = Catalog.GetString("Find");
      this.rbtPartner.Text = Catalog.GetString("One Partner");
      this.txtRecipient.ButtonText = Catalog.GetString("Find");
      this.rgrPartnerSelection.Text = Catalog.GetString("Select Recipient");
      ...
      this.grpCurrencySelection.Text = Catalog.GetString("Currency");
      ...
      this.Text = Catalog.GetString("One Year Monthly Giving");
      #endregion

      FPetraUtilsObject = new TFrmPetraReportingUtils(AParentFormHandle, this, stbMain);

      FPetraUtilsObject.FXMLFiles = "Finance\\\\oneyearmonthlygiving.xml,Finance\\\\finance.xml,common.xml";
      FPetraUtilsObject.FReportName = "OneYearMonthlyGiving";
      FPetraUtilsObject.FCurrentReport = "OneYearMonthlyGiving";
...
#region Parameter/Settings Handling
    ...
    */
    public void ReadControls(TRptCalculator ACalc, TReportActionEnum AReportAction)
    {
      ...
      if (rbtAllPartner.Checked)
      {
          ACalc.AddParameter("param_donor", "all_recipients");
      }
      ...
      {
          ACalc.AddParameter("param_donor", "one_partner");
      }
    ...
    */
    public void SetControls(TParameterList AParameters)
    {
      ...
      rbtAllPartner.Checked = AParameters.Get("param_donor").ToString() == "all_recipients";
      rbtExtract.Checked = AParameters.Get("param_donor").ToString() == "Extract";
      rbtPartner.Checked = AParameters.Get("param_donor").ToString() == "one_partner";
...
#region Column Functions and Calculations
    ...
    */
    public void SetAvailableFunctions()
    {
      ...
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("January", 2.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("February", 2.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("March", 2.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("April", 2.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("May", 2.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("June", 2.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("July", 2.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("August", 2.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("September", 2.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("October", 2.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("November", 2.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("December", 2.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Total", 2.0));
