...
namespace Ict.Petra.Client.MReporting.Gui.MFinance
{
  ...
  /// </summary>
  public partial class TFrmTrialBalance: System.Windows.Forms.Form, IFrmReporting
  {
    ...
    /// constructor
    /// </summary>
    public TFrmTrialBalance(IntPtr AParentFormHandle) : base()
    {
      //
      ...
      this.rbtSortByDepartment.Text = Catalog.GetString("Sort by Department");
      ...
      this.Text = Catalog.GetString("Trial Balance");
      #endregion

      FPetraUtilsObject = new TFrmPetraReportingUtils(AParentFormHandle, this, stbMain);

      FPetraUtilsObject.FXMLFiles = "Finance\\\\trialbalance.xml,Finance\\\\accountdetailcommon.xml,Finance\\\\finance.xml,common.xml";
      FPetraUtilsObject.FReportName = "Trial Balance";
      FPetraUtilsObject.FCurrentReport = "Trial Balance";
...
#region Parameter/Settings Handling
    ...
    */
    public void ReadControls(TRptCalculator ACalc, TReportActionEnum AReportAction)
    {
      ...
      if (rbtSortByDepartment.Checked)
      {
          ACalc.AddParameter("param_sortby", "Department");
      }
    ...
    */
    public void SetControls(TParameterList AParameters)
    {
      ...
      rbtSortByDepartment.Checked = AParameters.Get("param_sortby").ToString() == "Department";
