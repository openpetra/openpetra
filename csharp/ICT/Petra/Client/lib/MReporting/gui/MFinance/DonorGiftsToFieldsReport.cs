...
namespace Ict.Petra.Client.MReporting.Gui.MFinance
{
  ...
  /// </summary>
  public partial class TFrmDonorGiftsToFieldsReport: System.Windows.Forms.Form, IFrmReporting
  {
    ...
    /// constructor
    /// </summary>
    public TFrmDonorGiftsToFieldsReport(IntPtr AParentFormHandle) : base()
    {
      //
      ...
      this.Text = Catalog.GetString("Donor Gift to Fields Report");
      #endregion

      FPetraUtilsObject = new TFrmPetraReportingUtils(AParentFormHandle, this, stbMain);

      FPetraUtilsObject.FXMLFiles = "Finance\\\\donorgiftstofieldsreport.xml,Finance\\\\finance.xml,common.xml";
      FPetraUtilsObject.FReportName = "DonorGiftToFields";
      FPetraUtilsObject.FCurrentReport = "DonorGiftToFields";
...
#region Column Functions and Calculations
    ...
    */
    public void SetAvailableFunctions()
    {
      ...
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Donor Address", 8.0));
      ...
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Method", 2.0));
