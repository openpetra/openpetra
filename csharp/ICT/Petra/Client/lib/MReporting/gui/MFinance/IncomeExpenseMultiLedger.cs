...
namespace Ict.Petra.Client.MReporting.Gui.MFinance
{
  ...
  /// </summary>
  public partial class TFrmIncomeExpenseMultiLedger: System.Windows.Forms.Form, IFrmReporting
  {
    ...
    /// constructor
    /// </summary>
    public TFrmIncomeExpenseMultiLedger(IntPtr AParentFormHandle) : base()
    {
      //
      ...
      this.Text = Catalog.GetString("Income Expense Statement (Multi Ledger)");
      #endregion
      ...
      FPetraUtilsObject.FReportName = "Inc Exp Multi Ledger";
      ...
      uco_FinanceColumns.SetVisibility(true, true);
