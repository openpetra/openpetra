...
namespace Ict.Petra.Client.MReporting.Gui.MFinance
{
  ...
  /// </summary>
  public partial class TFrmARConferencePayments: System.Windows.Forms.Form, IFrmReporting
  {
    ...
    /// constructor
    /// </summary>
    public TFrmARConferencePayments(IntPtr AParentFormHandle) : base()
    {
      //
      ...
      this.lblConferenceKey.Text = Catalog.GetString("Partner Key of Conference:");
      this.lblMotivationCodes.Text = Catalog.GetString("Motivation Codes:");
      this.lblStartPayments.Text = Catalog.GetString("Start of Payments:");
