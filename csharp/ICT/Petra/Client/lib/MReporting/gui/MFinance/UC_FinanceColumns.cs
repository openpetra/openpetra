// auto generated with nant generateWinforms from UC_FinanceColumns.yaml and template usercontrolUnbound
//
...
namespace Ict.Petra.Client.MReporting.Gui.MFinance
{
  ...
  public partial class TFrmUC_FinanceColumns: UserControl, Ict.Petra.Client.CommonForms.IFrmPetra
  {
    ...
    /// constructor
    public TFrmUC_FinanceColumns() : base()
    {
      //
      ...
      this.rbtFromGL.Text = Catalog.GetString("Get from GL:");
      this.rbtCalculateExisting.Text = Catalog.GetString("Calculate from existing column(s)");
      this.chkYTD.Text = Catalog.GetString("YTD");
