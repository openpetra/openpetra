...
namespace Ict.Petra.Client.MReporting.Gui.MFinance
{
  ...
  /// </summary>
  public partial class TFrmFieldGiftTotalsReport: System.Windows.Forms.Form, IFrmReporting
  {
    ...
    /// constructor
    /// </summary>
    public TFrmFieldGiftTotalsReport(IntPtr AParentFormHandle) : base()
    {
      //
      ...
      this.lblYears.Text = Catalog.GetString("For last years (1-4):");
      ...
      this.grpFields.Text = Catalog.GetString("Select Receiving Fields");
      ...
      this.Text = Catalog.GetString("Field Gift Report");
      #endregion

      FPetraUtilsObject = new TFrmPetraReportingUtils(AParentFormHandle, this, stbMain);

      FPetraUtilsObject.FXMLFiles = "Finance\\\\fieldgifttotalsreport.xml,Finance\\\\finance.xml,common.xml";
      FPetraUtilsObject.FReportName = "FieldGiftTotalsReport";
      FPetraUtilsObject.FCurrentReport = "FieldGiftTotalsReport";
...
#region Parameter/Settings Handling
    ...
    */
    public void ReadControls(TRptCalculator ACalc, TReportActionEnum AReportAction)
    {
      ...
      ACalc.AddParameter("param_txtYears", this.txtYears.Text);
    ...
    */
    public void SetControls(TParameterList AParameters)
    {
      ...
      txtYears.NumberValueInt = AParameters.Get("param_txtYears").ToInt32();
