...
namespace Ict.Petra.Client.MReporting.Gui.MFinance
{
  ...
  /// </summary>
  public partial class TFrmRecipientGiftStatement: System.Windows.Forms.Form, IFrmReporting
  {
    ...
    /// constructor
    /// </summary>
    public TFrmRecipientGiftStatement(IntPtr AParentFormHandle) : base()
    {
      //
      ...
      this.rgrRecipientSelection.Text = Catalog.GetString("Select Recipients");
      ...
      this.Text = Catalog.GetString("Recipient Gift Statement");
      #endregion

      FPetraUtilsObject = new TFrmPetraReportingUtils(AParentFormHandle, this, stbMain);

      FPetraUtilsObject.FXMLFiles = "Finance\\\\recipientgiftstatement.xml,Finance\\\\finance.xml,common.xml";
      FPetraUtilsObject.FReportName = "RecipientGiftStatement";
      FPetraUtilsObject.FCurrentReport = "RecipientGiftStatement";
...
#region Column Functions and Calculations
    ...
    */
    public void SetAvailableFunctions()
    {
      ...
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Motivation Code", 2.0));
