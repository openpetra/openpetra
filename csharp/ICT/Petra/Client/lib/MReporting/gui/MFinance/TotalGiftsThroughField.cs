...
namespace Ict.Petra.Client.MReporting.Gui.MFinance
{
  ...
  /// </summary>
  public partial class TFrmTotalGiftsThroughField: System.Windows.Forms.Form, IFrmReporting
  {
    ...
    /// constructor
    /// </summary>
    public TFrmTotalGiftsThroughField(IntPtr AParentFormHandle) : base()
    {
      //
      ...
      this.Text = Catalog.GetString("Total Gifts through Field");
      #endregion

      FPetraUtilsObject = new TFrmPetraReportingUtils(AParentFormHandle, this, stbMain);

      FPetraUtilsObject.FXMLFiles = "Finance\\\\totalgiftsthroughfield.xml,Finance\\\\finance.xml,common.xml";
      FPetraUtilsObject.FReportName = "TotalGiftsThroughField";
      FPetraUtilsObject.FCurrentReport = "TotalGiftsThroughField";
