...
namespace Ict.Petra.Client.MReporting.Gui.MFinDev
{
  ...
  /// </summary>
  public partial class TFrmSYBUNTReport: System.Windows.Forms.Form, IFrmReporting
  {
    ...
    /// constructor
    /// </summary>
    public TFrmSYBUNTReport(IntPtr AParentFormHandle) : base()
    {
      //
      ...
      this.lblLastYear.Text = Catalog.GetString("Gifts given in year:");
      this.lblThisYear.Text = Catalog.GetString("No gifts in year:");
      ...
      this.Text = Catalog.GetString("SYBUNT");
      #endregion

      FPetraUtilsObject = new TFrmPetraReportingUtils(AParentFormHandle, this, stbMain);

      FPetraUtilsObject.FXMLFiles = "FinancialDevelopment\\\\sybunt.xml,common.xml";
      FPetraUtilsObject.FReportName = "SYBUNTReport";
      FPetraUtilsObject.FCurrentReport = "SYBUNTReport";
      ...
      ucoSorting.InitialiseData(FPetraUtilsObject);

      ucoReportColumns.PetraUtilsObject = FPetraUtilsObject;
      ucoReportColumns.InitUserControl();
      ucoSorting.PetraUtilsObject = FPetraUtilsObject;
      ucoSorting.InitUserControl();
...
#region Parameter/Settings Handling
    ...
    */
    public void ReadControls(TRptCalculator ACalc, TReportActionEnum AReportAction)
    {
      ...
      ACalc.AddParameter("param_last_year", this.txtLastYear.Text);
      ACalc.AddParameter("param_this_year", this.txtThisYear.Text);
      ...
      ucoSorting.ReadControls(ACalc, AReportAction);
    ...
    */
    public void SetControls(TParameterList AParameters)
    {
      ...
      txtLastYear.NumberValueInt = AParameters.Get("param_last_year").ToInt32();
      txtThisYear.NumberValueInt = AParameters.Get("param_this_year").ToInt32();
      ...
      ucoSorting.SetControls(AParameters);
...
#region Column Functions and Calculations
    ...
    */
    public void SetAvailableFunctions()
    {
      ...
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Last Gift Date", 2.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Last Gift Amount", 3.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Motivation Detail", 3.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Motivation Group", 3.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Number", 1.0));

      ucoReportColumns.SetAvailableFunctions(FPetraUtilsObject.GetAvailableFunctions());
      ucoSorting.SetAvailableFunctions(FPetraUtilsObject.GetAvailableFunctions());
