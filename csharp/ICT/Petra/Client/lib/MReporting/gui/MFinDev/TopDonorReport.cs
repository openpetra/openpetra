...
namespace Ict.Petra.Client.MReporting.Gui.MFinDev
{
  ...
  /// </summary>
  public partial class TFrmTopDonorReport: System.Windows.Forms.Form, IFrmReporting
  {
    ...
    /// constructor
    /// </summary>
    public TFrmTopDonorReport(IntPtr AParentFormHandle) : base()
    {
      //
      ...
      this.rbtTopDonor.Text = Catalog.GetString("Top");
      this.rbtMiddleDonor.Text = Catalog.GetString("Middle");
      this.rbtBottomDonor.Text = Catalog.GetString("Bottom");
      this.lblPercent1.Text = Catalog.GetString("%:");
      this.lblToPercentage.Text = Catalog.GetString("To:");
      this.lblPercent2.Text = Catalog.GetString("%:");
      this.lblCurrency.Text = Catalog.GetString("Currency:");
      this.grpLevel.Text = Catalog.GetString("Select Level");
      ...
      this.lblMotivationDetail.Text = Catalog.GetString("MotivationDetail:");
      ...
      this.Text = Catalog.GetString("Top Donor Report");
      #endregion
      ...
      FPetraUtilsObject.FXMLFiles = "FinancialDevelopment\\\\topdonorreport.xml,common.xml";
      FPetraUtilsObject.FReportName = "TopDonorReport";
      FPetraUtilsObject.FCurrentReport = "TopDonorReport";
...
#region Parameter/Settings Handling
    ...
    */
    public void ReadControls(TRptCalculator ACalc, TReportActionEnum AReportAction)
    {
      ...
      ACalc.AddParameter("param_percentage", this.txtPercentage.Text);
      ACalc.AddParameter("param_to_percentage", this.txtToPercentage.Text);
    ...
    */
    public void SetControls(TParameterList AParameters)
    {
      ...
      txtPercentage.NumberValueInt = AParameters.Get("param_percentage").ToInt32();
      txtToPercentage.NumberValueInt = AParameters.Get("param_to_percentage").ToInt32();
