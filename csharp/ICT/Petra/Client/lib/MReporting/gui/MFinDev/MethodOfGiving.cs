...
namespace Ict.Petra.Client.MReporting.Gui.MFinDev
{
  ...
  /// </summary>
  public partial class TFrmMethodOfGiving: System.Windows.Forms.Form, IFrmReporting
  {
    ...
    /// constructor
    /// </summary>
    public TFrmMethodOfGiving(IntPtr AParentFormHandle) : base()
    {
      //
      ...
      this.Text = Catalog.GetString("Method of Giving");
      #endregion

      FPetraUtilsObject = new TFrmPetraReportingUtils(AParentFormHandle, this, stbMain);

      FPetraUtilsObject.FXMLFiles = "FinancialDevelopment/methodofgiving.xml,common.xml";
      FPetraUtilsObject.FReportName = "MethodOfGiving";
      FPetraUtilsObject.FCurrentReport = "MethodOfGiving";
