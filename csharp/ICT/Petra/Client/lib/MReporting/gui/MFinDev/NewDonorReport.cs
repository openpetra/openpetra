...
namespace Ict.Petra.Client.MReporting.Gui.MFinDev
{
  ...
  /// </summary>
  public partial class TFrmNewDonorReport: System.Windows.Forms.Form, IFrmReporting
  {
    ...
    /// constructor
    /// </summary>
    public TFrmNewDonorReport(IntPtr AParentFormHandle) : base()
    {
      //
      ...
      this.rbtAmount.Text = Catalog.GetString("Gift Amount");
      this.rgrSorting.Text = Catalog.GetString("Sort by");
      ...
      this.Text = Catalog.GetString("New Donor Report");
      #endregion

      FPetraUtilsObject = new TFrmPetraReportingUtils(AParentFormHandle, this, stbMain);

      FPetraUtilsObject.FXMLFiles = "FinancialDevelopment\\\\newdonorreport.xml,common.xml";
      FPetraUtilsObject.FReportName = "NewDonorReport";
      FPetraUtilsObject.FCurrentReport = "NewDonorReport";
...
#region Parameter/Settings Handling
    ...
    */
    public void ReadControls(TRptCalculator ACalc, TReportActionEnum AReportAction)
    {
      ...
      {
          ACalc.AddParameter("param_rgrSorting", "Partner Name");
      }
      if (rbtPartnerKey.Checked)
      {
          ACalc.AddParameter("param_rgrSorting", "Partner Key");
      }
      if (rbtAmount.Checked)
      {
          ACalc.AddParameter("param_rgrSorting", "Amount");
      }
    ...
    */
    public void SetControls(TParameterList AParameters)
    {
      ...
      rbtPartnerName.Checked = AParameters.Get("param_rgrSorting").ToString() == "Partner Name";
      rbtPartnerKey.Checked = AParameters.Get("param_rgrSorting").ToString() == "Partner Key";
      rbtAmount.Checked = AParameters.Get("param_rgrSorting").ToString() == "Amount";
...
#region Column Functions and Calculations
    ...
    */
    public void SetAvailableFunctions()
    {
      ...
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Motivation Group Description", 3.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Motivation Detail", 3.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Motivation Detail Description", 3.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Gift Amount", 3.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Recipient Name", 4.0));
