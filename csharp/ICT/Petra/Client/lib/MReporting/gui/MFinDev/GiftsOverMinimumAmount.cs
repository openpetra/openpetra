...
namespace Ict.Petra.Client.MReporting.Gui.MFinDev
{
  ...
  /// </summary>
  public partial class TFrmGiftsOverMinimumAmount: System.Windows.Forms.Form, IFrmReporting
  {
    ...
    /// constructor
    /// </summary>
    public TFrmGiftsOverMinimumAmount(IntPtr AParentFormHandle) : base()
    {
      //
      ...
      this.rbtSortByAmount.Text = Catalog.GetString("By Amount");
      this.rgrSorting.Text = Catalog.GetString("Sort");
      this.chkExcludeAnonymousDonors.Text = Catalog.GetString("Exclude anonymous Donors");
      this.chkExcludeNoSolicitation.Text = Catalog.GetString("Exclude no Solicitations");
      this.grpExcludePartners.Text = Catalog.GetString("Exclude Partners");
      ...
      this.Text = Catalog.GetString("Gifts over Minimum Amount");
      #endregion

      FPetraUtilsObject = new TFrmPetraReportingUtils(AParentFormHandle, this, stbMain);

      FPetraUtilsObject.FXMLFiles = "FinancialDevelopment\\\\giftsoveramount.xml,common.xml";
      FPetraUtilsObject.FReportName = "GiftsOverAmount";
      FPetraUtilsObject.FCurrentReport = "GiftsOverAmount";
...
#region Parameter/Settings Handling
    ...
    */
    public void ReadControls(TRptCalculator ACalc, TReportActionEnum AReportAction)
    {
      ...
      {
          ACalc.AddParameter("param_sort_by", "Donor Name");
      }
      if (rbtSortByDonorKey.Checked)
      {
          ACalc.AddParameter("param_sort_by", "Donor Key");
      }
      if (rbtSortByAmount.Checked)
      {
          ACalc.AddParameter("param_sort_by", "Gift Amount");
      }
      ACalc.AddParameter("param_exclude_anonymous_donors", this.chkExcludeAnonymousDonors.Checked);
      ACalc.AddParameter("param_exclude_no_solicitations", this.chkExcludeNoSolicitation.Checked);
    ...
    */
    public void SetControls(TParameterList AParameters)
    {
      ...
      rbtSortByPartnerName.Checked = AParameters.Get("param_sort_by").ToString() == "Donor Name";
      rbtSortByDonorKey.Checked = AParameters.Get("param_sort_by").ToString() == "Donor Key";
      rbtSortByAmount.Checked = AParameters.Get("param_sort_by").ToString() == "Gift Amount";
      chkExcludeAnonymousDonors.Checked = AParameters.Get("param_exclude_anonymous_donors").ToBool();
      chkExcludeNoSolicitation.Checked = AParameters.Get("param_exclude_no_solicitations").ToBool();
...
#region Column Functions and Calculations
    ...
    */
    public void SetAvailableFunctions()
    {
      ...
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Gift Recipient", 8.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Total Gifts", 2.5));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Motivation Detail", 2.0));
