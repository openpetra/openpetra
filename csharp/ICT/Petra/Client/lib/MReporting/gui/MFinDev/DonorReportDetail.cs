// auto generated with nant generateWinforms from DonorReportDetail.yaml
//
...
namespace Ict.Petra.Client.MReporting.Gui.MFinDev
{
  ...
  /// </summary>
  public partial class TFrmDonorReportDetail: System.Windows.Forms.Form, IFrmReporting
  {
    ...
    /// constructor
    /// </summary>
    public TFrmDonorReportDetail(IntPtr AParentFormHandle) : base()
    {
      //
      ...
      this.rbtSortByPartnerName.Text = Catalog.GetString("By Donor Name");
      this.rbtSortByDonorKey.Text = Catalog.GetString("By Donor Key");
      ...
      this.Text = Catalog.GetString("Donors Report - Detail");
      #endregion

      FPetraUtilsObject = new TFrmPetraReportingUtils(AParentFormHandle, this, stbMain);

      FPetraUtilsObject.FXMLFiles = "FinancialDevelopment\\\\donorreportdetail.xml,common.xml";
      FPetraUtilsObject.FReportName = "DonorReportDetail";
      FPetraUtilsObject.FCurrentReport = "DonorReportDetail";
...
#region Column Functions and Calculations
    ...
    */
    public void SetAvailableFunctions()
    {
      ...
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Gift Recipient Key", 2.5));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Gift Details", 8.0));
