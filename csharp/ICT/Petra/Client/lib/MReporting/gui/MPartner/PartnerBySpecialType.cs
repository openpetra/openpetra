...
namespace Ict.Petra.Client.MReporting.Gui.MPartner
{
  ...
  /// </summary>
  public partial class TFrmPartnerBySpecialType: System.Windows.Forms.Form, IFrmReporting
  {
    ...
    /// constructor
    /// </summary>
    public TFrmPartnerBySpecialType(IntPtr AParentFormHandle) : base()
    {
      //
      ...
      this.lblIncludeSpecialTypes.Text = Catalog.GetString("Report on all partners that have one of these special types:");
      ...
      this.Text = Catalog.GetString("Partner By Special Type");
      #endregion

      FPetraUtilsObject = new TFrmPetraReportingUtils(AParentFormHandle, this, stbMain);

      FPetraUtilsObject.FXMLFiles = "Partner\\\\partnerbyspecialtype.xml";
      FPetraUtilsObject.FReportName = "Partner By Special Type";
      FPetraUtilsObject.FCurrentReport = "Partner By Special Type";
...
#region Parameter/Settings Handling
    ...
    */
    public void ReadControls(TRptCalculator ACalc, TReportActionEnum AReportAction)
    {
      ...
      ACalc.AddParameter("param_explicit_specialtypes", this.clbIncludeSpecialTypes.GetCheckedStringList());
    ...
    */
    public void SetControls(TParameterList AParameters)
    {
      ...
      clbIncludeSpecialTypes.SetCheckedStringList(AParameters.Get("param_explicit_specialtypes").ToString());
