...
namespace Ict.Petra.Client.MReporting.Gui.MPartner
{
  ...
  /// </summary>
  public partial class TFrmPartnerContactReport: System.Windows.Forms.Form, IFrmReporting
  {
    ...
    /// constructor
    /// </summary>
    public TFrmPartnerContactReport(IntPtr AParentFormHandle) : base()
    {
      //
      ...
      this.lblContact.Text = Catalog.GetString("Contact:");
      this.lblDateFrom.Text = Catalog.GetString("Date From::");
      this.lblDateTo.Text = Catalog.GetString("Date To::");
      this.grpReportRange.Text = Catalog.GetString("Report Range");
      this.tpgReportRange.Text = Catalog.GetString("Report Range");
      this.btnAddDetail.Text = Catalog.GetString("AddDetail");
      this.btnRemoveDetail.Text = Catalog.GetString("Remove Detail");
      this.tpgContactAttributes.Text = Catalog.GetString("Contact Attributes");
      ...
      FPetraUtilsObject.FReportName = "Partner Contact";
      FPetraUtilsObject.FCurrentReport = "Partner Contact";
      ...
      grdAttribute_InitialiseData(FPetraUtilsObject);
      grdDetail_InitialiseData(FPetraUtilsObject);
      grdSelection_InitialiseData(FPetraUtilsObject);
...
#region Column Functions and Calculations
    ...
    */
    public void SetAvailableFunctions()
    {
      ...
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Contact Detail", 3.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Contact Detail Description", 4.0));
