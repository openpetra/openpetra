// auto generated with nant generateWinforms from StartOfCommitmentReport.yaml
//
...
namespace Ict.Petra.Client.MReporting.Gui.MPersonnel
{
  ...
  /// </summary>
  public partial class TFrmStartOfCommitmentReport: System.Windows.Forms.Form, IFrmReporting
  {
    ...
    /// constructor
    /// </summary>
    public TFrmStartOfCommitmentReport(IntPtr AParentFormHandle) : base()
    {
      //
      ...
      this.lblStartDate.Text = Catalog.GetString("Commitment starts:");
      this.lblEndDate.Text = Catalog.GetString("and::");
      this.grpDates.Text = Catalog.GetString("Commitment Dates");
      this.chkSelectedStatus.Text = Catalog.GetString("Include only Persons with selected Commitment");
      this.chkNoSelectedStatus.Text = Catalog.GetString("Include Persons with no Commitment Status set");
      this.grpStatus.Text = Catalog.GetString("Commitment Status");
      ...
      this.Text = Catalog.GetString("Start of Commitment Report");
      #endregion

      FPetraUtilsObject = new TFrmPetraReportingUtils(AParentFormHandle, this, stbMain);

      FPetraUtilsObject.FXMLFiles = "Personnel\\\\startofcommitmentreport.xml,Personnel\\\\personnel.xml";
      FPetraUtilsObject.FReportName = "Start of Commitment Report";
      FPetraUtilsObject.FCurrentReport = "Start of Commitment Report";
      ...
      grdStatuses_InitialiseData(FPetraUtilsObject);
...
#region Parameter/Settings Handling
    ...
    */
    public void ReadControls(TRptCalculator ACalc, TReportActionEnum AReportAction)
    {
      ...
      ACalc.AddParameter("param_chkSelectedStatus", this.chkSelectedStatus.Checked);
      grdStatuses_ReadControls(ACalc, AReportAction);
      ACalc.AddParameter("param_chkNoSelectedStatus", this.chkNoSelectedStatus.Checked);
    ...
    */
    public void SetControls(TParameterList AParameters)
    {
      ...
      chkSelectedStatus.Checked = AParameters.Get("param_chkSelectedStatus").ToBool();
      grdStatuses_SetControls(AParameters);
      chkNoSelectedStatus.Checked = AParameters.Get("param_chkNoSelectedStatus").ToBool();
...
#region Column Functions and Calculations
    ...
    */
    public void SetAvailableFunctions()
    {
      ...
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("End Date", 2.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Field Name", 2.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Commitment Status", 3.0));
      ...
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Telephone", 2.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Mobile", 2.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Fax Number", 2.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Alternate Telephone", 2.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("URL", 2.0));
