...
namespace Ict.Petra.Client.MReporting.Gui.MPersonnel
{
  ...
  /// </summary>
  public partial class TFrmEmergencyDataReport: System.Windows.Forms.Form, IFrmReporting
  {
    ...
    /// constructor
    /// </summary>
    public TFrmEmergencyDataReport(IntPtr AParentFormHandle) : base()
    {
      //
      ...
      this.chkFamilyMembers.Text = Catalog.GetString("Show Family Members");
      this.chkAddress.Text = Catalog.GetString("Show Address");
      ...
      this.chkDriverLicense.Text = Catalog.GetString("Show Driver License");
      this.chkOtherEmergencyData.Text = Catalog.GetString("Show Other Emergency Data");
      ...
      this.chkEmergencyContacts.Text = Catalog.GetString("Show Emergency Contacts");
      this.chkProofQuestion.Text = Catalog.GetString("Show Proof of Life Question");
      ...
      this.Text = Catalog.GetString("Emergency Data Report");
      #endregion

      FPetraUtilsObject = new TFrmPetraReportingUtils(AParentFormHandle, this, stbMain);

      FPetraUtilsObject.FXMLFiles = "Personnel\\\\emergencydatareport.xml,Personnel\\\\commonpersonnel.xml";
      FPetraUtilsObject.FReportName = "Emergency Data Report";
      FPetraUtilsObject.FCurrentReport = "Emergency Data Report";
...
#region Parameter/Settings Handling
    ...
    */
    public void ReadControls(TRptCalculator ACalc, TReportActionEnum AReportAction)
    {
      ...
      ACalc.AddParameter("param_chkFamilyMembers", this.chkFamilyMembers.Checked);
      ACalc.AddParameter("param_chkAddress", this.chkAddress.Checked);
      ...
      ACalc.AddParameter("param_chkDriverLicense", this.chkDriverLicense.Checked);
      ACalc.AddParameter("param_chkOtherEmergencyData", this.chkOtherEmergencyData.Checked);
      ...
      ACalc.AddParameter("param_chkEmergencyContacts", this.chkEmergencyContacts.Checked);
      ACalc.AddParameter("param_chkProofQuestion", this.chkProofQuestion.Checked);
    ...
    */
    public void SetControls(TParameterList AParameters)
    {
      ...
      chkFamilyMembers.Checked = AParameters.Get("param_chkFamilyMembers").ToBool();
      chkAddress.Checked = AParameters.Get("param_chkAddress").ToBool();
      ...
      chkDriverLicense.Checked = AParameters.Get("param_chkDriverLicense").ToBool();
      chkOtherEmergencyData.Checked = AParameters.Get("param_chkOtherEmergencyData").ToBool();
      ...
      chkEmergencyContacts.Checked = AParameters.Get("param_chkEmergencyContacts").ToBool();
      chkProofQuestion.Checked = AParameters.Get("param_chkProofQuestion").ToBool();
    }
#endregion
