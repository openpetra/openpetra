// auto generated with nant generateWinforms from JobAssignmentReport.yaml
//
...
namespace Ict.Petra.Client.MReporting.Gui.MPersonnel
{
  ...
  /// </summary>
  public partial class TFrmJobAssignmentReport: System.Windows.Forms.Form, IFrmReporting
  {
    ...
    /// constructor
    /// </summary>
    public TFrmJobAssignmentReport(IntPtr AParentFormHandle) : base()
    {
      //
      ...
      this.Text = Catalog.GetString("Job Assignment Report");
      #endregion

      FPetraUtilsObject = new TFrmPetraReportingUtils(AParentFormHandle, this, stbMain);

      FPetraUtilsObject.FXMLFiles = "Personnel\\\\jobassignmentreport.xml,Personnel\\\\personnel.xml";
      FPetraUtilsObject.FReportName = "Job Assignment Report";
      FPetraUtilsObject.FCurrentReport = "Job Assignment Report";
...
#region Column Functions and Calculations
    ...
    */
    public void SetAvailableFunctions()
    {
      ...
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Role Key", 3.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Role Name", 4.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Assistant", 1.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Start Date", 3.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("End Date", 3.0));
      ...
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Address Post Code", 3.0));
      ...
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Address Country", 3.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Address E-Mail", 3.0));
