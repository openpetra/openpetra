...
namespace Ict.Petra.Client.MReporting.Gui.MPersonnel
{
  ...
  /// </summary>
  public partial class TFrmAbilitiesReport: System.Windows.Forms.Form, IFrmReporting
  {
    ...
    /// constructor
    /// </summary>
    public TFrmAbilitiesReport(IntPtr AParentFormHandle) : base()
    {
      //
      ...
      this.Text = Catalog.GetString("Abilities Report");
      #endregion

      FPetraUtilsObject = new TFrmPetraReportingUtils(AParentFormHandle, this, stbMain);

      FPetraUtilsObject.FXMLFiles = "Personnel\\\\abilitiesreport.xml,Personnel\\\\personnel.xml";
      FPetraUtilsObject.FReportName = "Abilities Report";
      FPetraUtilsObject.FCurrentReport = "Abilities Report";
...
#region Column Functions and Calculations
    ...
    */
    public void SetAvailableFunctions()
    {
      ...
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Ability", 4.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Application Status", 2.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Bringing Instrument", 3.0));
      ...
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Level", 5.0));
