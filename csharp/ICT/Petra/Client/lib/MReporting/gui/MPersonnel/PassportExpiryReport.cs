// auto generated with nant generateWinforms from PassportExpiryReport.yaml
//
...
namespace Ict.Petra.Client.MReporting.Gui.MPersonnel
{
  ...
  /// </summary>
  public partial class TFrmPassportExpiryReport: System.Windows.Forms.Form, IFrmReporting
  {
    ...
    /// constructor
    /// </summary>
    public TFrmPassportExpiryReport(IntPtr AParentFormHandle) : base()
    {
      //
      ...
      this.Text = Catalog.GetString("Passport Expiry Report");
      #endregion

      FPetraUtilsObject = new TFrmPetraReportingUtils(AParentFormHandle, this, stbMain);

      FPetraUtilsObject.FXMLFiles = "Personnel\\\\passportexpiryreport.xml,Personnel\\\\personnel.xml";
      FPetraUtilsObject.FReportName = "Passport Expiry Report";
      FPetraUtilsObject.FCurrentReport = "Passport Expiry Report";
...
#region Column Functions and Calculations
    ...
    */
    public void SetAvailableFunctions()
    {
      ...
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Country Name", 2.5));
      ...
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Occupation", 2.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Occupation Description", 5.0));
      ...
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Passport Country of Issue", 3.0));
      ...
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Passport Nationality", 2.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Passport Number", 4.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Passport Place of Birth", 3.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Passport Place of Issue", 3.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Passport Type", 3.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Person Date of Birth", 2.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Person First Name", 2.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Person Last Name", 2.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Person Middle Name", 2.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Person Prefered Name", 2.0));
