// auto generated with nant generateWinforms from LanguagesReport.yaml
//
...
namespace Ict.Petra.Client.MReporting.Gui.MPersonnel
{
  ...
  /// </summary>
  public partial class TFrmLanguagesReport: System.Windows.Forms.Form, IFrmReporting
  {
    ...
    /// constructor
    /// </summary>
    public TFrmLanguagesReport(IntPtr AParentFormHandle) : base()
    {
      //
      ...
      this.Text = Catalog.GetString("Languages Report");
      #endregion

      FPetraUtilsObject = new TFrmPetraReportingUtils(AParentFormHandle, this, stbMain);

      FPetraUtilsObject.FXMLFiles = "Personnel\\\\languagesreport.xml";
      FPetraUtilsObject.FReportName = "Languages Report";
      FPetraUtilsObject.FCurrentReport = "Languages Report";
...
#region Column Functions and Calculations
    ...
    */
    public void SetAvailableFunctions()
    {
      ...
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Application Status", 2.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Event Code", 3.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Experience", 2.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Language", 4.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Language Code", 2.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Level", 1.5));
      ...
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Translate", 2.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Into", 1.5));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Out Of", 1.5));
