// auto generated with nant generateWinforms from LocalPersonnelDataReport.yaml
//
...
namespace Ict.Petra.Client.MReporting.Gui.MPersonnel
{
  ...
  /// </summary>
  public partial class TFrmLocalPersonnelDataReport: System.Windows.Forms.Form, IFrmReporting
  {
    ...
    /// constructor
    /// </summary>
    public TFrmLocalPersonnelDataReport(IntPtr AParentFormHandle) : base()
    {
      //
      ...
      this.Text = Catalog.GetString("Local Personnel Data Report");
      #endregion

      FPetraUtilsObject = new TFrmPetraReportingUtils(AParentFormHandle, this, stbMain);

      FPetraUtilsObject.FXMLFiles = "Partner\\\\localpartnerdata.xml";
      FPetraUtilsObject.FReportName = "Local Personnel Data";
      FPetraUtilsObject.FCurrentReport = "Local Partner Data";
...
#region Parameter/Settings Handling
    ...
    */
    public void ReadControls(TRptCalculator ACalc, TReportActionEnum AReportAction)
    {
      ...
      ReadLocalDataLabel(ACalc, AReportAction);
