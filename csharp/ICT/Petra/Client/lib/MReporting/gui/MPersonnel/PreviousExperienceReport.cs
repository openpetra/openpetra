// auto generated with nant generateWinforms from PreviousExperienceReport.yaml
//
...
namespace Ict.Petra.Client.MReporting.Gui.MPersonnel
{
  ...
  /// </summary>
  public partial class TFrmPreviousExperienceReport: System.Windows.Forms.Form, IFrmReporting
  {
    ...
    /// constructor
    /// </summary>
    public TFrmPreviousExperienceReport(IntPtr AParentFormHandle) : base()
    {
      //
      ...
      this.Text = Catalog.GetString("Previous Experience Report");
      #endregion

      FPetraUtilsObject = new TFrmPetraReportingUtils(AParentFormHandle, this, stbMain);

      FPetraUtilsObject.FXMLFiles = "Personnel\\\\previousexperiencereport.xml,Personnel\\\\personnel.xml";
      FPetraUtilsObject.FReportName = "Previous Experience Report";
      FPetraUtilsObject.FCurrentReport = "Previous Experience Report";
...
#region Column Functions and Calculations
    ...
    */
    public void SetAvailableFunctions()
    {
      ...
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Location", 4.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Role", 3.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Type", 3.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Organisation", 5.0));
