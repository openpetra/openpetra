...
namespace Ict.Petra.Client.MReporting.Gui.MPersonnel
{
  ...
  /// </summary>
  public partial class TFrmCampaignOptions: System.Windows.Forms.Form, IFrmReporting
  {
    ...
    /// constructor
    /// </summary>
    public TFrmCampaignOptions(IntPtr AParentFormHandle) : base()
    {
      //
      ...
      this.lblYear.Text = Catalog.GetString("Year:");
      this.lblCampaignCode.Text = Catalog.GetString("Campaign Code:");
      this.lblOne.Text = Catalog.GetString("Insert Year and / or Campaign Code,");
      this.lblTwo.Text = Catalog.GetString("or leave empty to consider all campaign options.");
      this.grpOptions.Text = Catalog.GetString("Choose Options");
      ...
      this.Text = Catalog.GetString("Campaign Options Report");
      #endregion

      this.txtYear.Font = TAppSettingsManager.GetDefaultBoldFont();
      this.txtCampaignCode.Font = TAppSettingsManager.GetDefaultBoldFont();

      FPetraUtilsObject = new TFrmPetraReportingUtils(AParentFormHandle, this, stbMain);

      FPetraUtilsObject.FXMLFiles = "Personnel\\\\campaignoptions.xml";
      FPetraUtilsObject.FReportName = "Campaign Options";
      FPetraUtilsObject.FCurrentReport = "Campaign Options";
...
#region Parameter/Settings Handling
    ...
    */
    public void ReadControls(TRptCalculator ACalc, TReportActionEnum AReportAction)
    {
      ...
      ACalc.AddParameter("param_txtYear", this.txtYear.Text);
      ACalc.AddParameter("param_txtCampaignCode", this.txtCampaignCode.Text);
    ...
    */
    public void SetControls(TParameterList AParameters)
    {
      ...
      txtYear.Text = AParameters.Get("param_txtYear").ToString();
      txtCampaignCode.Text = AParameters.Get("param_txtCampaignCode").ToString();
...
#region Column Functions and Calculations
    ...
    */
    public void SetAvailableFunctions()
    {
      ...
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Unit Code", 2.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Unit Key", 3.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Unit Name", 5.0));
