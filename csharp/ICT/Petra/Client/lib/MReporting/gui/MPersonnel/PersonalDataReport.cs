...
namespace Ict.Petra.Client.MReporting.Gui.MPersonnel
{
  ...
  /// </summary>
  public partial class TFrmPersonalDataReport: System.Windows.Forms.Form, IFrmReporting
  {
    ...
    /// constructor
    /// </summary>
    public TFrmPersonalDataReport(IntPtr AParentFormHandle) : base()
    {
      //
      ...
      this.chkPersonalInfo.Text = Catalog.GetString("Show Personal Info");
      this.chkLocalPartnerData.Text = Catalog.GetString("Show Local Partner Data");
      this.chkLocalPersonnelData.Text = Catalog.GetString("Show Local Personnel Data");
      this.chkJobAssignments.Text = Catalog.GetString("Show Job Assignments");
      this.chkCommitments.Text = Catalog.GetString("Show Commitments");
      this.chkPassport.Text = Catalog.GetString("Show Passport");
      this.chkPersonalDocuments.Text = Catalog.GetString("Show Personal Documents");
      this.chkSpecialNeeds.Text = Catalog.GetString("Show Special Needs");
      this.chkPersonalBudget.Text = Catalog.GetString("Show Personal Budget");
      this.chkVisions.Text = Catalog.GetString("Show Visions");
      this.chkQualifications.Text = Catalog.GetString("Show Qualifications");
      this.chkAbilities.Text = Catalog.GetString("Show Abilities");
      this.chkLanguages.Text = Catalog.GetString("Show Languages");
      this.chkPreviousExperiences.Text = Catalog.GetString("Show Previous Experiences");
      this.chkValuableItems.Text = Catalog.GetString("Show Valuable Items");
      this.grpReportDetails.Text = Catalog.GetString("Report Details");
      this.tpgReportDetails.Text = Catalog.GetString("Report Details");
      ...
      this.Text = Catalog.GetString("Personal Data Report");
      #endregion

      FPetraUtilsObject = new TFrmPetraReportingUtils(AParentFormHandle, this, stbMain);

      FPetraUtilsObject.FXMLFiles = "Personnel\\\\personaldatareport.xml,Personnel\\\\commonpersonnel.xml";
      FPetraUtilsObject.FReportName = "Personal Data Report";
      FPetraUtilsObject.FCurrentReport = "Personal Data Report";
...
#region Parameter/Settings Handling
    ...
    */
    public void ReadControls(TRptCalculator ACalc, TReportActionEnum AReportAction)
    {
      ...
      ACalc.AddParameter("param_chkPersonalInfo", this.chkPersonalInfo.Checked);
      ACalc.AddParameter("param_chkLocalPartnerData", this.chkLocalPartnerData.Checked);
      ACalc.AddParameter("param_chkLocalPersonnelData", this.chkLocalPersonnelData.Checked);
      ACalc.AddParameter("param_chkJobAssignments", this.chkJobAssignments.Checked);
      ACalc.AddParameter("param_chkCommitments", this.chkCommitments.Checked);
      ACalc.AddParameter("param_chkPassport", this.chkPassport.Checked);
      ACalc.AddParameter("param_chkPersonalDocuments", this.chkPersonalDocuments.Checked);
      ACalc.AddParameter("param_chkSpecialNeeds", this.chkSpecialNeeds.Checked);
      ACalc.AddParameter("param_chkPersonalBudget", this.chkPersonalBudget.Checked);
      ACalc.AddParameter("param_chkVisions", this.chkVisions.Checked);
      ACalc.AddParameter("param_chkQualifications", this.chkQualifications.Checked);
      ACalc.AddParameter("param_chkAbilities", this.chkAbilities.Checked);
      ACalc.AddParameter("param_chkLanguages", this.chkLanguages.Checked);
      ACalc.AddParameter("param_chkPreviousExperiences", this.chkPreviousExperiences.Checked);
      ACalc.AddParameter("param_chkValuableItems", this.chkValuableItems.Checked);
    ...
    */
    public void SetControls(TParameterList AParameters)
    {
      ...
      chkPersonalInfo.Checked = AParameters.Get("param_chkPersonalInfo").ToBool();
      chkLocalPartnerData.Checked = AParameters.Get("param_chkLocalPartnerData").ToBool();
      chkLocalPersonnelData.Checked = AParameters.Get("param_chkLocalPersonnelData").ToBool();
      chkJobAssignments.Checked = AParameters.Get("param_chkJobAssignments").ToBool();
      chkCommitments.Checked = AParameters.Get("param_chkCommitments").ToBool();
      chkPassport.Checked = AParameters.Get("param_chkPassport").ToBool();
      chkPersonalDocuments.Checked = AParameters.Get("param_chkPersonalDocuments").ToBool();
      chkSpecialNeeds.Checked = AParameters.Get("param_chkSpecialNeeds").ToBool();
      chkPersonalBudget.Checked = AParameters.Get("param_chkPersonalBudget").ToBool();
      chkVisions.Checked = AParameters.Get("param_chkVisions").ToBool();
      chkQualifications.Checked = AParameters.Get("param_chkQualifications").ToBool();
      chkAbilities.Checked = AParameters.Get("param_chkAbilities").ToBool();
      chkLanguages.Checked = AParameters.Get("param_chkLanguages").ToBool();
      chkPreviousExperiences.Checked = AParameters.Get("param_chkPreviousExperiences").ToBool();
      chkValuableItems.Checked = AParameters.Get("param_chkValuableItems").ToBool();
    }
#endregion
