...
namespace Ict.Petra.Client.MReporting.Gui.MPersonnel
{
  ...
  public partial class TFrmUC_ShortTermerSelection: UserControl, Ict.Petra.Client.CommonForms.IFrmPetra
  {
    ...
    public TFrmUC_ShortTermerSelection() : base()
    {
      ...
      this.chkAccepted.Text = Catalog.GetString("Accepted");
      this.chkCancelled.Text = Catalog.GetString("Cancelled");
      this.chkHold.Text = Catalog.GetString("Hold");
      this.chkEnquiry.Text = Catalog.GetString("Enquiry");
      this.chkRejected.Text = Catalog.GetString("Rejected");
