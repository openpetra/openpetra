// auto generated with nant generateWinforms from ProgressReport.yaml
//
...
namespace Ict.Petra.Client.MReporting.Gui.MPersonnel
{
  ...
  /// </summary>
  public partial class TFrmProgressReport: System.Windows.Forms.Form, IFrmReporting
  {
    ...
    /// constructor
    /// </summary>
    public TFrmProgressReport(IntPtr AParentFormHandle) : base()
    {
      //
      ...
      this.Text = Catalog.GetString("Progress Report");
      #endregion

      FPetraUtilsObject = new TFrmPetraReportingUtils(AParentFormHandle, this, stbMain);

      FPetraUtilsObject.FXMLFiles = "Personnel\\\\progressreport.xml,Personnel\\\\personnel.xml";
      FPetraUtilsObject.FReportName = "Progress Report";
      FPetraUtilsObject.FCurrentReport = "Progress Report";
...
#region Column Functions and Calculations
    ...
    */
    public void SetAvailableFunctions()
    {
      ...
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Report Date", 3.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Report Type", 3.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Reporter", 4.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Next Report Date", 3.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Report Comment", 8.0));
