...
#region grid selection handling
		private void InitRelationshipList()
		{
			...
			if (grdDirectRelationship.Columns.Count == 0)
            {
                ...
                grdDirectRelationship.AddTextColumn(Catalog.GetString("Relationship"), FDirectRelationshipTable.Columns[PRelationTable.GetRelationNameDBName()]);
                grdDirectRelationship.AddTextColumn(Catalog.GetString("Description"), FDirectRelationshipTable.Columns[PRelationTable.GetRelationDescriptionDBName()]);
                
                grdReciprocalRelationship.AddCheckBoxColumn("", FReciprocalRelationshipTable.Columns["Selection"]);
                grdReciprocalRelationship.AddTextColumn(Catalog.GetString("Relationship"), FReciprocalRelationshipTable.Columns[PRelationTable.GetRelationNameDBName()]);
                grdReciprocalRelationship.AddTextColumn(Catalog.GetString("Description"), FReciprocalRelationshipTable.Columns[PRelationTable.GetReciprocalDescriptionDBName()]);
            }
