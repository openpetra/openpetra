...
namespace Ict.Petra.Client.MReporting.Gui.MPersonnel
{
  ...
  /// auto generated: Select Event
  public partial class TFrmSelectEvent: System.Windows.Forms.Form, Ict.Petra.Client.CommonForms.IFrmPetra
  {
    private Ict.Petra.Client.CommonForms.TFrmPetraUtils FPetraUtilsObject;

    /// constructor
    public TFrmSelectEvent(IntPtr AParentFormHandle) : base()
    {
      //
      ...
      this.rbtCampaign.Text = Catalog.GetString("Campaigns Only");
      ...
      this.Text = Catalog.GetString("Select Event");
      #endregion
