...
namespace Ict.Petra.Client.MFinance.Gui.Gift
{
    public partial class TUC_RecurringGiftTransactions
    {
        ...
        private void ReconcileMotivationDetailFromCombo(GiftBatchTDSARecurringGiftDetailRow ACurrentDetailRow)
        {
            if (FInEditModeFlag)
            {
        ...
        private void ReconcileMotivationDetailFromTextbox(GiftBatchTDSARecurringGiftDetailRow ACurrentDetailRow)
        {
            if (FInEditModeFlag)
            {
                bool isEmptyDetailRow = (ACurrentDetailRow == null);
        ...
        private void MotivationDetailChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (!txtDetailRecipientKeyMinistry.Visible
                    && !string.IsNullOrEmpty(FAutoPopComment))
                {
        ...
        private void ProcessMotivationDetailRow()
        {
            ...
            if (FMotivationDetail.Length > 0)
            {
                ...
                if (motivationDetail != null)
                {
                    ...
                    if (!FInBeginEditModeFlag && (!FPetraUtilsObject.SuppressChangeDetection || FRecipientKeyChangedInProcess))
                    {
