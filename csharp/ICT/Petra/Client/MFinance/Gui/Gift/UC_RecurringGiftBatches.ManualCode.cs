    ...
    public partial class TUC_RecurringGiftBatches
    {
        ...
        private bool DeleteRowManual(ARecurringGiftBatchRow ARowToDelete, ref string ACompletionMessage)
        {
            ...
            try
            {
                ...
                if (!newBatch)
                {
                    ...
                    FMainDS.Merge(TRemote.MFinance.Gift.WebConnectors.LoadARecurringGiftTransactions(FLedgerNumber, batchNumber));
                }
        ...
        private Boolean LoadAllBatchData(int ABatchNumber = 0)
        {
            ...
            try
            {
                ...
                if (GiftDV.Count == 0)
                {
                    FMainDS.Merge(TRemote.MFinance.Gift.WebConnectors.LoadARecurringGiftTransactions(FLedgerNumber, FSelectedBatchNumber));
                }
