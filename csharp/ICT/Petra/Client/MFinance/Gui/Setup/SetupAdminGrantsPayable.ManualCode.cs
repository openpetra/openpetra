...
//        private void FormatAsPercent(object sender, System.EventArgs e)
//        {
//            Boolean canConvert;
//            decimal percentVal = 0;
//            String numString = txtDetailChargePercentage.Text;
//            canConvert = decimal.TryParse(numString, out percentVal);
//            
//            if (canConvert == true)
//            {
//              txtDetailChargePercentage.Text = String.Format("{0:0.0%}", Convert.ToDecimal(txtDetailChargePercentage.Text));
//            }
//            else
//            {
//                MessageBox.Show("Percentage must be a numeric value");
//                txtDetailChargePercentage.Select();
//            }
//            
//        }
//        
        private void PopulateCombos()
        {
            ...
            Table1.DefaultView.RowFilter = ACostCentreTable.GetPostingCostCentreFlagDBName() + " = true";
