...
namespace Ict.Petra.Client.MFinance.Logic
{
    ...
    public static class TExWorkerWarning
    {
        ...
        public static bool CanContinueWithAnyExWorkers(GiftBatchAction AAction, GiftBatchTDS AMainDS, TFrmPetraEditUtils APetraUtilsObject, DataTable APostingGiftDetails = null)
        {
