// auto generated with nant generateWinforms from PresentAttendeeReport.yaml
//
...
namespace Ict.Petra.Client.MReporting.Gui.MConference
{
  ...
  /// </summary>
  public partial class TFrmPresentAttendeeReport: System.Windows.Forms.Form, IFrmReporting
  {
    ...
    /// constructor
    /// </summary>
    public TFrmPresentAttendeeReport(IntPtr AParentFormHandle) : base()
    {
      //
      ...
      this.Text = Catalog.GetString("Present Attendee Report");
      #endregion

      FPetraUtilsObject = new TFrmPetraReportingUtils(AParentFormHandle, this, stbMain);

      FPetraUtilsObject.FXMLFiles = "Conference\\\\presentattendeereport.xml,Conference\\\\conference.xml";
      FPetraUtilsObject.FReportName = "Present Attendee Report";
      FPetraUtilsObject.FCurrentReport = "Present Attendee Report";
