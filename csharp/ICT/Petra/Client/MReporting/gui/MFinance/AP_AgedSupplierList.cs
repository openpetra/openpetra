...
namespace Ict.Petra.Client.MReporting.Gui.MFinance
{
  ...
  /// </summary>
  public partial class TFrmAP_AgedSupplierList: System.Windows.Forms.Form, IFrmReporting
  {
    ...
    /// constructor
    /// </summary>
    public TFrmAP_AgedSupplierList(IntPtr AParentFormHandle) : base()
    {
      //
      ...
      this.lblDateSelection.Text = Catalog.GetString("Date for Report:");
      this.lblInvoice.Text = Catalog.GetString("Show Invoices:");
      this.lblDiscounted.Text = Catalog.GetString("Discounted Only:");
      this.grpSelection.Text = Catalog.GetString("Settings");
      ...
      this.Text = Catalog.GetString("AP Aged Supplier List");
      #endregion

      FPetraUtilsObject = new TFrmPetraReportingUtils(AParentFormHandle, this, stbMain);

      FPetraUtilsObject.FXMLFiles = "Finance\\\\AP_agedsupplierlist.xml,Finance\\\\finance.xml,common.xml";
      FPetraUtilsObject.FReportName = "APAgedSupplierList";
      FPetraUtilsObject.FCurrentReport = "APAgedSupplierList";
...
#region Parameter/Settings Handling
    ...
    */
    public void ReadControls(TRptCalculator ACalc, TReportActionEnum AReportAction)
    {
      ...
      ACalc.AddParameter("param_date_selection", this.dtpDateSelection.Date);
      ACalc.AddParameter("param_show_invoices", this.chkInvoice.Checked);
      ACalc.AddParameter("param_discounted_only", this.chkDiscounted.Checked);
    ...
    */
    public void SetControls(TParameterList AParameters)
    {
      ...
      DateTime dtpDateSelectionDate = AParameters.Get("param_date_selection").ToDate();
      if ((dtpDateSelectionDate <= DateTime.MinValue)
          || (dtpDateSelectionDate >= DateTime.MaxValue))
      {
          dtpDateSelectionDate = DateTime.Now;
      }
      dtpDateSelection.Date = dtpDateSelectionDate;
      chkInvoice.Checked = AParameters.Get("param_show_invoices").ToBool();
      chkDiscounted.Checked = AParameters.Get("param_discounted_only").ToBool();
    }
#endregion
