...
namespace Ict.Petra.Client.MReporting.Gui.MFinance
{
  ...
  /// </summary>
  public partial class TFrmFieldLeaderGiftSummary: System.Windows.Forms.Form, IFrmReporting
  {
    ...
    /// constructor
    /// </summary>
    public TFrmFieldLeaderGiftSummary(IntPtr AParentFormHandle) : base()
    {
      //
      ...
      this.Text = Catalog.GetString("Field Leader Gift Summary");
      #endregion

      FPetraUtilsObject = new TFrmPetraReportingUtils(AParentFormHandle, this, stbMain);

      FPetraUtilsObject.FXMLFiles = "Finance\\\\fieldleadergiftsummary.xml,Finance\\\\finance.xml,common.xml";
      FPetraUtilsObject.FReportName = "FieldLeaderGiftSummary";
      FPetraUtilsObject.FCurrentReport = "FieldLeaderGiftSummary";
