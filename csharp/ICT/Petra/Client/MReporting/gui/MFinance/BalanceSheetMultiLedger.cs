...
namespace Ict.Petra.Client.MReporting.Gui.MFinance
{
  ...
  /// </summary>
  public partial class TFrmBalanceSheetMultiLedger: System.Windows.Forms.Form, IFrmReporting
  {
    ...
    /// constructor
    /// </summary>
    public TFrmBalanceSheetMultiLedger(IntPtr AParentFormHandle) : base()
    {
      //
      ...
      this.Text = Catalog.GetString("Balance Sheet Multi Ledger");
      #endregion
      ...
      FPetraUtilsObject.FReportName = "Balance Sheet Multi Ledger";
      ...
      uco_FinanceColumns.SetVisibility(false, true);
