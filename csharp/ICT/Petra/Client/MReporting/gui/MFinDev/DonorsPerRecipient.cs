// auto generated with nant generateWinforms from DonorsPerRecipient.yaml
//
...
namespace Ict.Petra.Client.MReporting.Gui.MFinDev
{
  ...
  /// </summary>
  public partial class TFrmDonorsPerRecipient: System.Windows.Forms.Form, IFrmReporting
  {
    ...
    /// constructor
    /// </summary>
    public TFrmDonorsPerRecipient(IntPtr AParentFormHandle) : base()
    {
      //
      ...
      this.grpRecipient.Text = Catalog.GetString("Recipient");
      ...
      this.Text = Catalog.GetString("Donors per Recipient");
      #endregion

      FPetraUtilsObject = new TFrmPetraReportingUtils(AParentFormHandle, this, stbMain);

      FPetraUtilsObject.FXMLFiles = "FinancialDevelopment/fddonorsperrecipient.xml,common.xml";
      FPetraUtilsObject.FReportName = "FDDonorsPerRecipient";
      FPetraUtilsObject.FCurrentReport = "FDDonorsPerRecipient";
...
#region Column Functions and Calculations
    ...
    */
    public void SetAvailableFunctions()
    {
      ...
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Subscriptions", 6.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Last Gift Date", 2.5));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Last Gift Comment1", 3.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Last Gift Comment2", 3.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Last Gift Comment3", 3.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Last Gift Amount", 2.5));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Last Gift Motivation", 3.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Last Gift Other Recipient", 3.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Last Gift Other Motivation", 3.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Last Gift Other Date", 2.5));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Last Gift Other Comment1", 3.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Last Gift Other Comment2", 3.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Last Gift Other Comment3", 3.0));
      FPetraUtilsObject.AddAvailableFunction(new TPartnerColumnFunction("Last Gift Other Ammount", 2.0));
