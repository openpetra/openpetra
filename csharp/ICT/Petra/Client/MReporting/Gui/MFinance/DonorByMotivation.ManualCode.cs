...
namespace Ict.Petra.Client.MReporting.Gui.MFinance
{
    public partial class TFrmDonorByMotivation
    {
        ...
        private void InitializeMotivationGroupList()
        {
            ...
            DataTable MotGroupTable = TDataCache.TMFinance.GetCacheableFinanceTable(TCacheableFinanceTablesEnum.MotivationGroupList, GetSelectedLedger());
            ...
            clbMotivationGroup.DataBindGrid(NewMotGroupTable, ValueMemberMotGroup, CheckedMemberMotGroup, ValueMemberMotGroup, DisplayMemberMotGroup, false, true, false);
        ...
        private void InitializeMotivationDetailList()
        {
            ...
            DataTable NewMotDetailTable = MotDetailView.ToTable(true, new string[] { Value2MemberMotDetail, Value1MemberMotDetail, DisplayMemberMotDetail });
