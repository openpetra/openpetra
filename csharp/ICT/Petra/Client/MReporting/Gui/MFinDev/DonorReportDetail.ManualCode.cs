...
namespace Ict.Petra.Client.MReporting.Gui.MFinDev
{
    public partial class TFrmDonorReportDetail
    {
        ...
        private bool LoadReportData(TRptCalculator ACalc)
        {
            ...
            DataSet ReportSet = TRemote.MReporting.WebConnectors.GetReportDataSet("DonorReportDetail", paramsDictionary);
            ...
            FPetraUtilsObject.FFastReportsPlugin.RegisterData(ReportSet.Tables["DonorReportDetail"], "DonorReportDetail");
