...
namespace Ict.Petra.Client.MPartner.Gui
{
    public partial class TUC_IndividualData_PersonalDocuments
    {
        ...
        public void SpecialInitUserControl(IndividualDataTDS AMainDS)
        {
            ...
            this.SizeChanged += TUC_IndividualData_PersonalDocuments_SizeChanged;

            // Cannot resize the grid here because the grid columns have not been defined yet
        }

        private void TUC_IndividualData_PersonalDocuments_SizeChanged(object sender, EventArgs e)
        {
            ...
            if (myParent.CurrentControl == TUC_IndividualData.TDynamicLoadableUserControls.dlucPersonalDocuments)
            {
