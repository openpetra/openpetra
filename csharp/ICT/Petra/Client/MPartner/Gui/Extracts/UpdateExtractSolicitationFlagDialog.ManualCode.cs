...
namespace Ict.Petra.Client.MPartner.Gui.Extracts
{
    ...
    public partial class TFrmUpdateExtractSolicitationFlagDialog : System.Windows.Forms.Form
    {
        /// <summary>
        ...
        public Boolean GetReturnedParameters(out Boolean ANoSolicitations)
        {
            Boolean ReturnValue = true;

            ANoSolicitations = chkNoSolicitations.Checked;
        ...
        {
            if (MessageBox.Show(Catalog.GetString("Are you sure that you want to change the 'No Solicitations' flag" +
                        "\r\nfor all partners in the extract?"),
                    Catalog.GetString("Change 'No Solicitations' flag?"),
