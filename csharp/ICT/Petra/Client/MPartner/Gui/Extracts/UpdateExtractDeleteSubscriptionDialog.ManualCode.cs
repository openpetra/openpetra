...
namespace Ict.Petra.Client.MPartner.Gui.Extracts
{
    ...
    public partial class TFrmUpdateExtractDeleteSubscriptionDialog : System.Windows.Forms.Form
    {
        /// <summary>
        ...
        {
            lblExtractNameAndExplanation.Text = Catalog.GetString("Delete this Subscription for all Partners in Extract ") + AExtractName;
        }
        ...
        public Boolean GetReturnedParameters(out String APublicationCode)
        {
