...
namespace Ict.Petra.Client.MPartner.Gui.Setup
{
    public partial class TFrmPartnerTypeSetup
    {
        ...
        private void NewRowManual(ref PTypeRow ARow)
        {
            ...
            if (FMainDS.PType.Rows.Find(new object[] { newName }) != null)
            {
                while (FMainDS.PType.Rows.Find(new object[] { newName + countNewDetail.ToString() }) != null)
                {
                    countNewDetail++;
                }
        ...
        private void PrintGrid(TStandardFormPrint.TPrintUsing APrintApplication, bool APreviewMode)
        {
            TStandardFormPrint.PrintGrid(APrintApplication, APreviewMode, TModule.mPartner, this.Text, grdDetails,
                ...
                new int[]
                {
                    PTypeTable.ColumnTypeCodeId,
                    PTypeTable.ColumnTypeDescriptionId,
                    PTypeTable.ColumnValidTypeId,
                    PTypeTable.ColumnTypeDeletableId
                });
        }
    }
}