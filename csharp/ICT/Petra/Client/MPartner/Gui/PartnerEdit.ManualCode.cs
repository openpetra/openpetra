...
// TODO            "Partner Status wasn't changed - it was already set to '{0}'.");
        ...
        public int GetChangedRecordCount(out string AMessage)
        {
            ...
            // Find out which tables have changes
            ...
            {
                // Partner uses a multi-table DataSet
                ...
                {
                    string NiceTableName = null;

                    //TODO: Message from Alan - can someone go through this section and enter appropriate table names that can be globalised.  (Wolfgang??)
                    if (TableAndCount.Item1 == PartnerEditTDSFamilyMembersTable.GetTableName())
                    {
                        NiceTableName = Catalog.GetString("Family Members");
                    }
                    else if (TableAndCount.Item1 == PartnerEditTDSFamilyMembersInfoForStatusChangeTable.GetTableName())
                    {
                        NiceTableName = Catalog.GetString("Family Member Status");
                    }
                    else if (TableAndCount.Item1 == PartnerEditTDSMiscellaneousDataTable.GetTableName())
                    {
                        NiceTableName = Catalog.GetString("Miscellaneous Data");
                    }
                    else if (TableAndCount.Item1 == PartnerEditTDSPartnerTypeChangeFamilyMembersPromotionTable.GetTableName())
                    {
                        NiceTableName = Catalog.GetString("Family Members Promotion");
                    }
                    else if (TableAndCount.Item1 == PBankTable.GetTableName())
                    {
                        NiceTableName = Catalog.GetString("Bank");
                    }
                    else if (TableAndCount.Item1 == PartnerEditTDSPBankingDetailsTable.GetTableName())
                    {
                        NiceTableName = Catalog.GetString("Banking Details");
                    }
                    else if (TableAndCount.Item1 == PBankingDetailsUsageTable.GetTableName())
                    {
                        NiceTableName = Catalog.GetString("Banking Details Usage");
                    }
                    else if (TableAndCount.Item1 == PChurchTable.GetTableName())
                    {
                        NiceTableName = Catalog.GetString("Church");
                    }
                    else if (TableAndCount.Item1 == PDataLabelValueApplicationTable.GetTableName())
                    {
                        NiceTableName = Catalog.GetString("Application Data Label Value");
                    }
                    else if (TableAndCount.Item1 == PDataLabelValuePartnerTable.GetTableName())
                    {
                        NiceTableName = Catalog.GetString("Partner Data Label Value");
                    }
                    else if (TableAndCount.Item1 == PartnerEditTDSPFamilyTable.GetTableName())
                    {
                        NiceTableName = Catalog.GetString("Family");
                    }
                    else if (TableAndCount.Item1 == PFoundationTable.GetTableName())
                    {
                        NiceTableName = Catalog.GetString("Foundation");
                    }
                    else if (TableAndCount.Item1 == PFoundationDeadlineTable.GetTableName())
                    {
                        NiceTableName = Catalog.GetString("Foundation Deadline");
                    }
                    else if (TableAndCount.Item1 == PFoundationProposalTable.GetTableName())
                    {
                        NiceTableName = Catalog.GetString("Foundation Proposal");
                    }
                    else if (TableAndCount.Item1 == PFoundationProposalDetailTable.GetTableName())
                    {
                        NiceTableName = Catalog.GetString("Foundation Proposal Details");
                    }
                    else if (TableAndCount.Item1 == PInterestTable.GetTableName())
                    {
                        NiceTableName = Catalog.GetString("Interest");
                    }
                    else if (TableAndCount.Item1 == PLocationTable.GetTableName())
                    {
                        NiceTableName = Catalog.GetString("Location");
                    }
                    else if (TableAndCount.Item1 == POrganisationTable.GetTableName())
                    {
                        NiceTableName = Catalog.GetString("Organisation");
                    }
                    else if (TableAndCount.Item1 == PPartnerTable.GetTableName())
                    {
                        NiceTableName = Catalog.GetString("Partner");
                    }
                    else if (TableAndCount.Item1 == PPartnerBankingDetailsTable.GetTableName())
                    {
                        NiceTableName = Catalog.GetString("Partner Banking Details");
                    }
                    else if (TableAndCount.Item1 == PPartnerContactTable.GetTableName())
                    {
                        NiceTableName = Catalog.GetString("Partner Contact");
                    }
                    else if (TableAndCount.Item1 == PPartnerGiftDestinationTable.GetTableName())
                    {
                        NiceTableName = Catalog.GetString("Partner Gift Destination");
                    }
                    else if (TableAndCount.Item1 == PartnerEditTDSPPartnerInterestTable.GetTableName())
                    {
                        NiceTableName = Catalog.GetString("Partner Interest");
                    }
                    else if (TableAndCount.Item1 == PartnerEditTDSPPartnerLocationTable.GetTableName())
                    {
                        NiceTableName = Catalog.GetString("Partner Location");
                    }
                    else if (TableAndCount.Item1 == PartnerEditTDSPPartnerRelationshipTable.GetTableName())
                    {
                        NiceTableName = Catalog.GetString("Partner Relationship");
                    }
                    else if (TableAndCount.Item1 == PPartnerReminderTable.GetTableName())
                    {
                        NiceTableName = Catalog.GetString("Partner Reminder");
                    }
                    else if (TableAndCount.Item1 == PPartnerTaxDeductiblePctTable.GetTableName())
                    {
                        NiceTableName = Catalog.GetString("Partner Tax Deductible Percentage");
                    }
                    else if (TableAndCount.Item1 == PPartnerTypeTable.GetTableName())
                    {
                        NiceTableName = Catalog.GetString("Partner Type");
                    }
                    else if (TableAndCount.Item1 == PartnerEditTDSPPersonTable.GetTableName())
                    {
                        NiceTableName = Catalog.GetString("Person");
                    }
                    else if (TableAndCount.Item1 == PSubscriptionTable.GetTableName())
                    {
                        NiceTableName = Catalog.GetString("Subscription");
                    }
                    else if (TableAndCount.Item1 == PUnitTable.GetTableName())
                    {
                        NiceTableName = Catalog.GetString("Unit");
                    }
                    else if (TableAndCount.Item1 == PVenueTable.GetTableName())
                    {
                        NiceTableName = Catalog.GetString("Venue");
                    }
                    else if (TableAndCount.Item1 == UmUnitStructureTable.GetTableName())
                    {
                        NiceTableName = Catalog.GetString("Unit Structure");
                    }
                    else if (TableAndCount.Item1 == IndividualDataTDSJobAssignmentStaffDataCombinedTable.GetTableName())
                    {
                        NiceTableName = Catalog.GetString("Job Assignment Staff Data");
                    }
                    else if (TableAndCount.Item1 == PmDocumentTable.GetTableName())
                    {
                        NiceTableName = Catalog.GetString("Document");
                    }
                    else if (TableAndCount.Item1 == IndividualDataTDSPmGeneralApplicationTable.GetTableName())
                    {
                        NiceTableName = Catalog.GetString("General Application");
                    }
                    else if (TableAndCount.Item1 == PmJobAssignmentTable.GetTableName())
                    {
                        NiceTableName = Catalog.GetString("Job Assignment");
                    }
                    else if (TableAndCount.Item1 == IndividualDataTDSPmPassportDetailsTable.GetTableName())
                    {
                        NiceTableName = Catalog.GetString("Passport Details");
                    }
                    else if (TableAndCount.Item1 == PmPastExperienceTable.GetTableName())
                    {
                        NiceTableName = Catalog.GetString("Past Experience");
                    }
                    else if (TableAndCount.Item1 == PmPersonAbilityTable.GetTableName())
                    {
                        NiceTableName = Catalog.GetString("Person Ability");
                    }
                    else if (TableAndCount.Item1 == PmPersonalDataTable.GetTableName())
                    {
                        NiceTableName = Catalog.GetString("Personal Data");
                    }
                    else if (TableAndCount.Item1 == PmPersonEvaluationTable.GetTableName())
                    {
                        NiceTableName = Catalog.GetString("Person Evaluation");
                    }
                    else if (TableAndCount.Item1 == IndividualDataTDSPmPersonLanguageTable.GetTableName())
                    {
                        NiceTableName = Catalog.GetString("Person Language");
                    }
                    else if (TableAndCount.Item1 == PmPersonQualificationTable.GetTableName())
                    {
                        NiceTableName = Catalog.GetString("Person Qualification");
                    }
                    else if (TableAndCount.Item1 == PmPersonSkillTable.GetTableName())
                    {
                        NiceTableName = Catalog.GetString("Person Skill");
                    }
                    else if (TableAndCount.Item1 == PmShortTermApplicationTable.GetTableName())
                    {
                        NiceTableName = Catalog.GetString("Short Term Application");
                    }
                    else if (TableAndCount.Item1 == PmSpecialNeedTable.GetTableName())
                    {
                        NiceTableName = Catalog.GetString("Special Need");
                    }
                    else if (TableAndCount.Item1 == PmStaffDataTable.GetTableName())
                    {
                        NiceTableName = Catalog.GetString("Staff Data");
                    }
                    else if (TableAndCount.Item1 == PmYearProgramApplicationTable.GetTableName())
                    {
                        NiceTableName = Catalog.GetString("Year Program Application");
                    }
                    else if (TableAndCount.Item1 == IndividualDataTDSSummaryDataTable.GetTableName())
                    {
                        NiceTableName = Catalog.GetString("Summary Data");
                    }
                    else if (TableAndCount.Item1 == PmCommitmentStatusTable.GetTableName())
                    {
                        NiceTableName = Catalog.GetString("Commitment Status");
                    }
                    else
                    {
                        string msg = String.Format("No nice table name definition for {0} in GetChangedRecordCount()", TableAndCount.Item1);
                        TLogging.Log(msg);

                        NiceTableName = StringHelper.ReverseUpperCamelCase(TableAndCount.Item1);
