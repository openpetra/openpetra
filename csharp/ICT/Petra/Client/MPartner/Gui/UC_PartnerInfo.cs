...
namespace Ict.Petra.Client.MPartner.Gui
{
    ...
    public partial class TUC_PartnerInfo : TPetraUserControl, IPartnerInfoMethods
    {
        ...
        private static readonly string StrPartnerOrLocationNotExistantTextReRunSearchText =
            Catalog.GetString("Please re-run the search operation by pressing 'Search' to get up-to-date Find Results.");

        private static readonly string StrPartnerOrLocationNotExistantTitle =
            Catalog.GetString("Partner Information Cannot be Shown for Partner {0}");

        private static readonly string StrPartnerInfoCannotBeShownDueToTooBusyServerText =
            String.Format(AppCoreResourcestrings.StrPetraServerTooBusyGeneric,
                Catalog.GetString(
                    "retrieve Partner Info data for the selected Partner.\r\n\r\n" +
                    "Press the 'Reload' button on the right (green circular arrow) to request the data again."));
...
//            TLogging.Log("Received UpdateControls request for Partner " + APartnerKey.ToString() + ".");
        ...
        private void ClearControls(bool AClearOnlyAddressData, Int64 APartnerNotFound)
        {
            ...
            lblNoPartner.Font = new System.Drawing.Font("Verdana", 8.25F, System.Drawing.FontStyle.Regular,
            ...
            if (FServerCallError == String.Empty)
            {
                ...
                {
                    lblNoPartner.Text = Catalog.GetString("No Partner to display.");
                }
                else
                {
...
//            MessageBox.Show(String.Format("AValue: {0}; ALinkEnd: {1}", AValue, ALinkEnd));
        ...
        {
            // Ensure no data left-over data bits are still displayed
            ClearControls();

            lblNoPartner.Text = "Reloading Partner Info data...";
            ...
            try
            {
                // Ensure we retrieve and display the full amount of data for the Partner that we are re-loading data for!
                FLastPartnerKey = -1;
                FServerCallParams.PartnerInfoScope = TPartnerInfoScopeEnum.pisFull;
                FServerCallParams.Scope = TPartnerInfoAvailDataEnum.piadNone;
