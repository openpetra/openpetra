...
namespace Ict.Petra.Client.App.Core
{
    ...
    partial class TUnhandledExceptionForm
    {
        ...
        // Needed to comment the Dispose Method out to prevent infinite loop - very strange!
        // This Form still doesn't work when called through WinForms in case an
        // Unhandled Exception occurs, but at least it doesn't crash anymore...
