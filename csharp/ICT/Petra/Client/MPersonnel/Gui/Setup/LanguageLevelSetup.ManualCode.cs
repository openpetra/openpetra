...
namespace Ict.Petra.Client.MPersonnel.Gui.Setup
{
    public partial class TFrmLanguageLevelSetup
    {
        ...
        private void NewRowManual(ref PtLanguageLevelRow ARow)
        {
            ...
            while (FMainDS.PtLanguageLevel.Rows.Find(new object[] { newLevel }) != null)
            {
                newLevel++;
            }

            ARow.LanguageLevel = newLevel;
        }

        private void NewRecord(Object sender, EventArgs e)
        {
            CreateNewPtLanguageLevel();
        }
        ...
        private void ValidateDataDetailsManual(PtLanguageLevelRow ARow)
        {
