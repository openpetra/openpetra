    ...
    public partial class TFrmPassportTypeSetup
    {
        ...
        private void PrintGrid(TStandardFormPrint.TPrintUsing APrintApplication, bool APreviewMode)
        {
            TFrmSelectPrintFields.SelectAndPrintGridFields(this, APrintApplication, APreviewMode, TModule.mPartner, this.Text, grdDetails,
                new int[]
                {
                    PtPassportTypeTable.ColumnCodeId,
                    PtPassportTypeTable.ColumnDescriptionId,
                    PtPassportTypeTable.ColumnUnassignableFlagId,
                    PtPassportTypeTable.ColumnUnassignableDateId,
                    PtPassportTypeTable.ColumnDeletableFlagId
                });
        }
    }
}