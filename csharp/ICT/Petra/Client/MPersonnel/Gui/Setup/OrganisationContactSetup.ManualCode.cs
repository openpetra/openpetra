    ...
    public partial class TFrmOrganisationContactSetup
    {
        ...
        private void PrintGrid(TStandardFormPrint.TPrintUsing APrintApplication, bool APreviewMode)
        {
            TFrmSelectPrintFields.SelectAndPrintGridFields(this, APrintApplication, APreviewMode, TModule.mPartner, this.Text, grdDetails,
                new int[]
                {
                    PtContactTable.ColumnContactNameId,
                    PtContactTable.ColumnContactDescrId,
                    PtContactTable.ColumnUnassignableFlagId,
                    PtContactTable.ColumnUnassignableDateId,
                    PtContactTable.ColumnDeletableFlagId
                });
        }
    }
}