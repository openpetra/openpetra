    ...
    public class TCacheableTablesManager : MarshalByRefObject, ICacheableTablesManager
    {
        ...
        public Int32 CacheSize
        {
            get
            {
                ...
                try
                {
//                  TLogging.LogAtLevel(10, this.GetType().FullName + ".get_CacheSize waiting for a ReaderLock...");
...
//                  TLogging.LogAtLevel(10, this.GetType().FullName + ".get_CacheSize grabbed a ReaderLock.");
...
//                  TLogging.LogAtLevel(10, this.GetType().FullName + ".get_CacheSize released the ReaderLock.");
                }
                return ReturnValue;
            }
        }
        ...
        public Int32 CachedTablesCount
        {
            get
            {
                ...
                try
                {
//                  TLogging.LogAtLevel(10, this.GetType().FullName + ".get_CachedTablesCount waiting for a ReaderLock...");
...
//                  TLogging.LogAtLevel(10, this.GetType().FullName + ".get_CachedTablesCount grabbed a ReaderLock.");
                ...
                finally
                {
                    // Release read lock
                    FReadWriteLock.ReleaseReaderLock();
//                  TLogging.LogAtLevel(10, this.GetType().FullName + ".get_CachedTablesCount released the ReaderLock.");
                }
                return ReturnValue;
            }
        }
        ...
        {
//          TLogging.LogAtLevel(9, this.GetType().FullName + " created: Instance hash is " + this.GetHashCode().ToString() + ". AppDomain '" +
//                  AppDomain.CurrentDomain.FriendlyName + "'.");
        ...
        public DataTable GetCachedDataTable(String ACacheableTableName, out System.Type AType)
        {
            ...
            try
            {
//              TLogging.LogAtLevel(10, this.GetType().FullName + ".GetCachedDataTable waiting for a ReaderLock...");

                // Try to get a read lock [We don't specify a timeout because reading the DB tables into the cached table should be fairly quick]
                FReadWriteLock.AcquireReaderLock(SharedConstants.THREADING_WAIT_INFINITE);
//              TLogging.LogAtLevel(10, this.GetType().FullName + ".GetCachedDataTable grabbed a ReaderLock.");
                ...
                if (ContentsEntryDR != null)
                {
                    if (ContentsEntryDR.DataUpToDate)
                    {
                        try
                        {
//                          TLogging.LogAtLevel(10, this.GetType().FullName + ".GetCachedDataTable waiting for upgrading to a WriterLock...");
...
//                          TLogging.LogAtLevel(10, this.GetType().FullName + ".GetCachedDataTable upgraded to a WriterLock.");
                            ContentsEntryDR.LastAccessed = DateTime.Now;
                        }
                        finally
                        {
//                          TLogging.LogAtLevel(10, this.GetType().FullName + ".GetCachedDataTable waiting for downgrading to a ReaderLock...");

                            // Downgrade from a WriterLock to a ReaderLock again!
                            FReadWriteLock.DowngradeFromWriterLock(ref UpgradeLockCookie);
//                          TLogging.LogAtLevel(10, this.GetType().FullName + ".GetCachedDataTable downgraded to a ReaderLock.");
                        }
                    }
                    else
                    {
            ...
            finally
            {
                // Release read lock
                FReadWriteLock.ReleaseReaderLock();
//              TLogging.LogAtLevel(10, this.GetType().FullName + ".GetCachedDataTable released the ReaderLock.");
            }
...
//          TLogging.LogAtLevel(7, this.GetType().FullName + ".GetCachedDataTable: Returned Type: " + TmpTable.GetType().FullName);
        ...
        public System.Type GetCachedDataTableType(String ACacheableTableName)
        {
            ...
            try
            {
//              TLogging.LogAtLevel(10, this.GetType().FullName + ".GetCachedDataTableType waiting for a ReaderLock...");

                // Try to get a read lock [We don't specify a timeout because reading the DB tables into the cached table should be fairly quick]
                FReadWriteLock.AcquireReaderLock(SharedConstants.THREADING_WAIT_INFINITE);
//              TLogging.LogAtLevel(10, this.GetType().FullName + ".GetCachedDataTableType grabbed a ReaderLock.");
            ...
            finally
            {
                // Release read lock
                FReadWriteLock.ReleaseReaderLock();
//              TLogging.LogAtLevel(10, this.GetType().FullName + ".GetCachedDataTableType released the ReaderLock.");
            }
            return ReturnValue;
        }
        ...
        public void AddOrMergeCachedTable(String ACacheableTableName, DataTable ACacheableTable, System.Int32 AClientID, object AFilterCriteria)
        {
            ...
            if (ContentsEntryDR != null)
            {
                try
                {
//                  TLogging.LogAtLevel(10, this.GetType().FullName + ".AddOrMergeCachedTable waiting for a WriterLock...");
...
//                  TLogging.LogAtLevel (10, this.GetType().FullName + ".AddOrMergeCachedTable grabbed a WriterLock.");

//                  TLogging.LogAtLevel(7, this.GetType().FullName + ".AddOrMergeCachedTable: merging DataTable " + ACacheableTableName +
...
//                  TLogging.LogAtLevel(7, this.GetType().FullName + ".AddOrMergeCachedTable: merged DataTable " + ACacheableTableName + ". Rows after merging: " +
...
//                  TLogging.LogAtLevel(10, this.GetType().FullName + ".AddOrMergeCachedTable released the WriterLock.");
                }
...
//          TLogging.LogAtLevel(9, this.GetType().FullName + ".IsTableCached: got called in AppDomain '" + AppDomain.CurrentDomain.FriendlyName +
//                  "'. Instance hash is " + this.GetHashCode().ToString());
        ...
        public void MarkCachedTableNeedsRefreshing(String ACacheableTableName)
        {
            ...
            try
            {
//              TLogging.LogAtLevel(10, this.GetType().FullName + ".MarkCachedTableNeedsRefreshing waiting for a ReaderLock...");

                // Try to get a read lock [We don't specify a timeout because reading the DB tables into the cached table should be fairly quick]
                FReadWriteLock.AcquireReaderLock(SharedConstants.THREADING_WAIT_INFINITE);
//              TLogging.LogAtLevel(10, this.GetType().FullName + ".MarkCachedTableNeedsRefreshing grabbed a ReaderLock.");
            ...
            finally
            {
                // Release read lock
                FReadWriteLock.ReleaseReaderLock();
//              TLogging.LogAtLevel(10, this.GetType().FullName + ".MarkCachedTableNeedsRefreshing released the ReaderLock.");
            }
            ...
            if (ContentsEntryDR != null)
            {
                try
                {
//                  TLogging.LogAtLevel(10, this.GetType().FullName + ".MarkCachedTableNeedsRefreshing waiting for a WriterLock...");

                    // Prevent other threads from obtaining a read lock on the cache table while we are modifying the Contents table!
                    FReadWriteLock.AcquireWriterLock(SharedConstants.THREADING_WAIT_INFINITE);
//                  TLogging.LogAtLevel(10, this.GetType().FullName + ".MarkCachedTableNeedsRefreshing grabbed a WriterLock.");
                ...
                finally
                {
                    // Other threads are now free to obtain a read lock on the cache table.
                    FReadWriteLock.ReleaseWriterLock();
//                  TLogging.LogAtLevel(10, this.GetType().FullName + ".MarkCachedTableNeedsRefreshing released the WriterLock.");
                }
            }
        }
...
//          TLogging.LogAtLevel (9, "TCacheableTablesManager.AddCachedTableInternal: got called in AppDomain '" + AppDomain.CurrentDomain.FriendlyName + "'. Instance hash is " + this.GetHashCode().ToString());
            ...
            try
            {
//              TLogging.LogAtLevel (10, this.GetType().FullName + ".AddCachedTableInternal waiting for a ReaderLock...");

                // Try to get a read lock [We don't specify a timeout because reading the DB tables into the cached table should be fairly quick]
                FReadWriteLock.AcquireReaderLock(SharedConstants.THREADING_WAIT_INFINITE);
//              TLogging.LogAtLevel (10, this.GetType().FullName + ".AddCachedTableInternal grabbed a ReaderLock.");
            ...
            finally
            {
                // Release read lock
                FReadWriteLock.ReleaseReaderLock();
//              TLogging.LogAtLevel (10, this.GetType().FullName + ".AddCachedTableInternal released the ReaderLock.");
            }
            try
            {
//              TLogging.LogAtLevel (10, this.GetType().FullName + ".AddCachedTableInternal waiting for a WriterLock...");
...
//              TLogging.LogAtLevel (10, this.GetType().FullName + ".AddCachedTableInternal grabbed a WriterLock.");
...
//                  TLogging.LogAtLevel (9, this.GetType().FullName + ".AddCachedTableInternal: added DataTable '" + NewCacheTableRow.TableName +
...
//                  TLogging.LogAtLevel (10, this.GetType().FullName + ".AddCachedTableInternal released a WriterLock.");
...
//                      TLogging.LogAtLevel (9, this.GetType().FullName + ".AddCachedTableInternal: DataTable '" + ACacheableTableName +
//                              "' already exists in the Cache --> replaced it with the passed in DataTable.");
            ...
            finally
            {
                if (WriteLockTakenOut)
                {
                    // Other threads are now free to obtain a read lock on the cache table.
                    FReadWriteLock.ReleaseWriterLock();
//                  TLogging.LogAtLevel (10, this.GetType().FullName + ".AddCachedTableInternal released the WriterLock.");
                }
            }
        ...
        private CacheableTablesTDSContentsRow GetContentsEntry(String ACacheableTableName)
        {
            ...
            try
            {
                ...
                {
//                  TLogging.LogAtLevel (10, this.GetType().FullName + ".GetContentsEntry waiting for a ReaderLock...");

                    // Try to get a read lock [We don't specify a timeout because reading the DB tables into the cached table should be fairly quick]
                    FReadWriteLock.AcquireReaderLock(SharedConstants.THREADING_WAIT_INFINITE);
//                  TLogging.LogAtLevel (10, this.GetType().FullName + ".GetContentsEntry grabbed a ReaderLock.");
                }
                else
                {
            ...
            finally
            {
                if (!ReaderLockWasHeld)
                {
                    // Release read lock
                    FReadWriteLock.ReleaseReaderLock();
//                  TLogging.LogAtLevel (10, this.GetType().FullName + ".GetContentsEntry released the ReaderLock.");
                }
            }
/*
            if (ReturnValue != null)
            {
                TLogging.LogAtLevel (9, this.GetType().FullName + ".GetContentsEntry: checked for DataTable '" + ACacheableTableName +
...
*/
        ...
        private void RemoveCachedTable(String ACacheableTableName, Boolean ARemoveContentsEntry)
        {
            ...
            try
            {
                ...
                if (!FReadWriteLock.IsReaderLockHeld)
                {
//                  TLogging.LogAtLevel (10, this.GetType().FullName + ".RemoveCachedTable waiting for a ReaderLock...");

                    // Try to get a read lock [We don't specify a timeout because reading the DB tables into the cached table should be fairly quick]
                    FReadWriteLock.AcquireReaderLock(SharedConstants.THREADING_WAIT_INFINITE);
//                  TLogging.LogAtLevel (10, this.GetType().FullName + ".RemoveCachedTable grabbed a ReaderLock.");
                }
                else
                {
                    ReaderLockWasHeld = true;
            ...
            finally
            {
                if (!ReaderLockWasHeld)
                {
                    // Release read lock
                    FReadWriteLock.ReleaseReaderLock();
//                  TLogging.LogAtLevel (10, this.GetType().FullName + ".RemoveCachedTable released the ReaderLock.");
                }
            }
            ...
            if (ContentsEntryDR != null)
            {
                ...
                try
                {
                    if (!ReaderLockWasHeld)
                    {
//                      TLogging.LogAtLevel (10, this.GetType().FullName + ".RemoveCachedTable waiting for a WriterLock...");

                        // Prevent other threads from obtaining a read lock on the cache table while we are removing the cache table!
                        FReadWriteLock.AcquireWriterLock(SharedConstants.THREADING_WAIT_INFINITE);
//                      TLogging.LogAtLevel (10, this.GetType().FullName + ".RemoveCachedTable grabbed a WriterLock.");
                    }
                    else
                    {
//                      TLogging.LogAtLevel (10, this.GetType().FullName + ".RemoveCachedTable waiting for upgrading to a WriterLock...");
                        ...
                        UpgradeLockCookie = FReadWriteLock.UpgradeToWriterLock(SharedConstants.THREADING_WAIT_INFINITE);
//                      TLogging.LogAtLevel (10, this.GetType().FullName + ".RemoveCachedTable upgraded to a WriterLock.");
                    }
                ...
                finally
                {
                    if (WriteLockTakenOut)
                    {
                        if (!ReaderLockWasHeld)
                        {
                            // Other threads are now free to obtain a read lock on the cache table.
                            FReadWriteLock.ReleaseWriterLock();
//                          TLogging.LogAtLevel (10, this.GetType().FullName + ".RemoveCachedTable released the WriterLock.");
                        }
                        else
                        {
//                          TLogging.LogAtLevel (10, this.GetType().FullName + ".RemoveCachedTable waiting for downgrading to a ReaderLock...");

                            // Downgrade from a WriterLock to a ReaderLock again!
                            FReadWriteLock.DowngradeFromWriterLock(ref UpgradeLockCookie);
//                          TLogging.LogAtLevel (10, this.GetType().FullName + ".RemoveCachedTable downgraded to a ReaderLock.");
                        }
                    }
                }
            }
        ...
        private void RemoveOldestCachedTables()
        {
            ...
            try
            {
//              TLogging.LogAtLevel (10, this.GetType().FullName + ".RemoveOldestCachedTables waiting for a ReaderLock...");

                // Try to get a read lock [We don't specify a timeout because reading the DB tables into the cached table should be fairly quick]
                FReadWriteLock.AcquireReaderLock(SharedConstants.THREADING_WAIT_INFINITE);
//              TLogging.LogAtLevel (10, this.GetType().FullName + ".RemoveOldestCachedTables grabbed a ReaderLock.");
            ...
            finally
            {
                // Release read lock
                FReadWriteLock.ReleaseReaderLock();
//              TLogging.LogAtLevel (10, this.GetType().FullName + ".RemoveOldestCachedTables released the ReaderLock.");
            }
        }
        ...
        private void ShrinkCacheToMaxSize()
        {
            ...
            if (CacheSizeBeforeShrinking > UMaxCacheSize)
            {
                try
                {
//                  TLogging.LogAtLevel (10, this.GetType().FullName + ".ShrinkCacheToMaxSize waiting for a ReaderLock...");

                    // Try to get a read lock [We don't specify a timeout because reading the DB tables into the cached table should be fairly quick]
                    FReadWriteLock.AcquireReaderLock(SharedConstants.THREADING_WAIT_INFINITE);
//                  TLogging.LogAtLevel (10, this.GetType().FullName + ".ShrinkCacheToMaxSize grabbed a ReaderLock.");
                ...
                finally
                {
                    // Release read lock
                    FReadWriteLock.ReleaseReaderLock();
 //                 TLogging.LogAtLevel (10, this.GetType().FullName + ".ShrinkCacheToMaxSize released the ReaderLock.");
                }
            }
        }
...
//          TLogging.LogAtLevel (7, this.GetType().FullName + ".ResultingCachedDataTable: passed in HashCode: " + AHashCode +
...
//                  TLogging.LogAtLevel (7, this.GetType().FullName +
