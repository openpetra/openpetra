...
namespace Ict.Petra.Shared.MCommon.Data.Access
{
    ...
    public class PLanguageAccess : TTypedDataAccess
    {
        ...
        public static void LoadViaACurrency(DataSet ADataSet, String ACurrencyCode, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClauseLong("PUB_p_language", AFieldList, new string[] {
                            "p_language_code_c"}) + " FROM PUB_p_language, PUB_a_currency_language WHERE PUB_a_currency_language.p_lan" +
                    "guage_code_c = PUB_p_language.p_language_code_c AND PUB_a_currency_language.a_cu" +
                    "rrency_code_c = ?") 
                            + GenerateOrderByClause(AOrderBy)), PLanguageTable.GetTableName(), ATransaction, ParametersArray, AStartRecord, AMaxRecords);
        }
        ...
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_p_language", AFieldList, new string[] {
                            "p_language_code_c"}) + " FROM PUB_p_language, PUB_a_currency_language, PUB_a_currency WHERE PUB_a_currenc" +
                    "y_language.p_language_code_c = PUB_p_language.p_language_code_c AND PUB_a_curren" +
                    "cy_language.a_currency_code_c = PUB_a_currency.a_currency_code_c") 
        ...
        public static int CountViaACurrency(String ACurrencyCode, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[0] = new OdbcParameter("", OdbcType.VarChar, 16);
            ParametersArray[0].Value = ((object)(ACurrencyCode));
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar("SELECT COUNT(*) FROM PUB_p_language, PUB_a_currency_language WHERE PUB_a_currency" +
                        "_language.p_language_code_c = PUB_p_language.p_language_code_c AND PUB_a_currenc" +
                        "y_language.a_currency_code_c = ?", ATransaction, false, ParametersArray));
        }
        ...
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(("SELECT COUNT(*) FROM PUB_p_language, PUB_a_currency_language, PUB_a_currency WHER" +
                        "E PUB_a_currency_language.p_language_code_c = PUB_p_language.p_language_code_c A" +
                        "ND PUB_a_currency_language.a_currency_code_c = PUB_a_currency.a_currency_code_c" + GenerateWhereClauseLong("PUB_a_currency", ACurrencyTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, ACurrencyTable.GetPrimKeyColumnOrdList())));
        }
        ...
        public static void LoadViaPPerson(DataSet ADataSet, Int64 APartnerKey, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClauseLong("PUB_p_language", AFieldList, new string[] {
                            "p_language_code_c"}) + " FROM PUB_p_language, PUB_pm_person_language WHERE PUB_pm_person_language.p_langu" +
                    "age_code_c = PUB_p_language.p_language_code_c AND PUB_pm_person_language.p_partn" +
                    "er_key_n = ?") 
                            + GenerateOrderByClause(AOrderBy)), PLanguageTable.GetTableName(), ATransaction, ParametersArray, AStartRecord, AMaxRecords);
        }
        ...
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_p_language", AFieldList, new string[] {
                            "p_language_code_c"}) + " FROM PUB_p_language, PUB_pm_person_language, PUB_p_person WHERE PUB_pm_person_la" +
                    "nguage.p_language_code_c = PUB_p_language.p_language_code_c AND PUB_pm_person_la" +
                    "nguage.p_partner_key_n = PUB_p_person.p_partner_key_n") 
        ...
        public static int CountViaPPerson(Int64 APartnerKey, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[0] = new OdbcParameter("", OdbcType.Decimal, 10);
            ParametersArray[0].Value = ((object)(APartnerKey));
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar("SELECT COUNT(*) FROM PUB_p_language, PUB_pm_person_language WHERE PUB_pm_person_l" +
                        "anguage.p_language_code_c = PUB_p_language.p_language_code_c AND PUB_pm_person_l" +
                        "anguage.p_partner_key_n = ?", ATransaction, false, ParametersArray));
        }
        ...
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(("SELECT COUNT(*) FROM PUB_p_language, PUB_pm_person_language, PUB_p_person WHERE P" +
                        "UB_pm_person_language.p_language_code_c = PUB_p_language.p_language_code_c AND P" +
                        "UB_pm_person_language.p_partner_key_n = PUB_p_person.p_partner_key_n" + GenerateWhereClauseLong("PUB_p_person", PPersonTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, PPersonTable.GetPrimKeyColumnOrdList())));
        }
        ...
        public static void LoadViaUmJob(DataSet ADataSet, Int64 AUnitKey, String APositionName, String APositionScope, Int32 AJobKey, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClauseLong("PUB_p_language", AFieldList, new string[] {
                            "p_language_code_c"}) + @" FROM PUB_p_language, PUB_um_job_language WHERE PUB_um_job_language.p_language_code_c = PUB_p_language.p_language_code_c AND PUB_um_job_language.pm_unit_key_n = ? AND PUB_um_job_language.pt_position_name_c = ? AND PUB_um_job_language.pt_position_scope_c = ? AND PUB_um_job_language.um_job_key_i = ?") 
                            + GenerateOrderByClause(AOrderBy)), PLanguageTable.GetTableName(), ATransaction, ParametersArray, AStartRecord, AMaxRecords);
        }
        ...
        public static int CountViaUmJob(Int64 AUnitKey, String APositionName, String APositionScope, Int32 AJobKey, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[3] = new OdbcParameter("", OdbcType.Int);
            ParametersArray[3].Value = ((object)(AJobKey));
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(@"SELECT COUNT(*) FROM PUB_p_language, PUB_um_job_language WHERE PUB_um_job_language.p_language_code_c = PUB_p_language.p_language_code_c AND PUB_um_job_language.pm_unit_key_n = ? AND PUB_um_job_language.pt_position_name_c = ? AND PUB_um_job_language.pt_position_scope_c = ? AND PUB_um_job_language.um_job_key_i = ?", ATransaction, false, ParametersArray));
        }
    ...
    public class PInternationalPostalTypeAccess : TTypedDataAccess
    {
        ...
        public static int CountByPrimaryKey(String AInternatPostalTypeCode, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[0] = new OdbcParameter("", OdbcType.VarChar, 16);
            ParametersArray[0].Value = ((object)(AInternatPostalTypeCode));
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar("SELECT COUNT(*) FROM PUB_p_international_postal_type WHERE p_internat_postal_type" +
        ...
        public static void DeleteByPrimaryKey(String AInternatPostalTypeCode, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[0] = new OdbcParameter("", OdbcType.VarChar, 16);
            ParametersArray[0].Value = ((object)(AInternatPostalTypeCode));
            DBAccess.GDBAccessObj.ExecuteNonQuery("DELETE FROM PUB_p_international_postal_type WHERE p_internat_postal_type_code_c =" +
    ...
    public class PCountryAccess : TTypedDataAccess
    {
        ...
        public static void LoadViaPInternationalPostalTypeTemplate(DataSet ADataSet, PInternationalPostalTypeRow ATemplateRow, StringCollection ATemplateOperators, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_p_country", AFieldList, new string[] {
                            "p_country_code_c"}) + " FROM PUB_p_country, PUB_p_international_postal_type WHERE p_country.p_internat_p" +
                    "ostal_type_code_c = p_international_postal_type.p_internat_postal_type_code_c") 
        ...
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(("SELECT COUNT(*) FROM PUB_p_country, PUB_p_international_postal_type WHERE p_count" +
                        "ry.p_internat_postal_type_code_c = p_international_postal_type.p_internat_postal" +
                        "_type_code_c" + GenerateWhereClauseLong("PUB_p_international_postal_type", PInternationalPostalTypeTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, PInternationalPostalTypeTable.GetPrimKeyColumnOrdList())));
        }
        ...
        public static void LoadViaPAddressLayoutCode(DataSet ADataSet, String ACode, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClauseLong("PUB_p_country", AFieldList, new string[] {
                            "p_country_code_c"}) + " FROM PUB_p_country, PUB_p_address_layout WHERE PUB_p_address_layout.p_country_co" +
                    "de_c = PUB_p_country.p_country_code_c AND PUB_p_address_layout.p_address_layout_" +
                    "code_c = ?") 
                            + GenerateOrderByClause(AOrderBy)), PCountryTable.GetTableName(), ATransaction, ParametersArray, AStartRecord, AMaxRecords);
        }
        ...
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_p_country", AFieldList, new string[] {
                            "p_country_code_c"}) + " FROM PUB_p_country, PUB_p_address_layout, PUB_p_address_layout_code WHERE PUB_p_" +
                    "address_layout.p_country_code_c = PUB_p_country.p_country_code_c AND PUB_p_addre" +
                    "ss_layout.p_address_layout_code_c = PUB_p_address_layout_code.p_code_c") 
        ...
        public static int CountViaPAddressLayoutCode(String ACode, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[0] = new OdbcParameter("", OdbcType.VarChar, 32);
            ParametersArray[0].Value = ((object)(ACode));
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar("SELECT COUNT(*) FROM PUB_p_country, PUB_p_address_layout WHERE PUB_p_address_layo" +
                        "ut.p_country_code_c = PUB_p_country.p_country_code_c AND PUB_p_address_layout.p_" +
                        "address_layout_code_c = ?", ATransaction, false, ParametersArray));
        }
        ...
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(("SELECT COUNT(*) FROM PUB_p_country, PUB_p_address_layout, PUB_p_address_layout_co" +
                        "de WHERE PUB_p_address_layout.p_country_code_c = PUB_p_country.p_country_code_c " +
                        "AND PUB_p_address_layout.p_address_layout_code_c = PUB_p_address_layout_code.p_c" +
                        "ode_c" + GenerateWhereClauseLong("PUB_p_address_layout_code", PAddressLayoutCodeTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, PAddressLayoutCodeTable.GetPrimKeyColumnOrdList())));
        }
    ...
    public class ACurrencyAccess : TTypedDataAccess
    {
        ...
        public static void LoadViaPCountryTemplate(DataSet ADataSet, PCountryRow ATemplateRow, StringCollection ATemplateOperators, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_a_currency", AFieldList, new string[] {
                            "a_currency_code_c"}) + " FROM PUB_a_currency, PUB_p_country WHERE a_currency.p_country_code_c = p_country" +
                    ".p_country_code_c") 
        ...
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(("SELECT COUNT(*) FROM PUB_a_currency, PUB_p_country WHERE a_currency.p_country_cod" +
        ...
        public static void LoadViaPLanguage(DataSet ADataSet, String ALanguageCode, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ParametersArray[0].Value = ((object)(ALanguageCode));
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClauseLong("PUB_a_currency", AFieldList, new string[] {
                            "a_currency_code_c"}) + " FROM PUB_a_currency, PUB_a_currency_language WHERE PUB_a_currency_language.a_cur" +
                    "rency_code_c = PUB_a_currency.a_currency_code_c AND PUB_a_currency_language.p_la" +
                    "nguage_code_c = ?") 
                            + GenerateOrderByClause(AOrderBy)), ACurrencyTable.GetTableName(), ATransaction, ParametersArray, AStartRecord, AMaxRecords);
        }
        ...
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_a_currency", AFieldList, new string[] {
                            "a_currency_code_c"}) + " FROM PUB_a_currency, PUB_a_currency_language, PUB_p_language WHERE PUB_a_currenc" +
                    "y_language.a_currency_code_c = PUB_a_currency.a_currency_code_c AND PUB_a_curren" +
                    "cy_language.p_language_code_c = PUB_p_language.p_language_code_c") 
        ...
        public static int CountViaPLanguage(String ALanguageCode, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[0] = new OdbcParameter("", OdbcType.VarChar, 20);
            ParametersArray[0].Value = ((object)(ALanguageCode));
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar("SELECT COUNT(*) FROM PUB_a_currency, PUB_a_currency_language WHERE PUB_a_currency" +
                        "_language.a_currency_code_c = PUB_a_currency.a_currency_code_c AND PUB_a_currenc" +
                        "y_language.p_language_code_c = ?", ATransaction, false, ParametersArray));
        }
        ...
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(("SELECT COUNT(*) FROM PUB_a_currency, PUB_a_currency_language, PUB_p_language WHER" +
                        "E PUB_a_currency_language.a_currency_code_c = PUB_a_currency.a_currency_code_c A" +
                        "ND PUB_a_currency_language.p_language_code_c = PUB_p_language.p_language_code_c" + GenerateWhereClauseLong("PUB_p_language", PLanguageTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, PLanguageTable.GetPrimKeyColumnOrdList())));
        }
