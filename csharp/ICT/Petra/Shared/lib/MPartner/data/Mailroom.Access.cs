...
namespace Ict.Petra.Shared.MPartner.Mailroom.Data.Access
{
    ...
    public class MExtractMasterAccess : TTypedDataAccess
    {
        ...
        public static void LoadViaSUserTemplate(DataSet ADataSet, SUserRow ATemplateRow, StringCollection ATemplateOperators, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_m_extract_master", AFieldList, new string[] {
                            "m_extract_id_i"}) + " FROM PUB_m_extract_master, PUB_s_user WHERE m_extract_master.m_manual_mod_by_c =" +
                    " s_user.s_user_id_c") 
        ...
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(("SELECT COUNT(*) FROM PUB_m_extract_master, PUB_s_user WHERE m_extract_master.m_ma" +
                        "nual_mod_by_c = s_user.s_user_id_c" + GenerateWhereClauseLong("PUB_s_user", SUserTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, SUserTable.GetPrimKeyColumnOrdList())));
        }
        ...
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_m_extract_master", AFieldList, new string[] {
                            "m_extract_id_i"}) + " FROM PUB_m_extract_master, PUB_m_extract_type WHERE m_extract_master.m_extract_t" +
                    "ype_code_c = m_extract_type.m_code_c") 
        ...
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(("SELECT COUNT(*) FROM PUB_m_extract_master, PUB_m_extract_type WHERE m_extract_mas" +
                        "ter.m_extract_type_code_c = m_extract_type.m_code_c" + GenerateWhereClauseLong("PUB_m_extract_type", MExtractTypeTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, MExtractTypeTable.GetPrimKeyColumnOrdList())));
        }
        ...
        public static void LoadViaSGroup(DataSet ADataSet, String AGroupId, Int64 AUnitKey, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClauseLong("PUB_m_extract_master", AFieldList, new string[] {
                            "m_extract_id_i"}) + " FROM PUB_m_extract_master, PUB_s_group_extract WHERE PUB_s_group_extract.m_extra" +
                    "ct_id_i = PUB_m_extract_master.m_extract_id_i AND PUB_s_group_extract.s_group_id" +
                    "_c = ? AND PUB_s_group_extract.s_group_unit_key_n = ?") 
                            + GenerateOrderByClause(AOrderBy)), MExtractMasterTable.GetTableName(), ATransaction, ParametersArray, AStartRecord, AMaxRecords);
        }
        ...
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_m_extract_master", AFieldList, new string[] {
                            "m_extract_id_i"}) + @" FROM PUB_m_extract_master, PUB_s_group_extract, PUB_s_group WHERE PUB_s_group_extract.m_extract_id_i = PUB_m_extract_master.m_extract_id_i AND PUB_s_group_extract.s_group_id_c = PUB_s_group.s_group_id_c AND PUB_s_group_extract.s_group_unit_key_n = PUB_s_group.s_unit_key_n") 
        ...
        public static int CountViaSGroup(String AGroupId, Int64 AUnitKey, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[1] = new OdbcParameter("", OdbcType.Decimal, 10);
            ParametersArray[1].Value = ((object)(AUnitKey));
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar("SELECT COUNT(*) FROM PUB_m_extract_master, PUB_s_group_extract WHERE PUB_s_group_" +
                        "extract.m_extract_id_i = PUB_m_extract_master.m_extract_id_i AND PUB_s_group_ext" +
                        "ract.s_group_id_c = ? AND PUB_s_group_extract.s_group_unit_key_n = ?", ATransaction, false, ParametersArray));
        }
        ...
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar((@"SELECT COUNT(*) FROM PUB_m_extract_master, PUB_s_group_extract, PUB_s_group WHERE PUB_s_group_extract.m_extract_id_i = PUB_m_extract_master.m_extract_id_i AND PUB_s_group_extract.s_group_id_c = PUB_s_group.s_group_id_c AND PUB_s_group_extract.s_group_unit_key_n = PUB_s_group.s_unit_key_n" + GenerateWhereClauseLong("PUB_s_group", SGroupTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, SGroupTable.GetPrimKeyColumnOrdList())));
        }
    ...
    public class MExtractAccess : TTypedDataAccess
    {
        ...
        public static void LoadAll(DataSet ADataSet, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            "m_extract_id_i",
                            "p_partner_key_n",
                            "p_site_key_n"}) + " FROM PUB_m_extract") 
        ...
        public static void LoadByPrimaryKey(DataSet ADataSet, Int32 AExtractId, Int64 APartnerKey, Int64 ASiteKey, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            "m_extract_id_i",
                            "p_partner_key_n",
                            "p_site_key_n"}) + " FROM PUB_m_extract WHERE m_extract_id_i = ? AND p_partner_key_n = ? AND p_site_k" +
                    "ey_n = ?") 
        ...
        public static int CountByPrimaryKey(Int32 AExtractId, Int64 APartnerKey, Int64 ASiteKey, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[2] = new OdbcParameter("", OdbcType.Decimal, 10);
            ParametersArray[2].Value = ((object)(ASiteKey));
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar("SELECT COUNT(*) FROM PUB_m_extract WHERE m_extract_id_i = ? AND p_partner_key_n =" +
                        " ? AND p_site_key_n = ?", ATransaction, false, ParametersArray));
        }
        ...
        public static void LoadViaMExtractMaster(DataSet ADataSet, Int32 AExtractId, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            "m_extract_id_i",
                            "p_partner_key_n",
                            "p_site_key_n"}) + " FROM PUB_m_extract WHERE m_extract_id_i = ?") 
                            + GenerateOrderByClause(AOrderBy)), MExtractTable.GetTableName(), ATransaction, ParametersArray, AStartRecord, AMaxRecords);
        }
        ...
        public static void LoadViaMExtractMasterTemplate(DataSet ADataSet, MExtractMasterRow ATemplateRow, StringCollection ATemplateOperators, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_m_extract", AFieldList, new string[] {
                            "m_extract_id_i",
                            "p_partner_key_n",
                            "p_site_key_n"}) + " FROM PUB_m_extract, PUB_m_extract_master WHERE m_extract.m_extract_id_i = m_extr" +
                    "act_master.m_extract_id_i") 
        ...
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(("SELECT COUNT(*) FROM PUB_m_extract, PUB_m_extract_master WHERE m_extract.m_extrac" +
                        "t_id_i = m_extract_master.m_extract_id_i" + GenerateWhereClauseLong("PUB_m_extract_master", MExtractMasterTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, MExtractMasterTable.GetPrimKeyColumnOrdList())));
        }
        ...
        public static void LoadViaPPartner(DataSet ADataSet, Int64 APartnerKey, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            "m_extract_id_i",
                            "p_partner_key_n",
                            "p_site_key_n"}) + " FROM PUB_m_extract WHERE p_partner_key_n = ?") 
                            + GenerateOrderByClause(AOrderBy)), MExtractTable.GetTableName(), ATransaction, ParametersArray, AStartRecord, AMaxRecords);
        }
        ...
        public static void LoadViaPPartnerTemplate(DataSet ADataSet, PPartnerRow ATemplateRow, StringCollection ATemplateOperators, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_m_extract", AFieldList, new string[] {
                            "m_extract_id_i",
                            "p_partner_key_n",
                            "p_site_key_n"}) + " FROM PUB_m_extract, PUB_p_partner WHERE m_extract.p_partner_key_n = p_partner.p_" +
                    "partner_key_n") 
        ...
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(("SELECT COUNT(*) FROM PUB_m_extract, PUB_p_partner WHERE m_extract.p_partner_key_n" +
        ...
        public static void LoadViaPLocation(DataSet ADataSet, Int64 ASiteKey, Int32 ALocationKey, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            "m_extract_id_i",
                            "p_partner_key_n",
                            "p_site_key_n"}) + " FROM PUB_m_extract WHERE p_site_key_n = ? AND p_location_key_i = ?") 
                            + GenerateOrderByClause(AOrderBy)), MExtractTable.GetTableName(), ATransaction, ParametersArray, AStartRecord, AMaxRecords);
        }
        ...
        public static void LoadViaPLocationTemplate(DataSet ADataSet, PLocationRow ATemplateRow, StringCollection ATemplateOperators, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_m_extract", AFieldList, new string[] {
                            "m_extract_id_i",
                            "p_partner_key_n",
                            "p_site_key_n"}) + " FROM PUB_m_extract, PUB_p_location WHERE m_extract.p_site_key_n = p_location.p_s" +
                    "ite_key_n AND m_extract.p_location_key_i = p_location.p_location_key_i") 
        ...
        public static int CountViaPLocation(Int64 ASiteKey, Int32 ALocationKey, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[1] = new OdbcParameter("", OdbcType.Int);
            ParametersArray[1].Value = ((object)(ALocationKey));
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar("SELECT COUNT(*) FROM PUB_m_extract WHERE p_site_key_n = ? AND p_location_key_i = " +
        ...
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(("SELECT COUNT(*) FROM PUB_m_extract, PUB_p_location WHERE m_extract.p_site_key_n =" +
                        " p_location.p_site_key_n AND m_extract.p_location_key_i = p_location.p_location_" +
                        "key_i" + GenerateWhereClauseLong("PUB_p_location", PLocationTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, PLocationTable.GetPrimKeyColumnOrdList())));
        }
        ...
        public static void DeleteByPrimaryKey(Int32 AExtractId, Int64 APartnerKey, Int64 ASiteKey, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[2] = new OdbcParameter("", OdbcType.Decimal, 10);
            ParametersArray[2].Value = ((object)(ASiteKey));
            DBAccess.GDBAccessObj.ExecuteNonQuery("DELETE FROM PUB_m_extract WHERE m_extract_id_i = ? AND p_partner_key_n = ? AND p_" +
                    "site_key_n = ?", ATransaction, false, ParametersArray);
        }
    ...
    public class MExtractParameterAccess : TTypedDataAccess
    {
        ...
        public static void LoadAll(DataSet ADataSet, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            "m_extract_id_i",
                            "m_parameter_code_c",
                            "m_value_index_i"}) + " FROM PUB_m_extract_parameter") 
        ...
        public static void LoadByPrimaryKey(DataSet ADataSet, Int32 AExtractId, String AParameterCode, Int32 AValueIndex, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            "m_extract_id_i",
                            "m_parameter_code_c",
                            "m_value_index_i"}) + " FROM PUB_m_extract_parameter WHERE m_extract_id_i = ? AND m_parameter_code_c = ?" +
                    " AND m_value_index_i = ?") 
        ...
        public static int CountByPrimaryKey(Int32 AExtractId, String AParameterCode, Int32 AValueIndex, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[2] = new OdbcParameter("", OdbcType.Int);
            ParametersArray[2].Value = ((object)(AValueIndex));
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar("SELECT COUNT(*) FROM PUB_m_extract_parameter WHERE m_extract_id_i = ? AND m_param" +
                        "eter_code_c = ? AND m_value_index_i = ?", ATransaction, false, ParametersArray));
        }
        ...
        public static void LoadViaMExtractMaster(DataSet ADataSet, Int32 AExtractId, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            "m_extract_id_i",
                            "m_parameter_code_c",
                            "m_value_index_i"}) + " FROM PUB_m_extract_parameter WHERE m_extract_id_i = ?") 
                            + GenerateOrderByClause(AOrderBy)), MExtractParameterTable.GetTableName(), ATransaction, ParametersArray, AStartRecord, AMaxRecords);
        }
        ...
        public static void LoadViaMExtractMasterTemplate(DataSet ADataSet, MExtractMasterRow ATemplateRow, StringCollection ATemplateOperators, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_m_extract_parameter", AFieldList, new string[] {
                            "m_extract_id_i",
                            "m_parameter_code_c",
                            "m_value_index_i"}) + " FROM PUB_m_extract_parameter, PUB_m_extract_master WHERE m_extract_parameter.m_e" +
                    "xtract_id_i = m_extract_master.m_extract_id_i") 
                            + GenerateWhereClauseLong("PUB_m_extract_master", MExtractMasterTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)) 
                            + GenerateOrderByClause(AOrderBy)), MExtractParameterTable.GetTableName(), ATransaction, GetParametersForWhereClause(ATemplateRow), AStartRecord, AMaxRecords);
        }
        ...
        public static int CountViaMExtractMasterTemplate(MExtractMasterRow ATemplateRow, StringCollection ATemplateOperators, TDBTransaction ATransaction)
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(("SELECT COUNT(*) FROM PUB_m_extract_parameter, PUB_m_extract_master WHERE m_extrac" +
                        "t_parameter.m_extract_id_i = m_extract_master.m_extract_id_i" + GenerateWhereClauseLong("PUB_m_extract_master", MExtractMasterTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, MExtractMasterTable.GetPrimKeyColumnOrdList())));
        }
        ...
        public static void DeleteByPrimaryKey(Int32 AExtractId, String AParameterCode, Int32 AValueIndex, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[2] = new OdbcParameter("", OdbcType.Int);
            ParametersArray[2].Value = ((object)(AValueIndex));
            DBAccess.GDBAccessObj.ExecuteNonQuery("DELETE FROM PUB_m_extract_parameter WHERE m_extract_id_i = ? AND m_parameter_code" +
                    "_c = ? AND m_value_index_i = ?", ATransaction, false, ParametersArray);
        }
    ...
    public class PAddressLayoutCodeAccess : TTypedDataAccess
    {
        ...
        public static void LoadViaPCountry(DataSet ADataSet, String ACountryCode, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClauseLong("PUB_p_address_layout_code", AFieldList, new string[] {
                            "p_code_c"}) + " FROM PUB_p_address_layout_code, PUB_p_address_layout WHERE PUB_p_address_layout." +
                    "p_address_layout_code_c = PUB_p_address_layout_code.p_code_c AND PUB_p_address_l" +
                    "ayout.p_country_code_c = ?") 
                            + GenerateOrderByClause(AOrderBy)), PAddressLayoutCodeTable.GetTableName(), ATransaction, ParametersArray, AStartRecord, AMaxRecords);
        }
        ...
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_p_address_layout_code", AFieldList, new string[] {
                            "p_code_c"}) + " FROM PUB_p_address_layout_code, PUB_p_address_layout, PUB_p_country WHERE PUB_p_" +
                    "address_layout.p_address_layout_code_c = PUB_p_address_layout_code.p_code_c AND " +
        ...
        public static int CountViaPCountry(String ACountryCode, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[0] = new OdbcParameter("", OdbcType.VarChar, 8);
            ParametersArray[0].Value = ((object)(ACountryCode));
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar("SELECT COUNT(*) FROM PUB_p_address_layout_code, PUB_p_address_layout WHERE PUB_p_" +
                        "address_layout.p_address_layout_code_c = PUB_p_address_layout_code.p_code_c AND " +
                        "PUB_p_address_layout.p_country_code_c = ?", ATransaction, false, ParametersArray));
        }
        ...
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(("SELECT COUNT(*) FROM PUB_p_address_layout_code, PUB_p_address_layout, PUB_p_count" +
                        "ry WHERE PUB_p_address_layout.p_address_layout_code_c = PUB_p_address_layout_cod" +
                        "e.p_code_c AND PUB_p_address_layout.p_country_code_c = PUB_p_country.p_country_c" +
                        "ode_c" + GenerateWhereClauseLong("PUB_p_country", PCountryTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, PCountryTable.GetPrimKeyColumnOrdList())));
        }
    ...
    public class PAddressLayoutAccess : TTypedDataAccess
    {
        ...
        public static void LoadAll(DataSet ADataSet, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            ...
                            "p_address_line_code_c"}) + " FROM PUB_p_address_layout") 
        ...
        public static void LoadByPrimaryKey(DataSet ADataSet, String ACountryCode, String AAddressLayoutCode, Int32 AAddressLineNumber, String AAddressLineCode, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            ...
                            "p_address_layout_code_c",
                            "p_address_line_number_i",
                            "p_address_line_code_c"}) + " FROM PUB_p_address_layout WHERE p_country_code_c = ? AND p_address_layout_code_c" +
                    " = ? AND p_address_line_number_i = ? AND p_address_line_code_c = ?") 
        ...
        public static int CountByPrimaryKey(String ACountryCode, String AAddressLayoutCode, Int32 AAddressLineNumber, String AAddressLineCode, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[3] = new OdbcParameter("", OdbcType.VarChar, 16);
            ParametersArray[3].Value = ((object)(AAddressLineCode));
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar("SELECT COUNT(*) FROM PUB_p_address_layout WHERE p_country_code_c = ? AND p_addres" +
                        "s_layout_code_c = ? AND p_address_line_number_i = ? AND p_address_line_code_c = " +
                        "?", ATransaction, false, ParametersArray));
        }
        ...
        public static void LoadViaPCountry(DataSet ADataSet, String ACountryCode, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            ...
                            "p_address_layout_code_c",
                            "p_address_line_number_i",
                            "p_address_line_code_c"}) + " FROM PUB_p_address_layout WHERE p_country_code_c = ?") 
                            + GenerateOrderByClause(AOrderBy)), PAddressLayoutTable.GetTableName(), ATransaction, ParametersArray, AStartRecord, AMaxRecords);
        }
        ...
        public static void LoadViaPCountryTemplate(DataSet ADataSet, PCountryRow ATemplateRow, StringCollection ATemplateOperators, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_p_address_layout", AFieldList, new string[] {
                            ...
                            "p_address_layout_code_c",
                            "p_address_line_number_i",
                            "p_address_line_code_c"}) + " FROM PUB_p_address_layout, PUB_p_country WHERE p_address_layout.p_country_code_c" +
        ...
        public static int CountViaPCountryTemplate(PCountryRow ATemplateRow, StringCollection ATemplateOperators, TDBTransaction ATransaction)
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(("SELECT COUNT(*) FROM PUB_p_address_layout, PUB_p_country WHERE p_address_layout.p" +
                        "_country_code_c = p_country.p_country_code_c" + GenerateWhereClauseLong("PUB_p_country", PCountryTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, PCountryTable.GetPrimKeyColumnOrdList())));
        }
        ...
        public static void LoadViaPAddressLayoutCode(DataSet ADataSet, String ACode, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            ...
                            "p_address_layout_code_c",
                            "p_address_line_number_i",
                            "p_address_line_code_c"}) + " FROM PUB_p_address_layout WHERE p_address_layout_code_c = ?") 
                            + GenerateOrderByClause(AOrderBy)), PAddressLayoutTable.GetTableName(), ATransaction, ParametersArray, AStartRecord, AMaxRecords);
        }
        ...
        public static void LoadViaPAddressLayoutCodeTemplate(DataSet ADataSet, PAddressLayoutCodeRow ATemplateRow, StringCollection ATemplateOperators, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_p_address_layout", AFieldList, new string[] {
                            ...
                            "p_address_layout_code_c",
                            "p_address_line_number_i",
                            "p_address_line_code_c"}) + " FROM PUB_p_address_layout, PUB_p_address_layout_code WHERE p_address_layout.p_ad" +
                    "dress_layout_code_c = p_address_layout_code.p_code_c") 
        ...
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(("SELECT COUNT(*) FROM PUB_p_address_layout, PUB_p_address_layout_code WHERE p_addr" +
                        "ess_layout.p_address_layout_code_c = p_address_layout_code.p_code_c" + GenerateWhereClauseLong("PUB_p_address_layout_code", PAddressLayoutCodeTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, PAddressLayoutCodeTable.GetPrimKeyColumnOrdList())));
        }
        ...
        public static void DeleteByPrimaryKey(String ACountryCode, String AAddressLayoutCode, Int32 AAddressLineNumber, String AAddressLineCode, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[3] = new OdbcParameter("", OdbcType.VarChar, 16);
            ParametersArray[3].Value = ((object)(AAddressLineCode));
            DBAccess.GDBAccessObj.ExecuteNonQuery("DELETE FROM PUB_p_address_layout WHERE p_country_code_c = ? AND p_address_layout_" +
                    "code_c = ? AND p_address_line_number_i = ? AND p_address_line_code_c = ?", ATransaction, false, ParametersArray);
        }
    ...
    public class PAddressLineAccess : TTypedDataAccess
    {
        ...
        public static void LoadAll(DataSet ADataSet, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            ...
                            "p_address_element_position_i"}) + " FROM PUB_p_address_line") 
        ...
        public static void LoadByPrimaryKey(DataSet ADataSet, String AAddressLineCode, Int32 AAddressElementPosition, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            "p_address_line_code_c",
                            "p_address_element_position_i"}) + " FROM PUB_p_address_line WHERE p_address_line_code_c = ? AND p_address_element_po" +
                    "sition_i = ?") 
        ...
        public static int CountByPrimaryKey(String AAddressLineCode, Int32 AAddressElementPosition, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[1] = new OdbcParameter("", OdbcType.Int);
            ParametersArray[1].Value = ((object)(AAddressElementPosition));
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar("SELECT COUNT(*) FROM PUB_p_address_line WHERE p_address_line_code_c = ? AND p_add" +
                        "ress_element_position_i = ?", ATransaction, false, ParametersArray));
        }
        ...
        public static void LoadViaPAddressElement(DataSet ADataSet, String AAddressElementCode, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            "p_address_line_code_c",
                            "p_address_element_position_i"}) + " FROM PUB_p_address_line WHERE p_address_element_code_c = ?") 
                            + GenerateOrderByClause(AOrderBy)), PAddressLineTable.GetTableName(), ATransaction, ParametersArray, AStartRecord, AMaxRecords);
        }
        ...
        public static void LoadViaPAddressElementTemplate(DataSet ADataSet, PAddressElementRow ATemplateRow, StringCollection ATemplateOperators, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_p_address_line", AFieldList, new string[] {
                            "p_address_line_code_c",
                            "p_address_element_position_i"}) + " FROM PUB_p_address_line, PUB_p_address_element WHERE p_address_line.p_address_el" +
                    "ement_code_c = p_address_element.p_address_element_code_c") 
        ...
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(("SELECT COUNT(*) FROM PUB_p_address_line, PUB_p_address_element WHERE p_address_li" +
                        "ne.p_address_element_code_c = p_address_element.p_address_element_code_c" + GenerateWhereClauseLong("PUB_p_address_element", PAddressElementTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, PAddressElementTable.GetPrimKeyColumnOrdList())));
        }
        ...
        public static void DeleteByPrimaryKey(String AAddressLineCode, Int32 AAddressElementPosition, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[1] = new OdbcParameter("", OdbcType.Int);
            ParametersArray[1].Value = ((object)(AAddressElementPosition));
            DBAccess.GDBAccessObj.ExecuteNonQuery("DELETE FROM PUB_p_address_line WHERE p_address_line_code_c = ? AND p_address_elem" +
                    "ent_position_i = ?", ATransaction, false, ParametersArray);
        }
    ...
    public class PAddresseeTitleOverrideAccess : TTypedDataAccess
    {
        ...
        public static void LoadAll(DataSet ADataSet, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            "p_language_code_c",
                            "p_title_c"}) + " FROM PUB_p_addressee_title_override") 
        ...
        public static void LoadByPrimaryKey(DataSet ADataSet, String ALanguageCode, String ATitle, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            "p_language_code_c",
                            "p_title_c"}) + " FROM PUB_p_addressee_title_override WHERE p_language_code_c = ? AND p_title_c = " +
                    "?") 
        ...
        public static int CountByPrimaryKey(String ALanguageCode, String ATitle, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[1] = new OdbcParameter("", OdbcType.VarChar, 64);
            ParametersArray[1].Value = ((object)(ATitle));
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar("SELECT COUNT(*) FROM PUB_p_addressee_title_override WHERE p_language_code_c = ? A" +
                        "ND p_title_c = ?", ATransaction, false, ParametersArray));
        }
        ...
        public static void LoadViaPLanguage(DataSet ADataSet, String ALanguageCode, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            "p_language_code_c",
                            "p_title_c"}) + " FROM PUB_p_addressee_title_override WHERE p_language_code_c = ?") 
                            + GenerateOrderByClause(AOrderBy)), PAddresseeTitleOverrideTable.GetTableName(), ATransaction, ParametersArray, AStartRecord, AMaxRecords);
        }
        ...
        public static void LoadViaPLanguageTemplate(DataSet ADataSet, PLanguageRow ATemplateRow, StringCollection ATemplateOperators, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_p_addressee_title_override", AFieldList, new string[] {
                            "p_language_code_c",
                            "p_title_c"}) + " FROM PUB_p_addressee_title_override, PUB_p_language WHERE p_addressee_title_over" +
                    "ride.p_language_code_c = p_language.p_language_code_c") 
        ...
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(("SELECT COUNT(*) FROM PUB_p_addressee_title_override, PUB_p_language WHERE p_addre" +
                        "ssee_title_override.p_language_code_c = p_language.p_language_code_c" + GenerateWhereClauseLong("PUB_p_language", PLanguageTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, PLanguageTable.GetPrimKeyColumnOrdList())));
        }
        ...
        public static void DeleteByPrimaryKey(String ALanguageCode, String ATitle, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[1] = new OdbcParameter("", OdbcType.VarChar, 64);
            ParametersArray[1].Value = ((object)(ATitle));
            DBAccess.GDBAccessObj.ExecuteNonQuery("DELETE FROM PUB_p_addressee_title_override WHERE p_language_code_c = ? AND p_titl" +
    ...
    public class PCustomisedGreetingAccess : TTypedDataAccess
    {
        ...
        public static void LoadAll(DataSet ADataSet, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            "p_partner_key_n",
                            "s_user_id_c"}) + " FROM PUB_p_customised_greeting") 
        ...
        public static void LoadByPrimaryKey(DataSet ADataSet, Int64 APartnerKey, String AUserId, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            "p_partner_key_n",
                            "s_user_id_c"}) + " FROM PUB_p_customised_greeting WHERE p_partner_key_n = ? AND s_user_id_c = ?") 
        ...
        public static int CountByPrimaryKey(Int64 APartnerKey, String AUserId, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[1] = new OdbcParameter("", OdbcType.VarChar, 20);
            ParametersArray[1].Value = ((object)(AUserId));
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar("SELECT COUNT(*) FROM PUB_p_customised_greeting WHERE p_partner_key_n = ? AND s_us" +
                        "er_id_c = ?", ATransaction, false, ParametersArray));
        }
        ...
        public static void LoadViaPPartner(DataSet ADataSet, Int64 APartnerKey, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            "p_partner_key_n",
                            "s_user_id_c"}) + " FROM PUB_p_customised_greeting WHERE p_partner_key_n = ?") 
                            + GenerateOrderByClause(AOrderBy)), PCustomisedGreetingTable.GetTableName(), ATransaction, ParametersArray, AStartRecord, AMaxRecords);
        }
        ...
        public static void LoadViaPPartnerTemplate(DataSet ADataSet, PPartnerRow ATemplateRow, StringCollection ATemplateOperators, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_p_customised_greeting", AFieldList, new string[] {
                            "p_partner_key_n",
                            "s_user_id_c"}) + " FROM PUB_p_customised_greeting, PUB_p_partner WHERE p_customised_greeting.p_part" +
        ...
        public static int CountViaPPartnerTemplate(PPartnerRow ATemplateRow, StringCollection ATemplateOperators, TDBTransaction ATransaction)
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(("SELECT COUNT(*) FROM PUB_p_customised_greeting, PUB_p_partner WHERE p_customised_" +
                        "greeting.p_partner_key_n = p_partner.p_partner_key_n" + GenerateWhereClauseLong("PUB_p_partner", PPartnerTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, PPartnerTable.GetPrimKeyColumnOrdList())));
        }
        ...
        public static void LoadViaSUser(DataSet ADataSet, String AUserId, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            "p_partner_key_n",
                            "s_user_id_c"}) + " FROM PUB_p_customised_greeting WHERE s_user_id_c = ?") 
                            + GenerateOrderByClause(AOrderBy)), PCustomisedGreetingTable.GetTableName(), ATransaction, ParametersArray, AStartRecord, AMaxRecords);
        }
        ...
        public static void LoadViaSUserTemplate(DataSet ADataSet, SUserRow ATemplateRow, StringCollection ATemplateOperators, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_p_customised_greeting", AFieldList, new string[] {
                            "p_partner_key_n",
                            "s_user_id_c"}) + " FROM PUB_p_customised_greeting, PUB_s_user WHERE p_customised_greeting.s_user_id" +
                    "_c = s_user.s_user_id_c") 
                            + GenerateWhereClauseLong("PUB_s_user", SUserTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)) 
                            + GenerateOrderByClause(AOrderBy)), PCustomisedGreetingTable.GetTableName(), ATransaction, GetParametersForWhereClause(ATemplateRow), AStartRecord, AMaxRecords);
        }
        ...
        public static int CountViaSUserTemplate(SUserRow ATemplateRow, StringCollection ATemplateOperators, TDBTransaction ATransaction)
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(("SELECT COUNT(*) FROM PUB_p_customised_greeting, PUB_s_user WHERE p_customised_gre" +
                        "eting.s_user_id_c = s_user.s_user_id_c" + GenerateWhereClauseLong("PUB_s_user", SUserTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, SUserTable.GetPrimKeyColumnOrdList())));
        }
        ...
        public static void DeleteByPrimaryKey(Int64 APartnerKey, String AUserId, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[1] = new OdbcParameter("", OdbcType.VarChar, 20);
            ParametersArray[1].Value = ((object)(AUserId));
            DBAccess.GDBAccessObj.ExecuteNonQuery("DELETE FROM PUB_p_customised_greeting WHERE p_partner_key_n = ? AND s_user_id_c =" +
                    " ?", ATransaction, false, ParametersArray);
        }
    ...
    public class PFormalityAccess : TTypedDataAccess
    {
        ...
        public static void LoadAll(DataSet ADataSet, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            ...
                            "p_formality_level_i"}) + " FROM PUB_p_formality") 
        ...
        public static void LoadByPrimaryKey(DataSet ADataSet, String ALanguageCode, String ACountryCode, String AAddresseeTypeCode, Int32 AFormalityLevel, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            ...
                            "p_country_code_c",
                            "p_addressee_type_code_c",
                            "p_formality_level_i"}) + " FROM PUB_p_formality WHERE p_language_code_c = ? AND p_country_code_c = ? AND p_" +
                    "addressee_type_code_c = ? AND p_formality_level_i = ?") 
        ...
        public static int CountByPrimaryKey(String ALanguageCode, String ACountryCode, String AAddresseeTypeCode, Int32 AFormalityLevel, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[3] = new OdbcParameter("", OdbcType.Int);
            ParametersArray[3].Value = ((object)(AFormalityLevel));
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar("SELECT COUNT(*) FROM PUB_p_formality WHERE p_language_code_c = ? AND p_country_co" +
                        "de_c = ? AND p_addressee_type_code_c = ? AND p_formality_level_i = ?", ATransaction, false, ParametersArray));
        }
        ...
        public static void LoadViaPLanguage(DataSet ADataSet, String ALanguageCode, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            ...
                            "p_country_code_c",
                            "p_addressee_type_code_c",
                            "p_formality_level_i"}) + " FROM PUB_p_formality WHERE p_language_code_c = ?") 
                            + GenerateOrderByClause(AOrderBy)), PFormalityTable.GetTableName(), ATransaction, ParametersArray, AStartRecord, AMaxRecords);
        }
        ...
        public static void LoadViaPLanguageTemplate(DataSet ADataSet, PLanguageRow ATemplateRow, StringCollection ATemplateOperators, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_p_formality", AFieldList, new string[] {
                            ...
                            "p_country_code_c",
                            "p_addressee_type_code_c",
                            "p_formality_level_i"}) + " FROM PUB_p_formality, PUB_p_language WHERE p_formality.p_language_code_c = p_lan" +
                    "guage.p_language_code_c") 
                            + GenerateWhereClauseLong("PUB_p_language", PLanguageTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)) 
                            + GenerateOrderByClause(AOrderBy)), PFormalityTable.GetTableName(), ATransaction, GetParametersForWhereClause(ATemplateRow), AStartRecord, AMaxRecords);
        }
        ...
        public static int CountViaPLanguageTemplate(PLanguageRow ATemplateRow, StringCollection ATemplateOperators, TDBTransaction ATransaction)
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(("SELECT COUNT(*) FROM PUB_p_formality, PUB_p_language WHERE p_formality.p_language" +
                        "_code_c = p_language.p_language_code_c" + GenerateWhereClauseLong("PUB_p_language", PLanguageTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, PLanguageTable.GetPrimKeyColumnOrdList())));
        }
        ...
        public static void LoadViaPCountry(DataSet ADataSet, String ACountryCode, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            ...
                            "p_country_code_c",
                            "p_addressee_type_code_c",
                            "p_formality_level_i"}) + " FROM PUB_p_formality WHERE p_country_code_c = ?") 
                            + GenerateOrderByClause(AOrderBy)), PFormalityTable.GetTableName(), ATransaction, ParametersArray, AStartRecord, AMaxRecords);
        }
        ...
        public static void LoadViaPCountryTemplate(DataSet ADataSet, PCountryRow ATemplateRow, StringCollection ATemplateOperators, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_p_formality", AFieldList, new string[] {
                            ...
                            "p_country_code_c",
                            "p_addressee_type_code_c",
                            "p_formality_level_i"}) + " FROM PUB_p_formality, PUB_p_country WHERE p_formality.p_country_code_c = p_count" +
                    "ry.p_country_code_c") 
                            + GenerateWhereClauseLong("PUB_p_country", PCountryTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)) 
                            + GenerateOrderByClause(AOrderBy)), PFormalityTable.GetTableName(), ATransaction, GetParametersForWhereClause(ATemplateRow), AStartRecord, AMaxRecords);
        }
        ...
        public static int CountViaPCountryTemplate(PCountryRow ATemplateRow, StringCollection ATemplateOperators, TDBTransaction ATransaction)
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(("SELECT COUNT(*) FROM PUB_p_formality, PUB_p_country WHERE p_formality.p_country_c" +
                        "ode_c = p_country.p_country_code_c" + GenerateWhereClauseLong("PUB_p_country", PCountryTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, PCountryTable.GetPrimKeyColumnOrdList())));
        }
        ...
        public static void LoadViaPAddresseeType(DataSet ADataSet, String AAddresseeTypeCode, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            ...
                            "p_country_code_c",
                            "p_addressee_type_code_c",
                            "p_formality_level_i"}) + " FROM PUB_p_formality WHERE p_addressee_type_code_c = ?") 
                            + GenerateOrderByClause(AOrderBy)), PFormalityTable.GetTableName(), ATransaction, ParametersArray, AStartRecord, AMaxRecords);
        }
        ...
        public static void LoadViaPAddresseeTypeTemplate(DataSet ADataSet, PAddresseeTypeRow ATemplateRow, StringCollection ATemplateOperators, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_p_formality", AFieldList, new string[] {
                            ...
                            "p_country_code_c",
                            "p_addressee_type_code_c",
                            "p_formality_level_i"}) + " FROM PUB_p_formality, PUB_p_addressee_type WHERE p_formality.p_addressee_type_co" +
        ...
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(("SELECT COUNT(*) FROM PUB_p_formality, PUB_p_addressee_type WHERE p_formality.p_ad" +
        ...
        public static void DeleteByPrimaryKey(String ALanguageCode, String ACountryCode, String AAddresseeTypeCode, Int32 AFormalityLevel, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[3] = new OdbcParameter("", OdbcType.Int);
            ParametersArray[3].Value = ((object)(AFormalityLevel));
            DBAccess.GDBAccessObj.ExecuteNonQuery("DELETE FROM PUB_p_formality WHERE p_language_code_c = ? AND p_country_code_c = ? " +
                    "AND p_addressee_type_code_c = ? AND p_formality_level_i = ?", ATransaction, false, ParametersArray);
        }
    ...
    public class PFormLetterBodyAccess : TTypedDataAccess
    {
        ...
        public static void LoadViaSUserTemplate(DataSet ADataSet, SUserRow ATemplateRow, StringCollection ATemplateOperators, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_p_form_letter_body", AFieldList, new string[] {
                            "p_body_name_c"}) + " FROM PUB_p_form_letter_body, PUB_s_user WHERE p_form_letter_body.p_owner_c = s_u" +
                    "ser.s_user_id_c") 
                            + GenerateWhereClauseLong("PUB_s_user", SUserTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)) 
                            + GenerateOrderByClause(AOrderBy)), PFormLetterBodyTable.GetTableName(), ATransaction, GetParametersForWhereClause(ATemplateRow), AStartRecord, AMaxRecords);
        }
        ...
        public static int CountViaSUserTemplate(SUserRow ATemplateRow, StringCollection ATemplateOperators, TDBTransaction ATransaction)
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(("SELECT COUNT(*) FROM PUB_p_form_letter_body, PUB_s_user WHERE p_form_letter_body." +
                        "p_owner_c = s_user.s_user_id_c" + GenerateWhereClauseLong("PUB_s_user", SUserTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, SUserTable.GetPrimKeyColumnOrdList())));
        }
    ...
    public class PFormLetterDesignAccess : TTypedDataAccess
    {
        ...
        public static void LoadViaPFormLetterBodyTemplate(DataSet ADataSet, PFormLetterBodyRow ATemplateRow, StringCollection ATemplateOperators, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_p_form_letter_design", AFieldList, new string[] {
                            "p_design_name_c"}) + " FROM PUB_p_form_letter_design, PUB_p_form_letter_body WHERE p_form_letter_design" +
                    ".p_body_name_c = p_form_letter_body.p_body_name_c") 
        ...
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(("SELECT COUNT(*) FROM PUB_p_form_letter_design, PUB_p_form_letter_body WHERE p_for" +
                        "m_letter_design.p_body_name_c = p_form_letter_body.p_body_name_c" + GenerateWhereClauseLong("PUB_p_form_letter_body", PFormLetterBodyTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, PFormLetterBodyTable.GetPrimKeyColumnOrdList())));
        }
        ...
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_p_form_letter_design", AFieldList, new string[] {
                            "p_design_name_c"}) + " FROM PUB_p_form_letter_design, PUB_p_address_layout_code WHERE p_form_letter_des" +
                    "ign.p_address_layout_code_c = p_address_layout_code.p_code_c") 
                            + GenerateWhereClauseLong("PUB_p_address_layout_code", PAddressLayoutCodeTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)) 
                            + GenerateOrderByClause(AOrderBy)), PFormLetterDesignTable.GetTableName(), ATransaction, GetParametersForWhereClause(ATemplateRow), AStartRecord, AMaxRecords);
        }
    ...
    public class PFormLetterInsertAccess : TTypedDataAccess
    {
        ...
        public static void LoadViaPFormLetterBodyTemplate(DataSet ADataSet, PFormLetterBodyRow ATemplateRow, StringCollection ATemplateOperators, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_p_form_letter_insert", AFieldList, new string[] {
                            "p_sequence_i"}) + " FROM PUB_p_form_letter_insert, PUB_p_form_letter_body WHERE p_form_letter_insert" +
                    ".p_body_name_c = p_form_letter_body.p_body_name_c") 
                            + GenerateWhereClauseLong("PUB_p_form_letter_body", PFormLetterBodyTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)) 
                            + GenerateOrderByClause(AOrderBy)), PFormLetterInsertTable.GetTableName(), ATransaction, GetParametersForWhereClause(ATemplateRow), AStartRecord, AMaxRecords);
        }
        ...
        public static int CountViaPFormLetterBodyTemplate(PFormLetterBodyRow ATemplateRow, StringCollection ATemplateOperators, TDBTransaction ATransaction)
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(("SELECT COUNT(*) FROM PUB_p_form_letter_insert, PUB_p_form_letter_body WHERE p_for" +
                        "m_letter_insert.p_body_name_c = p_form_letter_body.p_body_name_c" + GenerateWhereClauseLong("PUB_p_form_letter_body", PFormLetterBodyTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, PFormLetterBodyTable.GetPrimKeyColumnOrdList())));
        }
        ...
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_p_form_letter_insert", AFieldList, new string[] {
                            "p_sequence_i"}) + " FROM PUB_p_form_letter_insert, PUB_p_partner WHERE p_form_letter_insert.p_partne" +
        ...
        public static int CountViaPPartnerTemplate(PPartnerRow ATemplateRow, StringCollection ATemplateOperators, TDBTransaction ATransaction)
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(("SELECT COUNT(*) FROM PUB_p_form_letter_insert, PUB_p_partner WHERE p_form_letter_" +
                        "insert.p_partner_key_n = p_partner.p_partner_key_n" + GenerateWhereClauseLong("PUB_p_partner", PPartnerTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, PPartnerTable.GetPrimKeyColumnOrdList())));
        }
        ...
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_p_form_letter_insert", AFieldList, new string[] {
                            "p_sequence_i"}) + " FROM PUB_p_form_letter_insert, PUB_m_extract_master WHERE p_form_letter_insert.m" +
                    "_extract_id_i = m_extract_master.m_extract_id_i") 
                            + GenerateWhereClauseLong("PUB_m_extract_master", MExtractMasterTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)) 
                            + GenerateOrderByClause(AOrderBy)), PFormLetterInsertTable.GetTableName(), ATransaction, GetParametersForWhereClause(ATemplateRow), AStartRecord, AMaxRecords);
        }
        ...
        public static int CountViaMExtractMasterTemplate(MExtractMasterRow ATemplateRow, StringCollection ATemplateOperators, TDBTransaction ATransaction)
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(("SELECT COUNT(*) FROM PUB_p_form_letter_insert, PUB_m_extract_master WHERE p_form_" +
                        "letter_insert.m_extract_id_i = m_extract_master.m_extract_id_i" + GenerateWhereClauseLong("PUB_m_extract_master", MExtractMasterTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, MExtractMasterTable.GetPrimKeyColumnOrdList())));
        }
    ...
    public class PLabelAccess : TTypedDataAccess
    {
        ...
        public static void LoadViaSFormTemplate(DataSet ADataSet, SFormRow ATemplateRow, StringCollection ATemplateOperators, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_p_label", AFieldList, new string[] {
                            "p_code_c"}) + " FROM PUB_p_label, PUB_s_form WHERE p_label.s_form_name_c = s_form.s_form_name_c") 
        ...
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(("SELECT COUNT(*) FROM PUB_p_label, PUB_s_form WHERE p_label.s_form_name_c = s_form" +
                        ".s_form_name_c" + GenerateWhereClauseLong("PUB_s_form", SFormTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, SFormTable.GetPrimKeyColumnOrdList())));
        }
    ...
    public class PMergeFieldAccess : TTypedDataAccess
    {
        ...
        public static void LoadAll(DataSet ADataSet, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            "p_merge_form_name_c",
                            "p_merge_field_name_c"}) + " FROM PUB_p_merge_field") 
        ...
        public static void LoadByPrimaryKey(DataSet ADataSet, String AMergeFormName, String AMergeFieldName, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            "p_merge_form_name_c",
                            "p_merge_field_name_c"}) + " FROM PUB_p_merge_field WHERE p_merge_form_name_c = ? AND p_merge_field_name_c = " +
                    "?") 
        ...
        public static int CountByPrimaryKey(String AMergeFormName, String AMergeFieldName, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[1] = new OdbcParameter("", OdbcType.VarChar, 32);
            ParametersArray[1].Value = ((object)(AMergeFieldName));
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar("SELECT COUNT(*) FROM PUB_p_merge_field WHERE p_merge_form_name_c = ? AND p_merge_" +
                        "field_name_c = ?", ATransaction, false, ParametersArray));
        }
        ...
        public static void LoadViaPMergeForm(DataSet ADataSet, String AMergeFormName, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            "p_merge_form_name_c",
                            "p_merge_field_name_c"}) + " FROM PUB_p_merge_field WHERE p_merge_form_name_c = ?") 
                            + GenerateOrderByClause(AOrderBy)), PMergeFieldTable.GetTableName(), ATransaction, ParametersArray, AStartRecord, AMaxRecords);
        }
        ...
        public static void LoadViaPMergeFormTemplate(DataSet ADataSet, PMergeFormRow ATemplateRow, StringCollection ATemplateOperators, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_p_merge_field", AFieldList, new string[] {
                            "p_merge_form_name_c",
                            "p_merge_field_name_c"}) + " FROM PUB_p_merge_field, PUB_p_merge_form WHERE p_merge_field.p_merge_form_name_c" +
                    " = p_merge_form.p_merge_form_name_c") 
        ...
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(("SELECT COUNT(*) FROM PUB_p_merge_field, PUB_p_merge_form WHERE p_merge_field.p_me" +
                        "rge_form_name_c = p_merge_form.p_merge_form_name_c" + GenerateWhereClauseLong("PUB_p_merge_form", PMergeFormTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, PMergeFormTable.GetPrimKeyColumnOrdList())));
        }
        ...
        public static void DeleteByPrimaryKey(String AMergeFormName, String AMergeFieldName, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[1] = new OdbcParameter("", OdbcType.VarChar, 32);
            ParametersArray[1].Value = ((object)(AMergeFieldName));
            DBAccess.GDBAccessObj.ExecuteNonQuery("DELETE FROM PUB_p_merge_field WHERE p_merge_form_name_c = ? AND p_merge_field_nam" +
                    "e_c = ?", ATransaction, false, ParametersArray);
        }
    ...
    public class PPostcodeRegionAccess : TTypedDataAccess
    {
        ...
        public static void LoadAll(DataSet ADataSet, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            "p_region_c",
                            "p_range_c"}) + " FROM PUB_p_postcode_region") 
        ...
        public static void LoadByPrimaryKey(DataSet ADataSet, String ARegion, String ARange, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            "p_region_c",
                            "p_range_c"}) + " FROM PUB_p_postcode_region WHERE p_region_c = ? AND p_range_c = ?") 
        ...
        public static int CountByPrimaryKey(String ARegion, String ARange, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[1] = new OdbcParameter("", OdbcType.VarChar, 64);
            ParametersArray[1].Value = ((object)(ARange));
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar("SELECT COUNT(*) FROM PUB_p_postcode_region WHERE p_region_c = ? AND p_range_c = ?" +
                        "", ATransaction, false, ParametersArray));
        }
        ...
        public static void LoadViaPPostcodeRange(DataSet ADataSet, String ARange, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            "p_region_c",
                            "p_range_c"}) + " FROM PUB_p_postcode_region WHERE p_range_c = ?") 
                            + GenerateOrderByClause(AOrderBy)), PPostcodeRegionTable.GetTableName(), ATransaction, ParametersArray, AStartRecord, AMaxRecords);
        }
        ...
        public static void LoadViaPPostcodeRangeTemplate(DataSet ADataSet, PPostcodeRangeRow ATemplateRow, StringCollection ATemplateOperators, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_p_postcode_region", AFieldList, new string[] {
                            "p_region_c",
                            "p_range_c"}) + " FROM PUB_p_postcode_region, PUB_p_postcode_range WHERE p_postcode_region.p_range" +
                    "_c = p_postcode_range.p_range_c") 
        ...
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(("SELECT COUNT(*) FROM PUB_p_postcode_region, PUB_p_postcode_range WHERE p_postcode" +
                        "_region.p_range_c = p_postcode_range.p_range_c" + GenerateWhereClauseLong("PUB_p_postcode_range", PPostcodeRangeTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, PPostcodeRangeTable.GetPrimKeyColumnOrdList())));
        }
    ...
    public class PPublicationAccess : TTypedDataAccess
    {
        ...
        public static void LoadViaAFrequencyTemplate(DataSet ADataSet, AFrequencyRow ATemplateRow, StringCollection ATemplateOperators, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_p_publication", AFieldList, new string[] {
                            "p_publication_code_c"}) + " FROM PUB_p_publication, PUB_a_frequency WHERE p_publication.a_frequency_code_c =" +
                    " a_frequency.a_frequency_code_c") 
        ...
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(("SELECT COUNT(*) FROM PUB_p_publication, PUB_a_frequency WHERE p_publication.a_fre" +
                        "quency_code_c = a_frequency.a_frequency_code_c" + GenerateWhereClauseLong("PUB_a_frequency", AFrequencyTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, AFrequencyTable.GetPrimKeyColumnOrdList())));
        }
        ...
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_p_publication", AFieldList, new string[] {
                            "p_publication_code_c"}) + " FROM PUB_p_publication, PUB_p_language WHERE p_publication.p_publication_languag" +
                    "e_c = p_language.p_language_code_c") 
                            + GenerateWhereClauseLong("PUB_p_language", PLanguageTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)) 
                            + GenerateOrderByClause(AOrderBy)), PPublicationTable.GetTableName(), ATransaction, GetParametersForWhereClause(ATemplateRow), AStartRecord, AMaxRecords);
        }
        ...
        public static int CountViaPLanguageTemplate(PLanguageRow ATemplateRow, StringCollection ATemplateOperators, TDBTransaction ATransaction)
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(("SELECT COUNT(*) FROM PUB_p_publication, PUB_p_language WHERE p_publication.p_publ" +
                        "ication_language_c = p_language.p_language_code_c" + GenerateWhereClauseLong("PUB_p_language", PLanguageTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, PLanguageTable.GetPrimKeyColumnOrdList())));
        }
        ...
        public static void LoadViaPPartner(DataSet ADataSet, Int64 APartnerKey, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ParametersArray[0].Value = ((object)(APartnerKey));
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClauseLong("PUB_p_publication", AFieldList, new string[] {
                            "p_publication_code_c"}) + " FROM PUB_p_publication, PUB_p_subscription WHERE PUB_p_subscription.p_publicatio" +
                    "n_code_c = PUB_p_publication.p_publication_code_c AND PUB_p_subscription.p_partn" +
                    "er_key_n = ?") 
                            + GenerateOrderByClause(AOrderBy)), PPublicationTable.GetTableName(), ATransaction, ParametersArray, AStartRecord, AMaxRecords);
        }
        ...
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_p_publication", AFieldList, new string[] {
                            "p_publication_code_c"}) + " FROM PUB_p_publication, PUB_p_subscription, PUB_p_partner WHERE PUB_p_subscripti" +
                    "on.p_publication_code_c = PUB_p_publication.p_publication_code_c AND PUB_p_subsc" +
                    "ription.p_partner_key_n = PUB_p_partner.p_partner_key_n") 
                            + GenerateWhereClauseLong("PUB_p_partner", PPartnerTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)) 
                            + GenerateOrderByClause(AOrderBy)), PPublicationTable.GetTableName(), ATransaction, GetParametersForWhereClause(ATemplateRow), AStartRecord, AMaxRecords);
        }
        ...
        public static int CountViaPPartner(Int64 APartnerKey, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[0] = new OdbcParameter("", OdbcType.Decimal, 10);
            ParametersArray[0].Value = ((object)(APartnerKey));
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar("SELECT COUNT(*) FROM PUB_p_publication, PUB_p_subscription WHERE PUB_p_subscripti" +
                        "on.p_publication_code_c = PUB_p_publication.p_publication_code_c AND PUB_p_subsc" +
                        "ription.p_partner_key_n = ?", ATransaction, false, ParametersArray));
        }
        
        /// auto generated
        public static int CountViaPPartnerTemplate(PPartnerRow ATemplateRow, StringCollection ATemplateOperators, TDBTransaction ATransaction)
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(("SELECT COUNT(*) FROM PUB_p_publication, PUB_p_subscription, PUB_p_partner WHERE P" +
                        "UB_p_subscription.p_publication_code_c = PUB_p_publication.p_publication_code_c " +
                        "AND PUB_p_subscription.p_partner_key_n = PUB_p_partner.p_partner_key_n" + GenerateWhereClauseLong("PUB_p_partner", PPartnerTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, PPartnerTable.GetPrimKeyColumnOrdList())));
        }
    ...
    public class PPublicationCostAccess : TTypedDataAccess
    {
        ...
        public static void LoadAll(DataSet ADataSet, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            ...
                            "p_date_effective_d"}) + " FROM PUB_p_publication_cost") 
        ...
        public static void LoadByPrimaryKey(DataSet ADataSet, String APublicationCode, System.DateTime ADateEffective, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            "p_publication_code_c",
                            "p_date_effective_d"}) + " FROM PUB_p_publication_cost WHERE p_publication_code_c = ? AND p_date_effective_" +
                    "d = ?") 
        ...
        public static int CountByPrimaryKey(String APublicationCode, System.DateTime ADateEffective, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[1] = new OdbcParameter("", OdbcType.Date);
            ParametersArray[1].Value = ((object)(ADateEffective));
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar("SELECT COUNT(*) FROM PUB_p_publication_cost WHERE p_publication_code_c = ? AND p_" +
                        "date_effective_d = ?", ATransaction, false, ParametersArray));
        }
        ...
        public static void LoadViaPPublication(DataSet ADataSet, String APublicationCode, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            "p_publication_code_c",
                            "p_date_effective_d"}) + " FROM PUB_p_publication_cost WHERE p_publication_code_c = ?") 
                            + GenerateOrderByClause(AOrderBy)), PPublicationCostTable.GetTableName(), ATransaction, ParametersArray, AStartRecord, AMaxRecords);
        }
        ...
        public static void LoadViaPPublicationTemplate(DataSet ADataSet, PPublicationRow ATemplateRow, StringCollection ATemplateOperators, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_p_publication_cost", AFieldList, new string[] {
                            "p_publication_code_c",
                            "p_date_effective_d"}) + " FROM PUB_p_publication_cost, PUB_p_publication WHERE p_publication_cost.p_public" +
                    "ation_code_c = p_publication.p_publication_code_c") 
        ...
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(("SELECT COUNT(*) FROM PUB_p_publication_cost, PUB_p_publication WHERE p_publicatio" +
                        "n_cost.p_publication_code_c = p_publication.p_publication_code_c" + GenerateWhereClauseLong("PUB_p_publication", PPublicationTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, PPublicationTable.GetPrimKeyColumnOrdList())));
        }
        ...
        public static void LoadViaACurrency(DataSet ADataSet, String ACurrencyCode, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            "p_publication_code_c",
                            "p_date_effective_d"}) + " FROM PUB_p_publication_cost WHERE p_currency_code_c = ?") 
                            + GenerateOrderByClause(AOrderBy)), PPublicationCostTable.GetTableName(), ATransaction, ParametersArray, AStartRecord, AMaxRecords);
        }
        ...
        public static void LoadViaACurrencyTemplate(DataSet ADataSet, ACurrencyRow ATemplateRow, StringCollection ATemplateOperators, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_p_publication_cost", AFieldList, new string[] {
                            "p_publication_code_c",
                            "p_date_effective_d"}) + " FROM PUB_p_publication_cost, PUB_a_currency WHERE p_publication_cost.p_currency_" +
        ...
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(("SELECT COUNT(*) FROM PUB_p_publication_cost, PUB_a_currency WHERE p_publication_c" +
                        "ost.p_currency_code_c = a_currency.a_currency_code_c" + GenerateWhereClauseLong("PUB_a_currency", ACurrencyTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, ACurrencyTable.GetPrimKeyColumnOrdList())));
        }
        ...
        public static void DeleteByPrimaryKey(String APublicationCode, System.DateTime ADateEffective, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[1] = new OdbcParameter("", OdbcType.Date);
            ParametersArray[1].Value = ((object)(ADateEffective));
            DBAccess.GDBAccessObj.ExecuteNonQuery("DELETE FROM PUB_p_publication_cost WHERE p_publication_code_c = ? AND p_date_effe" +
                    "ctive_d = ?", ATransaction, false, ParametersArray);
        }
    ...
    public class PSubscriptionAccess : TTypedDataAccess
    {
        ...
        public static void LoadAll(DataSet ADataSet, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            "p_publication_code_c",
                            "p_partner_key_n"}) + " FROM PUB_p_subscription") 
        ...
        public static void LoadByPrimaryKey(DataSet ADataSet, String APublicationCode, Int64 APartnerKey, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            "p_publication_code_c",
                            "p_partner_key_n"}) + " FROM PUB_p_subscription WHERE p_publication_code_c = ? AND p_partner_key_n = ?") 
        ...
        public static int CountByPrimaryKey(String APublicationCode, Int64 APartnerKey, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[1] = new OdbcParameter("", OdbcType.Decimal, 10);
            ParametersArray[1].Value = ((object)(APartnerKey));
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar("SELECT COUNT(*) FROM PUB_p_subscription WHERE p_publication_code_c = ? AND p_part" +
                        "ner_key_n = ?", ATransaction, false, ParametersArray));
        }
        ...
        public static void LoadViaPPublication(DataSet ADataSet, String APublicationCode, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            "p_publication_code_c",
                            "p_partner_key_n"}) + " FROM PUB_p_subscription WHERE p_publication_code_c = ?") 
                            + GenerateOrderByClause(AOrderBy)), PSubscriptionTable.GetTableName(), ATransaction, ParametersArray, AStartRecord, AMaxRecords);
        }
        ...
        public static void LoadViaPPublicationTemplate(DataSet ADataSet, PPublicationRow ATemplateRow, StringCollection ATemplateOperators, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_p_subscription", AFieldList, new string[] {
                            "p_publication_code_c",
                            "p_partner_key_n"}) + " FROM PUB_p_subscription, PUB_p_publication WHERE p_subscription.p_publication_co" +
                    "de_c = p_publication.p_publication_code_c") 
                            + GenerateWhereClauseLong("PUB_p_publication", PPublicationTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)) 
                            + GenerateOrderByClause(AOrderBy)), PSubscriptionTable.GetTableName(), ATransaction, GetParametersForWhereClause(ATemplateRow), AStartRecord, AMaxRecords);
        }
        ...
        public static int CountViaPPublicationTemplate(PPublicationRow ATemplateRow, StringCollection ATemplateOperators, TDBTransaction ATransaction)
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(("SELECT COUNT(*) FROM PUB_p_subscription, PUB_p_publication WHERE p_subscription.p" +
                        "_publication_code_c = p_publication.p_publication_code_c" + GenerateWhereClauseLong("PUB_p_publication", PPublicationTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, PPublicationTable.GetPrimKeyColumnOrdList())));
        }
        ...
        public static void LoadViaPPartnerPartnerKey(DataSet ADataSet, Int64 APartnerKey, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            "p_publication_code_c",
                            "p_partner_key_n"}) + " FROM PUB_p_subscription WHERE p_partner_key_n = ?") 
                            + GenerateOrderByClause(AOrderBy)), PSubscriptionTable.GetTableName(), ATransaction, ParametersArray, AStartRecord, AMaxRecords);
        }
        ...
        public static void LoadViaPPartnerPartnerKeyTemplate(DataSet ADataSet, PPartnerRow ATemplateRow, StringCollection ATemplateOperators, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_p_subscription", AFieldList, new string[] {
                            "p_publication_code_c",
                            "p_partner_key_n"}) + " FROM PUB_p_subscription, PUB_p_partner WHERE p_subscription.p_partner_key_n = p_" +
        ...
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(("SELECT COUNT(*) FROM PUB_p_subscription, PUB_p_partner WHERE p_subscription.p_par" +
        ...
        public static void LoadViaPPartnerGiftFromKey(DataSet ADataSet, Int64 APartnerKey, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            "p_publication_code_c",
                            "p_partner_key_n"}) + " FROM PUB_p_subscription WHERE p_gift_from_key_n = ?") 
                            + GenerateOrderByClause(AOrderBy)), PSubscriptionTable.GetTableName(), ATransaction, ParametersArray, AStartRecord, AMaxRecords);
        }
        ...
        public static void LoadViaPPartnerGiftFromKeyTemplate(DataSet ADataSet, PPartnerRow ATemplateRow, StringCollection ATemplateOperators, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_p_subscription", AFieldList, new string[] {
                            "p_publication_code_c",
                            "p_partner_key_n"}) + " FROM PUB_p_subscription, PUB_p_partner WHERE p_subscription.p_gift_from_key_n = " +
        ...
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(("SELECT COUNT(*) FROM PUB_p_subscription, PUB_p_partner WHERE p_subscription.p_gif" +
                        "t_from_key_n = p_partner.p_partner_key_n" + GenerateWhereClauseLong("PUB_p_partner", PPartnerTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, PPartnerTable.GetPrimKeyColumnOrdList())));
        }
        ...
        public static void LoadViaPReasonSubscriptionGiven(DataSet ADataSet, String ACode, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            "p_publication_code_c",
                            "p_partner_key_n"}) + " FROM PUB_p_subscription WHERE p_reason_subs_given_code_c = ?") 
                            + GenerateOrderByClause(AOrderBy)), PSubscriptionTable.GetTableName(), ATransaction, ParametersArray, AStartRecord, AMaxRecords);
        }
        ...
        public static void LoadViaPReasonSubscriptionGivenTemplate(DataSet ADataSet, PReasonSubscriptionGivenRow ATemplateRow, StringCollection ATemplateOperators, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_p_subscription", AFieldList, new string[] {
                            "p_publication_code_c",
                            "p_partner_key_n"}) + " FROM PUB_p_subscription, PUB_p_reason_subscription_given WHERE p_subscription.p_" +
                    "reason_subs_given_code_c = p_reason_subscription_given.p_code_c") 
        ...
        public static void LoadViaPReasonSubscriptionCancelled(DataSet ADataSet, String ACode, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            "p_publication_code_c",
                            "p_partner_key_n"}) + " FROM PUB_p_subscription WHERE p_reason_subs_cancelled_code_c = ?") 
                            + GenerateOrderByClause(AOrderBy)), PSubscriptionTable.GetTableName(), ATransaction, ParametersArray, AStartRecord, AMaxRecords);
        }
        ...
        public static void LoadViaPReasonSubscriptionCancelledTemplate(DataSet ADataSet, PReasonSubscriptionCancelledRow ATemplateRow, StringCollection ATemplateOperators, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_p_subscription", AFieldList, new string[] {
                            "p_publication_code_c",
                            "p_partner_key_n"}) + " FROM PUB_p_subscription, PUB_p_reason_subscription_cancelled WHERE p_subscriptio" +
                    "n.p_reason_subs_cancelled_code_c = p_reason_subscription_cancelled.p_code_c") 
        ...
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(("SELECT COUNT(*) FROM PUB_p_subscription, PUB_p_reason_subscription_cancelled WHER" +
                        "E p_subscription.p_reason_subs_cancelled_code_c = p_reason_subscription_cancelle" +
                        "d.p_code_c" + GenerateWhereClauseLong("PUB_p_reason_subscription_cancelled", PReasonSubscriptionCancelledTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, PReasonSubscriptionCancelledTable.GetPrimKeyColumnOrdList())));
        }
        ...
        public static void DeleteByPrimaryKey(String APublicationCode, Int64 APartnerKey, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[1] = new OdbcParameter("", OdbcType.Decimal, 10);
            ParametersArray[1].Value = ((object)(APartnerKey));
            DBAccess.GDBAccessObj.ExecuteNonQuery("DELETE FROM PUB_p_subscription WHERE p_publication_code_c = ? AND p_partner_key_n" +
                    " = ?", ATransaction, false, ParametersArray);
        }
    ...
    public class PContactAttributeAccess : TTypedDataAccess
    {
        ...
        public static int CountByPrimaryKey(String AContactAttributeCode, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[0] = new OdbcParameter("", OdbcType.VarChar, 32);
            ParametersArray[0].Value = ((object)(AContactAttributeCode));
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar("SELECT COUNT(*) FROM PUB_p_contact_attribute WHERE p_contact_attribute_code_c = ?" +
                        "", ATransaction, false, ParametersArray));
        }
    ...
    public class PContactAttributeDetailAccess : TTypedDataAccess
    {
        ...
        public static void LoadAll(DataSet ADataSet, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            ...
                            "p_contact_attr_detail_code_c"}) + " FROM PUB_p_contact_attribute_detail") 
        ...
        public static void LoadByPrimaryKey(DataSet ADataSet, String AContactAttributeCode, String AContactAttrDetailCode, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            "p_contact_attribute_code_c",
                            "p_contact_attr_detail_code_c"}) + " FROM PUB_p_contact_attribute_detail WHERE p_contact_attribute_code_c = ? AND p_c" +
                    "ontact_attr_detail_code_c = ?") 
        ...
        public static int CountByPrimaryKey(String AContactAttributeCode, String AContactAttrDetailCode, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[1] = new OdbcParameter("", OdbcType.VarChar, 32);
            ParametersArray[1].Value = ((object)(AContactAttrDetailCode));
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar("SELECT COUNT(*) FROM PUB_p_contact_attribute_detail WHERE p_contact_attribute_cod" +
                        "e_c = ? AND p_contact_attr_detail_code_c = ?", ATransaction, false, ParametersArray));
        }
        ...
        public static void LoadViaPContactAttribute(DataSet ADataSet, String AContactAttributeCode, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            "p_contact_attribute_code_c",
                            "p_contact_attr_detail_code_c"}) + " FROM PUB_p_contact_attribute_detail WHERE p_contact_attribute_code_c = ?") 
                            + GenerateOrderByClause(AOrderBy)), PContactAttributeDetailTable.GetTableName(), ATransaction, ParametersArray, AStartRecord, AMaxRecords);
        }
        ...
        public static void LoadViaPContactAttributeTemplate(DataSet ADataSet, PContactAttributeRow ATemplateRow, StringCollection ATemplateOperators, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_p_contact_attribute_detail", AFieldList, new string[] {
                            "p_contact_attribute_code_c",
                            "p_contact_attr_detail_code_c"}) + " FROM PUB_p_contact_attribute_detail, PUB_p_contact_attribute WHERE p_contact_att" +
                    "ribute_detail.p_contact_attribute_code_c = p_contact_attribute.p_contact_attribu" +
                    "te_code_c") 
        ...
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(("SELECT COUNT(*) FROM PUB_p_contact_attribute_detail, PUB_p_contact_attribute WHER" +
                        "E p_contact_attribute_detail.p_contact_attribute_code_c = p_contact_attribute.p_" +
                        "contact_attribute_code_c" + GenerateWhereClauseLong("PUB_p_contact_attribute", PContactAttributeTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, PContactAttributeTable.GetPrimKeyColumnOrdList())));
        }
        ...
        public static void LoadViaPPartnerContact(DataSet ADataSet, Int32 AContactId, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClauseLong("PUB_p_contact_attribute_detail", AFieldList, new string[] {
                            "p_contact_attribute_code_c",
                            "p_contact_attr_detail_code_c"}) + @" FROM PUB_p_contact_attribute_detail, PUB_p_partner_contact_attribute WHERE PUB_p_partner_contact_attribute.p_contact_attribute_code_c = PUB_p_contact_attribute_detail.p_contact_attribute_code_c AND PUB_p_partner_contact_attribute.p_contact_attr_detail_code_c = PUB_p_contact_attribute_detail.p_contact_attr_detail_code_c AND PUB_p_partner_contact_attribute.p_contact_id_i = ?") 
                            + GenerateOrderByClause(AOrderBy)), PContactAttributeDetailTable.GetTableName(), ATransaction, ParametersArray, AStartRecord, AMaxRecords);
        }
        ...
        public static int CountViaPPartnerContact(Int32 AContactId, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[0] = new OdbcParameter("", OdbcType.Int);
            ParametersArray[0].Value = ((object)(AContactId));
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(@"SELECT COUNT(*) FROM PUB_p_contact_attribute_detail, PUB_p_partner_contact_attribute WHERE PUB_p_partner_contact_attribute.p_contact_attribute_code_c = PUB_p_contact_attribute_detail.p_contact_attribute_code_c AND PUB_p_partner_contact_attribute.p_contact_attr_detail_code_c = PUB_p_contact_attribute_detail.p_contact_attr_detail_code_c AND PUB_p_partner_contact_attribute.p_contact_id_i = ?", ATransaction, false, ParametersArray));
        }
        ...
        public static void DeleteByPrimaryKey(String AContactAttributeCode, String AContactAttrDetailCode, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[1] = new OdbcParameter("", OdbcType.VarChar, 32);
            ParametersArray[1].Value = ((object)(AContactAttrDetailCode));
            DBAccess.GDBAccessObj.ExecuteNonQuery("DELETE FROM PUB_p_contact_attribute_detail WHERE p_contact_attribute_code_c = ? A" +
                    "ND p_contact_attr_detail_code_c = ?", ATransaction, false, ParametersArray);
        }
    ...
    public class PMethodOfContactAccess : TTypedDataAccess
    {
        ...
        public static int CountByPrimaryKey(String AMethodOfContactCode, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[0] = new OdbcParameter("", OdbcType.VarChar, 16);
            ParametersArray[0].Value = ((object)(AMethodOfContactCode));
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar("SELECT COUNT(*) FROM PUB_p_method_of_contact WHERE p_method_of_contact_code_c = ?" +
                        "", ATransaction, false, ParametersArray));
        }
    ...
    public class PPartnerContactAccess : TTypedDataAccess
    {
        ...
        public static void LoadViaPPartnerTemplate(DataSet ADataSet, PPartnerRow ATemplateRow, StringCollection ATemplateOperators, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_p_partner_contact", AFieldList, new string[] {
                            "p_contact_id_i"}) + " FROM PUB_p_partner_contact, PUB_p_partner WHERE p_partner_contact.p_partner_key_" +
        ...
        public static int CountViaPPartnerTemplate(PPartnerRow ATemplateRow, StringCollection ATemplateOperators, TDBTransaction ATransaction)
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(("SELECT COUNT(*) FROM PUB_p_partner_contact, PUB_p_partner WHERE p_partner_contact" +
        ...
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_p_partner_contact", AFieldList, new string[] {
                            "p_contact_id_i"}) + " FROM PUB_p_partner_contact, PUB_p_mailing WHERE p_partner_contact.p_mailing_code" +
                    "_c = p_mailing.p_mailing_code_c") 
        ...
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(("SELECT COUNT(*) FROM PUB_p_partner_contact, PUB_p_mailing WHERE p_partner_contact" +
                        ".p_mailing_code_c = p_mailing.p_mailing_code_c" + GenerateWhereClauseLong("PUB_p_mailing", PMailingTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, PMailingTable.GetPrimKeyColumnOrdList())));
        }
        ...
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_p_partner_contact", AFieldList, new string[] {
                            "p_contact_id_i"}) + " FROM PUB_p_partner_contact, PUB_p_method_of_contact WHERE p_partner_contact.p_co" +
                    "ntact_code_c = p_method_of_contact.p_method_of_contact_code_c") 
        ...
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(("SELECT COUNT(*) FROM PUB_p_partner_contact, PUB_p_method_of_contact WHERE p_partn" +
                        "er_contact.p_contact_code_c = p_method_of_contact.p_method_of_contact_code_c" + GenerateWhereClauseLong("PUB_p_method_of_contact", PMethodOfContactTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, PMethodOfContactTable.GetPrimKeyColumnOrdList())));
        }
        ...
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_p_partner_contact", AFieldList, new string[] {
                            "p_contact_id_i"}) + " FROM PUB_p_partner_contact, PUB_s_module WHERE p_partner_contact.s_module_id_c =" +
        ...
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(("SELECT COUNT(*) FROM PUB_p_partner_contact, PUB_s_module WHERE p_partner_contact." +
                        "s_module_id_c = s_module.s_module_id_c" + GenerateWhereClauseLong("PUB_s_module", SModuleTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, SModuleTable.GetPrimKeyColumnOrdList())));
        }
        ...
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_p_partner_contact", AFieldList, new string[] {
                            "p_contact_id_i"}) + " FROM PUB_p_partner_contact, PUB_s_user WHERE p_partner_contact.s_user_id_c = s_u" +
                    "ser.s_user_id_c") 
                            + GenerateWhereClauseLong("PUB_s_user", SUserTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)) 
                            + GenerateOrderByClause(AOrderBy)), PPartnerContactTable.GetTableName(), ATransaction, GetParametersForWhereClause(ATemplateRow), AStartRecord, AMaxRecords);
        }
        ...
        public static int CountViaSUserTemplate(SUserRow ATemplateRow, StringCollection ATemplateOperators, TDBTransaction ATransaction)
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(("SELECT COUNT(*) FROM PUB_p_partner_contact, PUB_s_user WHERE p_partner_contact.s_" +
        ...
        public static void LoadViaPContactAttributeDetail(DataSet ADataSet, String AContactAttributeCode, String AContactAttrDetailCode, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ParametersArray[1].Value = ((object)(AContactAttrDetailCode));
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClauseLong("PUB_p_partner_contact", AFieldList, new string[] {
                            "p_contact_id_i"}) + @" FROM PUB_p_partner_contact, PUB_p_partner_contact_attribute WHERE PUB_p_partner_contact_attribute.p_contact_id_i = PUB_p_partner_contact.p_contact_id_i AND PUB_p_partner_contact_attribute.p_contact_attribute_code_c = ? AND PUB_p_partner_contact_attribute.p_contact_attr_detail_code_c = ?") 
                            + GenerateOrderByClause(AOrderBy)), PPartnerContactTable.GetTableName(), ATransaction, ParametersArray, AStartRecord, AMaxRecords);
        }
        ...
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_p_partner_contact", AFieldList, new string[] {
                            "p_contact_id_i"}) + @" FROM PUB_p_partner_contact, PUB_p_partner_contact_attribute, PUB_p_contact_attribute_detail WHERE PUB_p_partner_contact_attribute.p_contact_id_i = PUB_p_partner_contact.p_contact_id_i AND PUB_p_partner_contact_attribute.p_contact_attribute_code_c = PUB_p_contact_attribute_detail.p_contact_attribute_code_c AND PUB_p_partner_contact_attribute.p_contact_attr_detail_code_c = PUB_p_contact_attribute_detail.p_contact_attr_detail_code_c") 
        ...
        public static int CountViaPContactAttributeDetail(String AContactAttributeCode, String AContactAttrDetailCode, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[1] = new OdbcParameter("", OdbcType.VarChar, 32);
            ParametersArray[1].Value = ((object)(AContactAttrDetailCode));
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(@"SELECT COUNT(*) FROM PUB_p_partner_contact, PUB_p_partner_contact_attribute WHERE PUB_p_partner_contact_attribute.p_contact_id_i = PUB_p_partner_contact.p_contact_id_i AND PUB_p_partner_contact_attribute.p_contact_attribute_code_c = ? AND PUB_p_partner_contact_attribute.p_contact_attr_detail_code_c = ?", ATransaction, false, ParametersArray));
        }
        ...
        public static void LoadViaPPartnerPPartnerReminder(DataSet ADataSet, Int64 APartnerKey, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ParametersArray[0].Value = ((object)(APartnerKey));
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClauseLong("PUB_p_partner_contact", AFieldList, new string[] {
                            "p_contact_id_i"}) + " FROM PUB_p_partner_contact, PUB_p_partner_reminder WHERE PUB_p_partner_reminder." +
                    "p_contact_id_i = PUB_p_partner_contact.p_contact_id_i AND PUB_p_partner_reminder" +
                    ".p_partner_key_n = ?") 
                            + GenerateOrderByClause(AOrderBy)), PPartnerContactTable.GetTableName(), ATransaction, ParametersArray, AStartRecord, AMaxRecords);
        }
        ...
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_p_partner_contact", AFieldList, new string[] {
                            "p_contact_id_i"}) + " FROM PUB_p_partner_contact, PUB_p_partner_reminder, PUB_p_partner WHERE PUB_p_pa" +
                    "rtner_reminder.p_contact_id_i = PUB_p_partner_contact.p_contact_id_i AND PUB_p_p" +
                    "artner_reminder.p_partner_key_n = PUB_p_partner.p_partner_key_n") 
                            + GenerateWhereClauseLong("PUB_p_partner", PPartnerTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)) 
                            + GenerateOrderByClause(AOrderBy)), PPartnerContactTable.GetTableName(), ATransaction, GetParametersForWhereClause(ATemplateRow), AStartRecord, AMaxRecords);
        }
        ...
        public static int CountViaPPartnerPPartnerReminder(Int64 APartnerKey, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[0] = new OdbcParameter("", OdbcType.Decimal, 10);
            ParametersArray[0].Value = ((object)(APartnerKey));
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar("SELECT COUNT(*) FROM PUB_p_partner_contact, PUB_p_partner_reminder WHERE PUB_p_pa" +
                        "rtner_reminder.p_contact_id_i = PUB_p_partner_contact.p_contact_id_i AND PUB_p_p" +
                        "artner_reminder.p_partner_key_n = ?", ATransaction, false, ParametersArray));
        }
        ...
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(("SELECT COUNT(*) FROM PUB_p_partner_contact, PUB_p_partner_reminder, PUB_p_partner" +
                        " WHERE PUB_p_partner_reminder.p_contact_id_i = PUB_p_partner_contact.p_contact_i" +
                        "d_i AND PUB_p_partner_reminder.p_partner_key_n = PUB_p_partner.p_partner_key_n" + GenerateWhereClauseLong("PUB_p_partner", PPartnerTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, PPartnerTable.GetPrimKeyColumnOrdList())));
        }
        ...
        public static void LoadViaSGroup(DataSet ADataSet, String AGroupId, Int64 AUnitKey, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ParametersArray[1].Value = ((object)(AUnitKey));
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClauseLong("PUB_p_partner_contact", AFieldList, new string[] {
                            "p_contact_id_i"}) + " FROM PUB_p_partner_contact, PUB_s_group_partner_contact WHERE PUB_s_group_partne" +
                    "r_contact.p_contact_id_i = PUB_p_partner_contact.p_contact_id_i AND PUB_s_group_" +
                    "partner_contact.s_group_id_c = ? AND PUB_s_group_partner_contact.s_group_unit_ke" +
                    "y_n = ?") 
                            + GenerateOrderByClause(AOrderBy)), PPartnerContactTable.GetTableName(), ATransaction, ParametersArray, AStartRecord, AMaxRecords);
        }
        ...
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_p_partner_contact", AFieldList, new string[] {
                            "p_contact_id_i"}) + @" FROM PUB_p_partner_contact, PUB_s_group_partner_contact, PUB_s_group WHERE PUB_s_group_partner_contact.p_contact_id_i = PUB_p_partner_contact.p_contact_id_i AND PUB_s_group_partner_contact.s_group_id_c = PUB_s_group.s_group_id_c AND PUB_s_group_partner_contact.s_group_unit_key_n = PUB_s_group.s_unit_key_n") 
                            + GenerateWhereClauseLong("PUB_s_group", SGroupTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)) 
                            + GenerateOrderByClause(AOrderBy)), PPartnerContactTable.GetTableName(), ATransaction, GetParametersForWhereClause(ATemplateRow), AStartRecord, AMaxRecords);
        }
        ...
        public static int CountViaSGroup(String AGroupId, Int64 AUnitKey, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[1] = new OdbcParameter("", OdbcType.Decimal, 10);
            ParametersArray[1].Value = ((object)(AUnitKey));
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(@"SELECT COUNT(*) FROM PUB_p_partner_contact, PUB_s_group_partner_contact WHERE PUB_s_group_partner_contact.p_contact_id_i = PUB_p_partner_contact.p_contact_id_i AND PUB_s_group_partner_contact.s_group_id_c = ? AND PUB_s_group_partner_contact.s_group_unit_key_n = ?", ATransaction, false, ParametersArray));
        }
        
        /// auto generated
        public static int CountViaSGroupTemplate(SGroupRow ATemplateRow, StringCollection ATemplateOperators, TDBTransaction ATransaction)
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar((@"SELECT COUNT(*) FROM PUB_p_partner_contact, PUB_s_group_partner_contact, PUB_s_group WHERE PUB_s_group_partner_contact.p_contact_id_i = PUB_p_partner_contact.p_contact_id_i AND PUB_s_group_partner_contact.s_group_id_c = PUB_s_group.s_group_id_c AND PUB_s_group_partner_contact.s_group_unit_key_n = PUB_s_group.s_unit_key_n" + GenerateWhereClauseLong("PUB_s_group", SGroupTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, SGroupTable.GetPrimKeyColumnOrdList())));
        }
    ...
    public class PPartnerContactAttributeAccess : TTypedDataAccess
    {
        ...
        public static void LoadAll(DataSet ADataSet, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            "p_contact_id_i",
                            "p_contact_attribute_code_c",
                            "p_contact_attr_detail_code_c"}) + " FROM PUB_p_partner_contact_attribute") 
        ...
        public static void LoadByPrimaryKey(DataSet ADataSet, Int32 AContactId, String AContactAttributeCode, String AContactAttrDetailCode, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            "p_contact_id_i",
                            "p_contact_attribute_code_c",
                            "p_contact_attr_detail_code_c"}) + " FROM PUB_p_partner_contact_attribute WHERE p_contact_id_i = ? AND p_contact_attr" +
                    "ibute_code_c = ? AND p_contact_attr_detail_code_c = ?") 
        ...
        public static int CountByPrimaryKey(Int32 AContactId, String AContactAttributeCode, String AContactAttrDetailCode, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[2] = new OdbcParameter("", OdbcType.VarChar, 32);
            ParametersArray[2].Value = ((object)(AContactAttrDetailCode));
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar("SELECT COUNT(*) FROM PUB_p_partner_contact_attribute WHERE p_contact_id_i = ? AND" +
                        " p_contact_attribute_code_c = ? AND p_contact_attr_detail_code_c = ?", ATransaction, false, ParametersArray));
        }
        ...
        public static void LoadViaPContactAttributeDetail(DataSet ADataSet, String AContactAttributeCode, String AContactAttrDetailCode, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            "p_contact_id_i",
                            "p_contact_attribute_code_c",
                            "p_contact_attr_detail_code_c"}) + " FROM PUB_p_partner_contact_attribute WHERE p_contact_attribute_code_c = ? AND p_" +
                    "contact_attr_detail_code_c = ?") 
                            + GenerateOrderByClause(AOrderBy)), PPartnerContactAttributeTable.GetTableName(), ATransaction, ParametersArray, AStartRecord, AMaxRecords);
        }
        ...
        public static void LoadViaPContactAttributeDetailTemplate(DataSet ADataSet, PContactAttributeDetailRow ATemplateRow, StringCollection ATemplateOperators, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_p_partner_contact_attribute", AFieldList, new string[] {
                            "p_contact_id_i",
                            "p_contact_attribute_code_c",
                            "p_contact_attr_detail_code_c"}) + @" FROM PUB_p_partner_contact_attribute, PUB_p_contact_attribute_detail WHERE p_partner_contact_attribute.p_contact_attribute_code_c = p_contact_attribute_detail.p_contact_attribute_code_c AND p_partner_contact_attribute.p_contact_attr_detail_code_c = p_contact_attribute_detail.p_contact_attr_detail_code_c") 
                            + GenerateWhereClauseLong("PUB_p_contact_attribute_detail", PContactAttributeDetailTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)) 
                            + GenerateOrderByClause(AOrderBy)), PPartnerContactAttributeTable.GetTableName(), ATransaction, GetParametersForWhereClause(ATemplateRow), AStartRecord, AMaxRecords);
        }
        ...
        public static int CountViaPContactAttributeDetail(String AContactAttributeCode, String AContactAttrDetailCode, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[1] = new OdbcParameter("", OdbcType.VarChar, 32);
            ParametersArray[1].Value = ((object)(AContactAttrDetailCode));
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar("SELECT COUNT(*) FROM PUB_p_partner_contact_attribute WHERE p_contact_attribute_co" +
                        "de_c = ? AND p_contact_attr_detail_code_c = ?", ATransaction, false, ParametersArray));
        }
        
        /// auto generated
        public static int CountViaPContactAttributeDetailTemplate(PContactAttributeDetailRow ATemplateRow, StringCollection ATemplateOperators, TDBTransaction ATransaction)
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar((@"SELECT COUNT(*) FROM PUB_p_partner_contact_attribute, PUB_p_contact_attribute_detail WHERE p_partner_contact_attribute.p_contact_attribute_code_c = p_contact_attribute_detail.p_contact_attribute_code_c AND p_partner_contact_attribute.p_contact_attr_detail_code_c = p_contact_attribute_detail.p_contact_attr_detail_code_c" + GenerateWhereClauseLong("PUB_p_contact_attribute_detail", PContactAttributeDetailTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, PContactAttributeDetailTable.GetPrimKeyColumnOrdList())));
        }
        ...
        public static void LoadViaPPartnerContact(DataSet ADataSet, Int32 AContactId, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            "p_contact_id_i",
                            "p_contact_attribute_code_c",
                            "p_contact_attr_detail_code_c"}) + " FROM PUB_p_partner_contact_attribute WHERE p_contact_id_i = ?") 
                            + GenerateOrderByClause(AOrderBy)), PPartnerContactAttributeTable.GetTableName(), ATransaction, ParametersArray, AStartRecord, AMaxRecords);
        }
        ...
        public static void LoadViaPPartnerContactTemplate(DataSet ADataSet, PPartnerContactRow ATemplateRow, StringCollection ATemplateOperators, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_p_partner_contact_attribute", AFieldList, new string[] {
                            "p_contact_id_i",
                            "p_contact_attribute_code_c",
                            "p_contact_attr_detail_code_c"}) + " FROM PUB_p_partner_contact_attribute, PUB_p_partner_contact WHERE p_partner_cont" +
                    "act_attribute.p_contact_id_i = p_partner_contact.p_contact_id_i") 
                            + GenerateWhereClauseLong("PUB_p_partner_contact", PPartnerContactTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)) 
                            + GenerateOrderByClause(AOrderBy)), PPartnerContactAttributeTable.GetTableName(), ATransaction, GetParametersForWhereClause(ATemplateRow), AStartRecord, AMaxRecords);
        }
        ...
        public static int CountViaPPartnerContactTemplate(PPartnerContactRow ATemplateRow, StringCollection ATemplateOperators, TDBTransaction ATransaction)
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(("SELECT COUNT(*) FROM PUB_p_partner_contact_attribute, PUB_p_partner_contact WHERE" +
                        " p_partner_contact_attribute.p_contact_id_i = p_partner_contact.p_contact_id_i" + GenerateWhereClauseLong("PUB_p_partner_contact", PPartnerContactTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, PPartnerContactTable.GetPrimKeyColumnOrdList())));
        }
        ...
        public static void DeleteByPrimaryKey(Int32 AContactId, String AContactAttributeCode, String AContactAttrDetailCode, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[2] = new OdbcParameter("", OdbcType.VarChar, 32);
            ParametersArray[2].Value = ((object)(AContactAttrDetailCode));
            DBAccess.GDBAccessObj.ExecuteNonQuery("DELETE FROM PUB_p_partner_contact_attribute WHERE p_contact_id_i = ? AND p_contac" +
                    "t_attribute_code_c = ? AND p_contact_attr_detail_code_c = ?", ATransaction, false, ParametersArray);
        }
