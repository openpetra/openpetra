...
namespace Ict.Petra.Shared.MPersonnel.Units.Data.Access
{
    ...
    public class PtPositionAccess : TTypedDataAccess
    {
        ...
        public static void LoadAll(DataSet ADataSet, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            "pt_position_name_c",
                            "pt_position_scope_c"}) + " FROM PUB_pt_position") 
        ...
        public static void LoadByPrimaryKey(DataSet ADataSet, String APositionName, String APositionScope, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            "pt_position_name_c",
                            "pt_position_scope_c"}) + " FROM PUB_pt_position WHERE pt_position_name_c = ? AND pt_position_scope_c = ?") 
        ...
        public static int CountByPrimaryKey(String APositionName, String APositionScope, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[1] = new OdbcParameter("", OdbcType.VarChar, 24);
            ParametersArray[1].Value = ((object)(APositionScope));
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar("SELECT COUNT(*) FROM PUB_pt_position WHERE pt_position_name_c = ? AND pt_position" +
                        "_scope_c = ?", ATransaction, false, ParametersArray));
        }
        ...
        public static void LoadViaUUnitType(DataSet ADataSet, String AUnitTypeCode, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            "pt_position_name_c",
                            "pt_position_scope_c"}) + " FROM PUB_pt_position WHERE pt_position_scope_c = ?") 
                            + GenerateOrderByClause(AOrderBy)), PtPositionTable.GetTableName(), ATransaction, ParametersArray, AStartRecord, AMaxRecords);
        }
        ...
        public static void LoadViaUUnitTypeTemplate(DataSet ADataSet, UUnitTypeRow ATemplateRow, StringCollection ATemplateOperators, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_pt_position", AFieldList, new string[] {
                            "pt_position_name_c",
                            "pt_position_scope_c"}) + " FROM PUB_pt_position, PUB_u_unit_type WHERE pt_position.pt_position_scope_c = u_" +
                    "unit_type.u_unit_type_code_c") 
        ...
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(("SELECT COUNT(*) FROM PUB_pt_position, PUB_u_unit_type WHERE pt_position.pt_positi" +
                        "on_scope_c = u_unit_type.u_unit_type_code_c" + GenerateWhereClauseLong("PUB_u_unit_type", UUnitTypeTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, UUnitTypeTable.GetPrimKeyColumnOrdList())));
        }
        ...
        public static void LoadViaPUnit(DataSet ADataSet, Int64 APartnerKey, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClauseLong("PUB_pt_position", AFieldList, new string[] {
                            "pt_position_name_c",
                            "pt_position_scope_c"}) + " FROM PUB_pt_position, PUB_um_job WHERE PUB_um_job.pt_position_name_c = PUB_pt_po" +
                    "sition.pt_position_name_c AND PUB_um_job.pt_position_scope_c = PUB_pt_position.p" +
                    "t_position_scope_c AND PUB_um_job.pm_unit_key_n = ?") 
                            + GenerateOrderByClause(AOrderBy)), PtPositionTable.GetTableName(), ATransaction, ParametersArray, AStartRecord, AMaxRecords);
        }
        ...
        public static void LoadViaPUnitTemplate(DataSet ADataSet, PUnitRow ATemplateRow, StringCollection ATemplateOperators, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_pt_position", AFieldList, new string[] {
                            "pt_position_name_c",
                            "pt_position_scope_c"}) + " FROM PUB_pt_position, PUB_um_job, PUB_p_unit WHERE PUB_um_job.pt_position_name_c" +
                    " = PUB_pt_position.pt_position_name_c AND PUB_um_job.pt_position_scope_c = PUB_p" +
                    "t_position.pt_position_scope_c AND PUB_um_job.pm_unit_key_n = PUB_p_unit.p_partn" +
                    "er_key_n") 
        ...
        public static int CountViaPUnit(Int64 APartnerKey, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[0] = new OdbcParameter("", OdbcType.Decimal, 10);
            ParametersArray[0].Value = ((object)(APartnerKey));
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar("SELECT COUNT(*) FROM PUB_pt_position, PUB_um_job WHERE PUB_um_job.pt_position_nam" +
                        "e_c = PUB_pt_position.pt_position_name_c AND PUB_um_job.pt_position_scope_c = PU" +
                        "B_pt_position.pt_position_scope_c AND PUB_um_job.pm_unit_key_n = ?", ATransaction, false, ParametersArray));
        }
        ...
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar((@"SELECT COUNT(*) FROM PUB_pt_position, PUB_um_job, PUB_p_unit WHERE PUB_um_job.pt_position_name_c = PUB_pt_position.pt_position_name_c AND PUB_um_job.pt_position_scope_c = PUB_pt_position.pt_position_scope_c AND PUB_um_job.pm_unit_key_n = PUB_p_unit.p_partner_key_n" + GenerateWhereClauseLong("PUB_p_unit", PUnitTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, PUnitTable.GetPrimKeyColumnOrdList())));
        }
        ...
        public static void DeleteByPrimaryKey(String APositionName, String APositionScope, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[1] = new OdbcParameter("", OdbcType.VarChar, 24);
            ParametersArray[1].Value = ((object)(APositionScope));
            DBAccess.GDBAccessObj.ExecuteNonQuery("DELETE FROM PUB_pt_position WHERE pt_position_name_c = ? AND pt_position_scope_c " +
    ...
    public class UmJobAccess : TTypedDataAccess
    {
        ...
        public static void LoadByPrimaryKey(DataSet ADataSet, Int64 AUnitKey, String APositionName, String APositionScope, Int32 AJobKey, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            ...
                            "pt_position_name_c",
                            "pt_position_scope_c",
                            "um_job_key_i"}) + " FROM PUB_um_job WHERE pm_unit_key_n = ? AND pt_position_name_c = ? AND pt_positi" +
                    "on_scope_c = ? AND um_job_key_i = ?") 
        ...
        public static int CountByPrimaryKey(Int64 AUnitKey, String APositionName, String APositionScope, Int32 AJobKey, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[3] = new OdbcParameter("", OdbcType.Int);
            ParametersArray[3].Value = ((object)(AJobKey));
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar("SELECT COUNT(*) FROM PUB_um_job WHERE pm_unit_key_n = ? AND pt_position_name_c = " +
                        "? AND pt_position_scope_c = ? AND um_job_key_i = ?", ATransaction, false, ParametersArray));
        }
        ...
        public static void LoadViaPUnit(DataSet ADataSet, Int64 APartnerKey, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            ...
                            "pt_position_name_c",
                            "pt_position_scope_c",
                            "um_job_key_i"}) + " FROM PUB_um_job WHERE pm_unit_key_n = ?") 
                            + GenerateOrderByClause(AOrderBy)), UmJobTable.GetTableName(), ATransaction, ParametersArray, AStartRecord, AMaxRecords);
        }
        ...
        public static void LoadViaPUnitTemplate(DataSet ADataSet, PUnitRow ATemplateRow, StringCollection ATemplateOperators, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_um_job", AFieldList, new string[] {
                            ...
                            "pt_position_name_c",
                            "pt_position_scope_c",
                            "um_job_key_i"}) + " FROM PUB_um_job, PUB_p_unit WHERE um_job.pm_unit_key_n = p_unit.p_partner_key_n") 
                            + GenerateWhereClauseLong("PUB_p_unit", PUnitTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)) 
                            + GenerateOrderByClause(AOrderBy)), UmJobTable.GetTableName(), ATransaction, GetParametersForWhereClause(ATemplateRow), AStartRecord, AMaxRecords);
        }
        ...
        public static int CountViaPUnitTemplate(PUnitRow ATemplateRow, StringCollection ATemplateOperators, TDBTransaction ATransaction)
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(("SELECT COUNT(*) FROM PUB_um_job, PUB_p_unit WHERE um_job.pm_unit_key_n = p_unit.p" +
                        "_partner_key_n" + GenerateWhereClauseLong("PUB_p_unit", PUnitTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, PUnitTable.GetPrimKeyColumnOrdList())));
        }
        ...
        public static void LoadViaPtPosition(DataSet ADataSet, String APositionName, String APositionScope, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            ...
                            "pt_position_name_c",
                            "pt_position_scope_c",
                            "um_job_key_i"}) + " FROM PUB_um_job WHERE pt_position_name_c = ? AND pt_position_scope_c = ?") 
                            + GenerateOrderByClause(AOrderBy)), UmJobTable.GetTableName(), ATransaction, ParametersArray, AStartRecord, AMaxRecords);
        }
        ...
        public static void LoadViaPtPositionTemplate(DataSet ADataSet, PtPositionRow ATemplateRow, StringCollection ATemplateOperators, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_um_job", AFieldList, new string[] {
                            ...
                            "pt_position_name_c",
                            "pt_position_scope_c",
                            "um_job_key_i"}) + " FROM PUB_um_job, PUB_pt_position WHERE um_job.pt_position_name_c = pt_position.p" +
                    "t_position_name_c AND um_job.pt_position_scope_c = pt_position.pt_position_scope" +
                    "_c") 
        ...
        public static int CountViaPtPosition(String APositionName, String APositionScope, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[1] = new OdbcParameter("", OdbcType.VarChar, 24);
            ParametersArray[1].Value = ((object)(APositionScope));
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar("SELECT COUNT(*) FROM PUB_um_job WHERE pt_position_name_c = ? AND pt_position_scop" +
        ...
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(("SELECT COUNT(*) FROM PUB_um_job, PUB_pt_position WHERE um_job.pt_position_name_c " +
                        "= pt_position.pt_position_name_c AND um_job.pt_position_scope_c = pt_position.pt" +
                        "_position_scope_c" + GenerateWhereClauseLong("PUB_pt_position", PtPositionTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, PtPositionTable.GetPrimKeyColumnOrdList())));
        }
        ...
        public static void LoadViaPtAbilityAreaTemplate(DataSet ADataSet, PtAbilityAreaRow ATemplateRow, StringCollection ATemplateOperators, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_um_job", AFieldList, new string[] {
                            ...
                            "pt_position_name_c",
                            "pt_position_scope_c",
                            "um_job_key_i"}) + @" FROM PUB_um_job, PUB_um_job_requirement, PUB_pt_ability_area WHERE PUB_um_job_requirement.pm_unit_key_n = PUB_um_job.pm_unit_key_n AND PUB_um_job_requirement.pt_position_name_c = PUB_um_job.pt_position_name_c AND PUB_um_job_requirement.pt_position_scope_c = PUB_um_job.pt_position_scope_c AND PUB_um_job_requirement.um_job_key_i = PUB_um_job.um_job_key_i AND PUB_um_job_requirement.pt_ability_area_name_c = PUB_pt_ability_area.pt_ability_area_name_c") 
        ...
        public static int CountViaPtAbilityArea(String AAbilityAreaName, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[0] = new OdbcParameter("", OdbcType.VarChar, 32);
            ParametersArray[0].Value = ((object)(AAbilityAreaName));
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(@"SELECT COUNT(*) FROM PUB_um_job, PUB_um_job_requirement WHERE PUB_um_job_requirement.pm_unit_key_n = PUB_um_job.pm_unit_key_n AND PUB_um_job_requirement.pt_position_name_c = PUB_um_job.pt_position_name_c AND PUB_um_job_requirement.pt_position_scope_c = PUB_um_job.pt_position_scope_c AND PUB_um_job_requirement.um_job_key_i = PUB_um_job.um_job_key_i AND PUB_um_job_requirement.pt_ability_area_name_c = ?", ATransaction, false, ParametersArray));
        }
        ...
        public static void LoadViaPLanguageTemplate(DataSet ADataSet, PLanguageRow ATemplateRow, StringCollection ATemplateOperators, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_um_job", AFieldList, new string[] {
                            ...
                            "pt_position_name_c",
                            "pt_position_scope_c",
                            "um_job_key_i"}) + @" FROM PUB_um_job, PUB_um_job_language, PUB_p_language WHERE PUB_um_job_language.pm_unit_key_n = PUB_um_job.pm_unit_key_n AND PUB_um_job_language.pt_position_name_c = PUB_um_job.pt_position_name_c AND PUB_um_job_language.pt_position_scope_c = PUB_um_job.pt_position_scope_c AND PUB_um_job_language.um_job_key_i = PUB_um_job.um_job_key_i AND PUB_um_job_language.p_language_code_c = PUB_p_language.p_language_code_c") 
        ...
        public static int CountViaPLanguage(String ALanguageCode, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[0] = new OdbcParameter("", OdbcType.VarChar, 20);
            ParametersArray[0].Value = ((object)(ALanguageCode));
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(@"SELECT COUNT(*) FROM PUB_um_job, PUB_um_job_language WHERE PUB_um_job_language.pm_unit_key_n = PUB_um_job.pm_unit_key_n AND PUB_um_job_language.pt_position_name_c = PUB_um_job.pt_position_name_c AND PUB_um_job_language.pt_position_scope_c = PUB_um_job.pt_position_scope_c AND PUB_um_job_language.um_job_key_i = PUB_um_job.um_job_key_i AND PUB_um_job_language.p_language_code_c = ?", ATransaction, false, ParametersArray));
        }
        ...
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar((@"SELECT COUNT(*) FROM PUB_um_job, PUB_um_job_language, PUB_p_language WHERE PUB_um_job_language.pm_unit_key_n = PUB_um_job.pm_unit_key_n AND PUB_um_job_language.pt_position_name_c = PUB_um_job.pt_position_name_c AND PUB_um_job_language.pt_position_scope_c = PUB_um_job.pt_position_scope_c AND PUB_um_job_language.um_job_key_i = PUB_um_job.um_job_key_i AND PUB_um_job_language.p_language_code_c = PUB_p_language.p_language_code_c" + GenerateWhereClauseLong("PUB_p_language", PLanguageTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, PLanguageTable.GetPrimKeyColumnOrdList())));
        }
        ...
        public static int CountViaPtQualificationArea(String AQualificationAreaName, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[0] = new OdbcParameter("", OdbcType.VarChar, 32);
            ParametersArray[0].Value = ((object)(AQualificationAreaName));
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(@"SELECT COUNT(*) FROM PUB_um_job, PUB_um_job_qualification WHERE PUB_um_job_qualification.pm_unit_key_n = PUB_um_job.pm_unit_key_n AND PUB_um_job_qualification.pt_position_name_c = PUB_um_job.pt_position_name_c AND PUB_um_job_qualification.pt_position_scope_c = PUB_um_job.pt_position_scope_c AND PUB_um_job_qualification.um_job_key_i = PUB_um_job.um_job_key_i AND PUB_um_job_qualification.pt_qualification_area_name_c = ?", ATransaction, false, ParametersArray));
        }
        ...
        public static int CountViaPtVisionArea(String AVisionAreaName, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[0] = new OdbcParameter("", OdbcType.VarChar, 32);
            ParametersArray[0].Value = ((object)(AVisionAreaName));
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(@"SELECT COUNT(*) FROM PUB_um_job, PUB_um_job_vision WHERE PUB_um_job_vision.pm_unit_key_n = PUB_um_job.pm_unit_key_n AND PUB_um_job_vision.pt_position_name_c = PUB_um_job.pt_position_name_c AND PUB_um_job_vision.pt_position_scope_c = PUB_um_job.pt_position_scope_c AND PUB_um_job_vision.um_job_key_i = PUB_um_job.um_job_key_i AND PUB_um_job_vision.pt_vision_area_name_c = ?", ATransaction, false, ParametersArray));
        }
        ...
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar((@"SELECT COUNT(*) FROM PUB_um_job, PUB_um_job_vision, PUB_pt_vision_area WHERE PUB_um_job_vision.pm_unit_key_n = PUB_um_job.pm_unit_key_n AND PUB_um_job_vision.pt_position_name_c = PUB_um_job.pt_position_name_c AND PUB_um_job_vision.pt_position_scope_c = PUB_um_job.pt_position_scope_c AND PUB_um_job_vision.um_job_key_i = PUB_um_job.um_job_key_i AND PUB_um_job_vision.pt_vision_area_name_c = PUB_pt_vision_area.pt_vision_area_name_c" + GenerateWhereClauseLong("PUB_pt_vision_area", PtVisionAreaTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, PtVisionAreaTable.GetPrimKeyColumnOrdList())));
        }
        ...
        public static int CountViaPPartner(Int64 APartnerKey, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[0] = new OdbcParameter("", OdbcType.Decimal, 10);
            ParametersArray[0].Value = ((object)(APartnerKey));
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(@"SELECT COUNT(*) FROM PUB_um_job, PUB_pm_job_assignment WHERE PUB_pm_job_assignment.pm_unit_key_n = PUB_um_job.pm_unit_key_n AND PUB_pm_job_assignment.pt_position_name_c = PUB_um_job.pt_position_name_c AND PUB_pm_job_assignment.pt_position_scope_c = PUB_um_job.pt_position_scope_c AND PUB_pm_job_assignment.um_job_key_i = PUB_um_job.um_job_key_i AND PUB_pm_job_assignment.p_partner_key_n = ?", ATransaction, false, ParametersArray));
        }
        ...
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar((@"SELECT COUNT(*) FROM PUB_um_job, PUB_pm_job_assignment, PUB_p_partner WHERE PUB_pm_job_assignment.pm_unit_key_n = PUB_um_job.pm_unit_key_n AND PUB_pm_job_assignment.pt_position_name_c = PUB_um_job.pt_position_name_c AND PUB_pm_job_assignment.pt_position_scope_c = PUB_um_job.pt_position_scope_c AND PUB_pm_job_assignment.um_job_key_i = PUB_um_job.um_job_key_i AND PUB_pm_job_assignment.p_partner_key_n = PUB_p_partner.p_partner_key_n" + GenerateWhereClauseLong("PUB_p_partner", PPartnerTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, PPartnerTable.GetPrimKeyColumnOrdList())));
        }
        ...
        public static void LoadViaSGroup(DataSet ADataSet, String AGroupId, Int64 AUnitKey, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClauseLong("PUB_um_job", AFieldList, new string[] {
                            ...
                            "pt_position_name_c",
                            "pt_position_scope_c",
                            "um_job_key_i"}) + @" FROM PUB_um_job, PUB_s_job_group WHERE PUB_s_job_group.s_unit_key_n = PUB_um_job.pm_unit_key_n AND PUB_s_job_group.pt_position_name_c = PUB_um_job.pt_position_name_c AND PUB_s_job_group.pt_position_scope_c = PUB_um_job.pt_position_scope_c AND PUB_s_job_group.um_job_key_i = PUB_um_job.um_job_key_i AND PUB_s_job_group.s_group_id_c = ? AND PUB_s_job_group.s_unit_key_n = ?") 
                            + GenerateOrderByClause(AOrderBy)), UmJobTable.GetTableName(), ATransaction, ParametersArray, AStartRecord, AMaxRecords);
        }
        ...
        public static void LoadViaSGroupTemplate(DataSet ADataSet, SGroupRow ATemplateRow, StringCollection ATemplateOperators, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_um_job", AFieldList, new string[] {
                            ...
                            "pt_position_name_c",
                            "pt_position_scope_c",
                            "um_job_key_i"}) + @" FROM PUB_um_job, PUB_s_job_group, PUB_s_group WHERE PUB_s_job_group.s_unit_key_n = PUB_um_job.pm_unit_key_n AND PUB_s_job_group.pt_position_name_c = PUB_um_job.pt_position_name_c AND PUB_s_job_group.pt_position_scope_c = PUB_um_job.pt_position_scope_c AND PUB_s_job_group.um_job_key_i = PUB_um_job.um_job_key_i AND PUB_s_job_group.s_group_id_c = PUB_s_group.s_group_id_c AND PUB_s_job_group.s_unit_key_n = PUB_s_group.s_unit_key_n") 
        ...
        public static int CountViaSGroup(String AGroupId, Int64 AUnitKey, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[1] = new OdbcParameter("", OdbcType.Decimal, 10);
            ParametersArray[1].Value = ((object)(AUnitKey));
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(@"SELECT COUNT(*) FROM PUB_um_job, PUB_s_job_group WHERE PUB_s_job_group.s_unit_key_n = PUB_um_job.pm_unit_key_n AND PUB_s_job_group.pt_position_name_c = PUB_um_job.pt_position_name_c AND PUB_s_job_group.pt_position_scope_c = PUB_um_job.pt_position_scope_c AND PUB_s_job_group.um_job_key_i = PUB_um_job.um_job_key_i AND PUB_s_job_group.s_group_id_c = ? AND PUB_s_job_group.s_unit_key_n = ?", ATransaction, false, ParametersArray));
        }
        ...
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar((@"SELECT COUNT(*) FROM PUB_um_job, PUB_s_job_group, PUB_s_group WHERE PUB_s_job_group.s_unit_key_n = PUB_um_job.pm_unit_key_n AND PUB_s_job_group.pt_position_name_c = PUB_um_job.pt_position_name_c AND PUB_s_job_group.pt_position_scope_c = PUB_um_job.pt_position_scope_c AND PUB_s_job_group.um_job_key_i = PUB_um_job.um_job_key_i AND PUB_s_job_group.s_group_id_c = PUB_s_group.s_group_id_c AND PUB_s_job_group.s_unit_key_n = PUB_s_group.s_unit_key_n" + GenerateWhereClauseLong("PUB_s_group", SGroupTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, SGroupTable.GetPrimKeyColumnOrdList())));
        }
        ...
        public static void DeleteByPrimaryKey(Int64 AUnitKey, String APositionName, String APositionScope, Int32 AJobKey, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[3] = new OdbcParameter("", OdbcType.Int);
            ParametersArray[3].Value = ((object)(AJobKey));
            DBAccess.GDBAccessObj.ExecuteNonQuery("DELETE FROM PUB_um_job WHERE pm_unit_key_n = ? AND pt_position_name_c = ? AND pt_" +
                    "position_scope_c = ? AND um_job_key_i = ?", ATransaction, false, ParametersArray);
        }
    ...
    public class UmJobRequirementAccess : TTypedDataAccess
    {
        ...
        public static void LoadAll(DataSet ADataSet, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            ...
                            "pt_position_scope_c",
                            "um_job_key_i",
                            "pt_ability_area_name_c"}) + " FROM PUB_um_job_requirement") 
        ...
        public static void LoadByPrimaryKey(DataSet ADataSet, Int64 AUnitKey, String APositionName, String APositionScope, Int32 AJobKey, String AAbilityAreaName, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            ...
                            "pt_position_scope_c",
                            "um_job_key_i",
                            "pt_ability_area_name_c"}) + " FROM PUB_um_job_requirement WHERE pm_unit_key_n = ? AND pt_position_name_c = ? A" +
                    "ND pt_position_scope_c = ? AND um_job_key_i = ? AND pt_ability_area_name_c = ?") 
        ...
        public static int CountByPrimaryKey(Int64 AUnitKey, String APositionName, String APositionScope, Int32 AJobKey, String AAbilityAreaName, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[4] = new OdbcParameter("", OdbcType.VarChar, 32);
            ParametersArray[4].Value = ((object)(AAbilityAreaName));
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar("SELECT COUNT(*) FROM PUB_um_job_requirement WHERE pm_unit_key_n = ? AND pt_positi" +
                        "on_name_c = ? AND pt_position_scope_c = ? AND um_job_key_i = ? AND pt_ability_ar" +
        ...
        public static void LoadViaUmJob(DataSet ADataSet, Int64 AUnitKey, String APositionName, String APositionScope, Int32 AJobKey, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            ...
                            "um_job_key_i",
                            "pt_ability_area_name_c"}) + " FROM PUB_um_job_requirement WHERE pm_unit_key_n = ? AND pt_position_name_c = ? A" +
                    "ND pt_position_scope_c = ? AND um_job_key_i = ?") 
                            + GenerateOrderByClause(AOrderBy)), UmJobRequirementTable.GetTableName(), ATransaction, ParametersArray, AStartRecord, AMaxRecords);
        }
        ...
        public static void LoadViaUmJobTemplate(DataSet ADataSet, UmJobRow ATemplateRow, StringCollection ATemplateOperators, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_um_job_requirement", AFieldList, new string[] {
                            ...
                            "pt_position_scope_c",
                            "um_job_key_i",
                            "pt_ability_area_name_c"}) + @" FROM PUB_um_job_requirement, PUB_um_job WHERE um_job_requirement.pm_unit_key_n = um_job.pm_unit_key_n AND um_job_requirement.pt_position_name_c = um_job.pt_position_name_c AND um_job_requirement.pt_position_scope_c = um_job.pt_position_scope_c AND um_job_requirement.um_job_key_i = um_job.um_job_key_i") 
        ...
        public static int CountViaUmJob(Int64 AUnitKey, String APositionName, String APositionScope, Int32 AJobKey, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[3].Value = ((object)(AJobKey));
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar("SELECT COUNT(*) FROM PUB_um_job_requirement WHERE pm_unit_key_n = ? AND pt_positi" +
                        "on_name_c = ? AND pt_position_scope_c = ? AND um_job_key_i = ?", ATransaction, false, ParametersArray));
        }
        ...
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar((@"SELECT COUNT(*) FROM PUB_um_job_requirement, PUB_um_job WHERE um_job_requirement.pm_unit_key_n = um_job.pm_unit_key_n AND um_job_requirement.pt_position_name_c = um_job.pt_position_name_c AND um_job_requirement.pt_position_scope_c = um_job.pt_position_scope_c AND um_job_requirement.um_job_key_i = um_job.um_job_key_i" + GenerateWhereClauseLong("PUB_um_job", UmJobTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, UmJobTable.GetPrimKeyColumnOrdList())));
        }
        ...
        public static void LoadViaPtAbilityArea(DataSet ADataSet, String AAbilityAreaName, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            ...
                            "pt_position_scope_c",
                            "um_job_key_i",
                            "pt_ability_area_name_c"}) + " FROM PUB_um_job_requirement WHERE pt_ability_area_name_c = ?") 
                            + GenerateOrderByClause(AOrderBy)), UmJobRequirementTable.GetTableName(), ATransaction, ParametersArray, AStartRecord, AMaxRecords);
        }
        ...
        public static void LoadViaPtAbilityAreaTemplate(DataSet ADataSet, PtAbilityAreaRow ATemplateRow, StringCollection ATemplateOperators, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_um_job_requirement", AFieldList, new string[] {
                            ...
                            "pt_position_scope_c",
                            "um_job_key_i",
                            "pt_ability_area_name_c"}) + " FROM PUB_um_job_requirement, PUB_pt_ability_area WHERE um_job_requirement.pt_abi" +
                    "lity_area_name_c = pt_ability_area.pt_ability_area_name_c") 
                            + GenerateWhereClauseLong("PUB_pt_ability_area", PtAbilityAreaTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)) 
                            + GenerateOrderByClause(AOrderBy)), UmJobRequirementTable.GetTableName(), ATransaction, GetParametersForWhereClause(ATemplateRow), AStartRecord, AMaxRecords);
        }
        ...
        public static int CountViaPtAbilityAreaTemplate(PtAbilityAreaRow ATemplateRow, StringCollection ATemplateOperators, TDBTransaction ATransaction)
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(("SELECT COUNT(*) FROM PUB_um_job_requirement, PUB_pt_ability_area WHERE um_job_req" +
                        "uirement.pt_ability_area_name_c = pt_ability_area.pt_ability_area_name_c" + GenerateWhereClauseLong("PUB_pt_ability_area", PtAbilityAreaTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, PtAbilityAreaTable.GetPrimKeyColumnOrdList())));
        }
        ...
        public static void LoadViaPtAbilityLevel(DataSet ADataSet, Int32 AAbilityLevel, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            ...
                            "pt_position_scope_c",
                            "um_job_key_i",
                            "pt_ability_area_name_c"}) + " FROM PUB_um_job_requirement WHERE pt_ability_level_i = ?") 
                            + GenerateOrderByClause(AOrderBy)), UmJobRequirementTable.GetTableName(), ATransaction, ParametersArray, AStartRecord, AMaxRecords);
        }
        ...
        public static void LoadViaPtAbilityLevelTemplate(DataSet ADataSet, PtAbilityLevelRow ATemplateRow, StringCollection ATemplateOperators, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_um_job_requirement", AFieldList, new string[] {
                            ...
                            "pt_position_scope_c",
                            "um_job_key_i",
                            "pt_ability_area_name_c"}) + " FROM PUB_um_job_requirement, PUB_pt_ability_level WHERE um_job_requirement.pt_ab" +
                    "ility_level_i = pt_ability_level.pt_ability_level_i") 
        ...
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(("SELECT COUNT(*) FROM PUB_um_job_requirement, PUB_pt_ability_level WHERE um_job_re" +
                        "quirement.pt_ability_level_i = pt_ability_level.pt_ability_level_i" + GenerateWhereClauseLong("PUB_pt_ability_level", PtAbilityLevelTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, PtAbilityLevelTable.GetPrimKeyColumnOrdList())));
        }
        ...
        public static void DeleteByPrimaryKey(Int64 AUnitKey, String APositionName, String APositionScope, Int32 AJobKey, String AAbilityAreaName, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[4] = new OdbcParameter("", OdbcType.VarChar, 32);
            ParametersArray[4].Value = ((object)(AAbilityAreaName));
            DBAccess.GDBAccessObj.ExecuteNonQuery("DELETE FROM PUB_um_job_requirement WHERE pm_unit_key_n = ? AND pt_position_name_c" +
                    " = ? AND pt_position_scope_c = ? AND um_job_key_i = ? AND pt_ability_area_name_c" +
                    " = ?", ATransaction, false, ParametersArray);
        }
    ...
    public class UmJobLanguageAccess : TTypedDataAccess
    {
        ...
        public static void LoadAll(DataSet ADataSet, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            ...
                            "pt_position_scope_c",
                            "um_job_key_i",
                            "p_language_code_c"}) + " FROM PUB_um_job_language") 
        ...
        public static void LoadByPrimaryKey(DataSet ADataSet, Int64 AUnitKey, String APositionName, String APositionScope, Int32 AJobKey, String ALanguageCode, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            ...
                            "pt_position_scope_c",
                            "um_job_key_i",
                            "p_language_code_c"}) + " FROM PUB_um_job_language WHERE pm_unit_key_n = ? AND pt_position_name_c = ? AND " +
                    "pt_position_scope_c = ? AND um_job_key_i = ? AND p_language_code_c = ?") 
        ...
        public static int CountByPrimaryKey(Int64 AUnitKey, String APositionName, String APositionScope, Int32 AJobKey, String ALanguageCode, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[4] = new OdbcParameter("", OdbcType.VarChar, 20);
            ParametersArray[4].Value = ((object)(ALanguageCode));
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar("SELECT COUNT(*) FROM PUB_um_job_language WHERE pm_unit_key_n = ? AND pt_position_" +
                        "name_c = ? AND pt_position_scope_c = ? AND um_job_key_i = ? AND p_language_code_" +
        ...
        public static void LoadViaUmJob(DataSet ADataSet, Int64 AUnitKey, String APositionName, String APositionScope, Int32 AJobKey, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            ...
                            "um_job_key_i",
                            "p_language_code_c"}) + " FROM PUB_um_job_language WHERE pm_unit_key_n = ? AND pt_position_name_c = ? AND " +
                    "pt_position_scope_c = ? AND um_job_key_i = ?") 
                            + GenerateOrderByClause(AOrderBy)), UmJobLanguageTable.GetTableName(), ATransaction, ParametersArray, AStartRecord, AMaxRecords);
        }
        ...
        public static void LoadViaUmJobTemplate(DataSet ADataSet, UmJobRow ATemplateRow, StringCollection ATemplateOperators, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_um_job_language", AFieldList, new string[] {
                            ...
                            "pt_position_scope_c",
                            "um_job_key_i",
                            "p_language_code_c"}) + @" FROM PUB_um_job_language, PUB_um_job WHERE um_job_language.pm_unit_key_n = um_job.pm_unit_key_n AND um_job_language.pt_position_name_c = um_job.pt_position_name_c AND um_job_language.pt_position_scope_c = um_job.pt_position_scope_c AND um_job_language.um_job_key_i = um_job.um_job_key_i") 
                            + GenerateWhereClauseLong("PUB_um_job", UmJobTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)) 
                            + GenerateOrderByClause(AOrderBy)), UmJobLanguageTable.GetTableName(), ATransaction, GetParametersForWhereClause(ATemplateRow), AStartRecord, AMaxRecords);
        }
        ...
        public static int CountViaUmJob(Int64 AUnitKey, String APositionName, String APositionScope, Int32 AJobKey, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[3].Value = ((object)(AJobKey));
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar("SELECT COUNT(*) FROM PUB_um_job_language WHERE pm_unit_key_n = ? AND pt_position_" +
                        "name_c = ? AND pt_position_scope_c = ? AND um_job_key_i = ?", ATransaction, false, ParametersArray));
        }
        
        /// auto generated
        public static int CountViaUmJobTemplate(UmJobRow ATemplateRow, StringCollection ATemplateOperators, TDBTransaction ATransaction)
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar((@"SELECT COUNT(*) FROM PUB_um_job_language, PUB_um_job WHERE um_job_language.pm_unit_key_n = um_job.pm_unit_key_n AND um_job_language.pt_position_name_c = um_job.pt_position_name_c AND um_job_language.pt_position_scope_c = um_job.pt_position_scope_c AND um_job_language.um_job_key_i = um_job.um_job_key_i" + GenerateWhereClauseLong("PUB_um_job", UmJobTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, UmJobTable.GetPrimKeyColumnOrdList())));
        }
        ...
        public static void LoadViaPLanguage(DataSet ADataSet, String ALanguageCode, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            ...
                            "pt_position_scope_c",
                            "um_job_key_i",
                            "p_language_code_c"}) + " FROM PUB_um_job_language WHERE p_language_code_c = ?") 
                            + GenerateOrderByClause(AOrderBy)), UmJobLanguageTable.GetTableName(), ATransaction, ParametersArray, AStartRecord, AMaxRecords);
        }
        ...
        public static void LoadViaPLanguageTemplate(DataSet ADataSet, PLanguageRow ATemplateRow, StringCollection ATemplateOperators, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_um_job_language", AFieldList, new string[] {
                            ...
                            "pt_position_scope_c",
                            "um_job_key_i",
                            "p_language_code_c"}) + " FROM PUB_um_job_language, PUB_p_language WHERE um_job_language.p_language_code_c" +
                    " = p_language.p_language_code_c") 
                            + GenerateWhereClauseLong("PUB_p_language", PLanguageTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)) 
                            + GenerateOrderByClause(AOrderBy)), UmJobLanguageTable.GetTableName(), ATransaction, GetParametersForWhereClause(ATemplateRow), AStartRecord, AMaxRecords);
        }
        ...
        public static int CountViaPLanguageTemplate(PLanguageRow ATemplateRow, StringCollection ATemplateOperators, TDBTransaction ATransaction)
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(("SELECT COUNT(*) FROM PUB_um_job_language, PUB_p_language WHERE um_job_language.p_" +
                        "language_code_c = p_language.p_language_code_c" + GenerateWhereClauseLong("PUB_p_language", PLanguageTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, PLanguageTable.GetPrimKeyColumnOrdList())));
        }
        ...
        public static void LoadViaPtLanguageLevel(DataSet ADataSet, Int32 ALanguageLevel, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            ...
                            "pt_position_scope_c",
                            "um_job_key_i",
                            "p_language_code_c"}) + " FROM PUB_um_job_language WHERE pt_language_level_i = ?") 
                            + GenerateOrderByClause(AOrderBy)), UmJobLanguageTable.GetTableName(), ATransaction, ParametersArray, AStartRecord, AMaxRecords);
        }
        ...
        public static void LoadViaPtLanguageLevelTemplate(DataSet ADataSet, PtLanguageLevelRow ATemplateRow, StringCollection ATemplateOperators, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_um_job_language", AFieldList, new string[] {
                            ...
                            "pt_position_scope_c",
                            "um_job_key_i",
                            "p_language_code_c"}) + " FROM PUB_um_job_language, PUB_pt_language_level WHERE um_job_language.pt_languag" +
                    "e_level_i = pt_language_level.pt_language_level_i") 
        ...
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(("SELECT COUNT(*) FROM PUB_um_job_language, PUB_pt_language_level WHERE um_job_lang" +
                        "uage.pt_language_level_i = pt_language_level.pt_language_level_i" + GenerateWhereClauseLong("PUB_pt_language_level", PtLanguageLevelTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, PtLanguageLevelTable.GetPrimKeyColumnOrdList())));
        }
        ...
        public static void DeleteByPrimaryKey(Int64 AUnitKey, String APositionName, String APositionScope, Int32 AJobKey, String ALanguageCode, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[4] = new OdbcParameter("", OdbcType.VarChar, 20);
            ParametersArray[4].Value = ((object)(ALanguageCode));
            DBAccess.GDBAccessObj.ExecuteNonQuery("DELETE FROM PUB_um_job_language WHERE pm_unit_key_n = ? AND pt_position_name_c = " +
                    "? AND pt_position_scope_c = ? AND um_job_key_i = ? AND p_language_code_c = ?", ATransaction, false, ParametersArray);
        }
    ...
    public class UmJobQualificationAccess : TTypedDataAccess
    {
        ...
        public static void LoadAll(DataSet ADataSet, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            ...
                            "pt_position_scope_c",
                            "um_job_key_i",
                            "pt_qualification_area_name_c"}) + " FROM PUB_um_job_qualification") 
        ...
        public static void LoadByPrimaryKey(DataSet ADataSet, Int64 AUnitKey, String APositionName, String APositionScope, Int32 AJobKey, String AQualificationAreaName, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            ...
                            "pt_position_scope_c",
                            "um_job_key_i",
                            "pt_qualification_area_name_c"}) + " FROM PUB_um_job_qualification WHERE pm_unit_key_n = ? AND pt_position_name_c = ?" +
                    " AND pt_position_scope_c = ? AND um_job_key_i = ? AND pt_qualification_area_name" +
                    "_c = ?") 
        ...
        public static int CountByPrimaryKey(Int64 AUnitKey, String APositionName, String APositionScope, Int32 AJobKey, String AQualificationAreaName, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[4] = new OdbcParameter("", OdbcType.VarChar, 32);
            ParametersArray[4].Value = ((object)(AQualificationAreaName));
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar("SELECT COUNT(*) FROM PUB_um_job_qualification WHERE pm_unit_key_n = ? AND pt_posi" +
                        "tion_name_c = ? AND pt_position_scope_c = ? AND um_job_key_i = ? AND pt_qualific" +
                        "ation_area_name_c = ?", ATransaction, false, ParametersArray));
        }
        ...
        public static void LoadViaUmJob(DataSet ADataSet, Int64 AUnitKey, String APositionName, String APositionScope, Int32 AJobKey, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            ...
                            "um_job_key_i",
                            "pt_qualification_area_name_c"}) + " FROM PUB_um_job_qualification WHERE pm_unit_key_n = ? AND pt_position_name_c = ?" +
                    " AND pt_position_scope_c = ? AND um_job_key_i = ?") 
                            + GenerateOrderByClause(AOrderBy)), UmJobQualificationTable.GetTableName(), ATransaction, ParametersArray, AStartRecord, AMaxRecords);
        }
        ...
        public static void LoadViaUmJobTemplate(DataSet ADataSet, UmJobRow ATemplateRow, StringCollection ATemplateOperators, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_um_job_qualification", AFieldList, new string[] {
                            ...
                            "pt_position_scope_c",
                            "um_job_key_i",
                            "pt_qualification_area_name_c"}) + @" FROM PUB_um_job_qualification, PUB_um_job WHERE um_job_qualification.pm_unit_key_n = um_job.pm_unit_key_n AND um_job_qualification.pt_position_name_c = um_job.pt_position_name_c AND um_job_qualification.pt_position_scope_c = um_job.pt_position_scope_c AND um_job_qualification.um_job_key_i = um_job.um_job_key_i") 
                            + GenerateWhereClauseLong("PUB_um_job", UmJobTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)) 
                            + GenerateOrderByClause(AOrderBy)), UmJobQualificationTable.GetTableName(), ATransaction, GetParametersForWhereClause(ATemplateRow), AStartRecord, AMaxRecords);
        }
        ...
        public static int CountViaUmJob(Int64 AUnitKey, String APositionName, String APositionScope, Int32 AJobKey, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[3].Value = ((object)(AJobKey));
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar("SELECT COUNT(*) FROM PUB_um_job_qualification WHERE pm_unit_key_n = ? AND pt_posi" +
                        "tion_name_c = ? AND pt_position_scope_c = ? AND um_job_key_i = ?", ATransaction, false, ParametersArray));
        }
        
        /// auto generated
        public static int CountViaUmJobTemplate(UmJobRow ATemplateRow, StringCollection ATemplateOperators, TDBTransaction ATransaction)
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar((@"SELECT COUNT(*) FROM PUB_um_job_qualification, PUB_um_job WHERE um_job_qualification.pm_unit_key_n = um_job.pm_unit_key_n AND um_job_qualification.pt_position_name_c = um_job.pt_position_name_c AND um_job_qualification.pt_position_scope_c = um_job.pt_position_scope_c AND um_job_qualification.um_job_key_i = um_job.um_job_key_i" + GenerateWhereClauseLong("PUB_um_job", UmJobTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, UmJobTable.GetPrimKeyColumnOrdList())));
        }
        ...
        public static void LoadViaPtQualificationArea(DataSet ADataSet, String AQualificationAreaName, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            ...
                            "pt_position_scope_c",
                            "um_job_key_i",
                            "pt_qualification_area_name_c"}) + " FROM PUB_um_job_qualification WHERE pt_qualification_area_name_c = ?") 
                            + GenerateOrderByClause(AOrderBy)), UmJobQualificationTable.GetTableName(), ATransaction, ParametersArray, AStartRecord, AMaxRecords);
        }
        ...
        public static void LoadViaPtQualificationAreaTemplate(DataSet ADataSet, PtQualificationAreaRow ATemplateRow, StringCollection ATemplateOperators, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_um_job_qualification", AFieldList, new string[] {
                            ...
                            "pt_position_scope_c",
                            "um_job_key_i",
                            "pt_qualification_area_name_c"}) + " FROM PUB_um_job_qualification, PUB_pt_qualification_area WHERE um_job_qualificat" +
                    "ion.pt_qualification_area_name_c = pt_qualification_area.pt_qualification_area_n" +
                    "ame_c") 
                            + GenerateWhereClauseLong("PUB_pt_qualification_area", PtQualificationAreaTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)) 
                            + GenerateOrderByClause(AOrderBy)), UmJobQualificationTable.GetTableName(), ATransaction, GetParametersForWhereClause(ATemplateRow), AStartRecord, AMaxRecords);
        }
        ...
        public static int CountViaPtQualificationArea(String AQualificationAreaName, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[0] = new OdbcParameter("", OdbcType.VarChar, 32);
            ParametersArray[0].Value = ((object)(AQualificationAreaName));
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar("SELECT COUNT(*) FROM PUB_um_job_qualification WHERE pt_qualification_area_name_c " +
                        "= ?", ATransaction, false, ParametersArray));
        }
        ...
        public static int CountViaPtQualificationAreaTemplate(PtQualificationAreaRow ATemplateRow, StringCollection ATemplateOperators, TDBTransaction ATransaction)
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(("SELECT COUNT(*) FROM PUB_um_job_qualification, PUB_pt_qualification_area WHERE um" +
                        "_job_qualification.pt_qualification_area_name_c = pt_qualification_area.pt_quali" +
                        "fication_area_name_c" + GenerateWhereClauseLong("PUB_pt_qualification_area", PtQualificationAreaTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, PtQualificationAreaTable.GetPrimKeyColumnOrdList())));
        }
        ...
        public static void LoadViaPtQualificationLevel(DataSet ADataSet, Int32 AQualificationLevel, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            ...
                            "pt_position_scope_c",
                            "um_job_key_i",
                            "pt_qualification_area_name_c"}) + " FROM PUB_um_job_qualification WHERE pt_qualification_level_i = ?") 
                            + GenerateOrderByClause(AOrderBy)), UmJobQualificationTable.GetTableName(), ATransaction, ParametersArray, AStartRecord, AMaxRecords);
        }
        ...
        public static void LoadViaPtQualificationLevelTemplate(DataSet ADataSet, PtQualificationLevelRow ATemplateRow, StringCollection ATemplateOperators, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_um_job_qualification", AFieldList, new string[] {
                            ...
                            "pt_position_scope_c",
                            "um_job_key_i",
                            "pt_qualification_area_name_c"}) + " FROM PUB_um_job_qualification, PUB_pt_qualification_level WHERE um_job_qualifica" +
                    "tion.pt_qualification_level_i = pt_qualification_level.pt_qualification_level_i") 
        ...
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(("SELECT COUNT(*) FROM PUB_um_job_qualification, PUB_pt_qualification_level WHERE u" +
                        "m_job_qualification.pt_qualification_level_i = pt_qualification_level.pt_qualifi" +
                        "cation_level_i" + GenerateWhereClauseLong("PUB_pt_qualification_level", PtQualificationLevelTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, PtQualificationLevelTable.GetPrimKeyColumnOrdList())));
        }
        ...
        public static void DeleteByPrimaryKey(Int64 AUnitKey, String APositionName, String APositionScope, Int32 AJobKey, String AQualificationAreaName, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[4] = new OdbcParameter("", OdbcType.VarChar, 32);
            ParametersArray[4].Value = ((object)(AQualificationAreaName));
            DBAccess.GDBAccessObj.ExecuteNonQuery("DELETE FROM PUB_um_job_qualification WHERE pm_unit_key_n = ? AND pt_position_name" +
                    "_c = ? AND pt_position_scope_c = ? AND um_job_key_i = ? AND pt_qualification_are" +
                    "a_name_c = ?", ATransaction, false, ParametersArray);
        }
    ...
    public class UmJobVisionAccess : TTypedDataAccess
    {
        ...
        public static void LoadAll(DataSet ADataSet, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            ...
                            "pt_position_scope_c",
                            "um_job_key_i",
                            "pt_vision_area_name_c"}) + " FROM PUB_um_job_vision") 
        ...
        public static void LoadByPrimaryKey(DataSet ADataSet, Int64 AUnitKey, String APositionName, String APositionScope, Int32 AJobKey, String AVisionAreaName, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            ...
                            "pt_position_scope_c",
                            "um_job_key_i",
                            "pt_vision_area_name_c"}) + " FROM PUB_um_job_vision WHERE pm_unit_key_n = ? AND pt_position_name_c = ? AND pt" +
                    "_position_scope_c = ? AND um_job_key_i = ? AND pt_vision_area_name_c = ?") 
        ...
        public static int CountByPrimaryKey(Int64 AUnitKey, String APositionName, String APositionScope, Int32 AJobKey, String AVisionAreaName, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[4] = new OdbcParameter("", OdbcType.VarChar, 32);
            ParametersArray[4].Value = ((object)(AVisionAreaName));
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar("SELECT COUNT(*) FROM PUB_um_job_vision WHERE pm_unit_key_n = ? AND pt_position_na" +
                        "me_c = ? AND pt_position_scope_c = ? AND um_job_key_i = ? AND pt_vision_area_nam" +
                        "e_c = ?", ATransaction, false, ParametersArray));
        }
        ...
        public static void LoadViaUmJob(DataSet ADataSet, Int64 AUnitKey, String APositionName, String APositionScope, Int32 AJobKey, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            ...
                            "um_job_key_i",
                            "pt_vision_area_name_c"}) + " FROM PUB_um_job_vision WHERE pm_unit_key_n = ? AND pt_position_name_c = ? AND pt" +
                    "_position_scope_c = ? AND um_job_key_i = ?") 
                            + GenerateOrderByClause(AOrderBy)), UmJobVisionTable.GetTableName(), ATransaction, ParametersArray, AStartRecord, AMaxRecords);
        }
        ...
        public static void LoadViaUmJobTemplate(DataSet ADataSet, UmJobRow ATemplateRow, StringCollection ATemplateOperators, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_um_job_vision", AFieldList, new string[] {
                            ...
                            "pt_position_scope_c",
                            "um_job_key_i",
                            "pt_vision_area_name_c"}) + @" FROM PUB_um_job_vision, PUB_um_job WHERE um_job_vision.pm_unit_key_n = um_job.pm_unit_key_n AND um_job_vision.pt_position_name_c = um_job.pt_position_name_c AND um_job_vision.pt_position_scope_c = um_job.pt_position_scope_c AND um_job_vision.um_job_key_i = um_job.um_job_key_i") 
                            + GenerateWhereClauseLong("PUB_um_job", UmJobTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)) 
                            + GenerateOrderByClause(AOrderBy)), UmJobVisionTable.GetTableName(), ATransaction, GetParametersForWhereClause(ATemplateRow), AStartRecord, AMaxRecords);
        }
        ...
        public static int CountViaUmJob(Int64 AUnitKey, String APositionName, String APositionScope, Int32 AJobKey, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[3].Value = ((object)(AJobKey));
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar("SELECT COUNT(*) FROM PUB_um_job_vision WHERE pm_unit_key_n = ? AND pt_position_na" +
                        "me_c = ? AND pt_position_scope_c = ? AND um_job_key_i = ?", ATransaction, false, ParametersArray));
        }
        
        /// auto generated
        public static int CountViaUmJobTemplate(UmJobRow ATemplateRow, StringCollection ATemplateOperators, TDBTransaction ATransaction)
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar((@"SELECT COUNT(*) FROM PUB_um_job_vision, PUB_um_job WHERE um_job_vision.pm_unit_key_n = um_job.pm_unit_key_n AND um_job_vision.pt_position_name_c = um_job.pt_position_name_c AND um_job_vision.pt_position_scope_c = um_job.pt_position_scope_c AND um_job_vision.um_job_key_i = um_job.um_job_key_i" + GenerateWhereClauseLong("PUB_um_job", UmJobTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, UmJobTable.GetPrimKeyColumnOrdList())));
        }
        ...
        public static void LoadViaPtVisionArea(DataSet ADataSet, String AVisionAreaName, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            ...
                            "pt_position_scope_c",
                            "um_job_key_i",
                            "pt_vision_area_name_c"}) + " FROM PUB_um_job_vision WHERE pt_vision_area_name_c = ?") 
                            + GenerateOrderByClause(AOrderBy)), UmJobVisionTable.GetTableName(), ATransaction, ParametersArray, AStartRecord, AMaxRecords);
        }
        ...
        public static void LoadViaPtVisionAreaTemplate(DataSet ADataSet, PtVisionAreaRow ATemplateRow, StringCollection ATemplateOperators, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_um_job_vision", AFieldList, new string[] {
                            ...
                            "pt_position_scope_c",
                            "um_job_key_i",
                            "pt_vision_area_name_c"}) + " FROM PUB_um_job_vision, PUB_pt_vision_area WHERE um_job_vision.pt_vision_area_na" +
                    "me_c = pt_vision_area.pt_vision_area_name_c") 
                            + GenerateWhereClauseLong("PUB_pt_vision_area", PtVisionAreaTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)) 
                            + GenerateOrderByClause(AOrderBy)), UmJobVisionTable.GetTableName(), ATransaction, GetParametersForWhereClause(ATemplateRow), AStartRecord, AMaxRecords);
        }
        ...
        public static int CountViaPtVisionAreaTemplate(PtVisionAreaRow ATemplateRow, StringCollection ATemplateOperators, TDBTransaction ATransaction)
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(("SELECT COUNT(*) FROM PUB_um_job_vision, PUB_pt_vision_area WHERE um_job_vision.pt" +
                        "_vision_area_name_c = pt_vision_area.pt_vision_area_name_c" + GenerateWhereClauseLong("PUB_pt_vision_area", PtVisionAreaTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, PtVisionAreaTable.GetPrimKeyColumnOrdList())));
        }
        ...
        public static void LoadViaPtVisionLevel(DataSet ADataSet, Int32 AVisionLevel, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            ...
                            "pt_position_scope_c",
                            "um_job_key_i",
                            "pt_vision_area_name_c"}) + " FROM PUB_um_job_vision WHERE pt_vision_level_i = ?") 
                            + GenerateOrderByClause(AOrderBy)), UmJobVisionTable.GetTableName(), ATransaction, ParametersArray, AStartRecord, AMaxRecords);
        }
        ...
        public static void LoadViaPtVisionLevelTemplate(DataSet ADataSet, PtVisionLevelRow ATemplateRow, StringCollection ATemplateOperators, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_um_job_vision", AFieldList, new string[] {
                            ...
                            "pt_position_scope_c",
                            "um_job_key_i",
                            "pt_vision_area_name_c"}) + " FROM PUB_um_job_vision, PUB_pt_vision_level WHERE um_job_vision.pt_vision_level_" +
                    "i = pt_vision_level.pt_vision_level_i") 
        ...
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(("SELECT COUNT(*) FROM PUB_um_job_vision, PUB_pt_vision_level WHERE um_job_vision.p" +
                        "t_vision_level_i = pt_vision_level.pt_vision_level_i" + GenerateWhereClauseLong("PUB_pt_vision_level", PtVisionLevelTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, PtVisionLevelTable.GetPrimKeyColumnOrdList())));
        }
        ...
        public static void DeleteByPrimaryKey(Int64 AUnitKey, String APositionName, String APositionScope, Int32 AJobKey, String AVisionAreaName, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[4] = new OdbcParameter("", OdbcType.VarChar, 32);
            ParametersArray[4].Value = ((object)(AVisionAreaName));
            DBAccess.GDBAccessObj.ExecuteNonQuery("DELETE FROM PUB_um_job_vision WHERE pm_unit_key_n = ? AND pt_position_name_c = ? " +
                    "AND pt_position_scope_c = ? AND um_job_key_i = ? AND pt_vision_area_name_c = ?", ATransaction, false, ParametersArray);
        }
    ...
    public class UmUnitAbilityAccess : TTypedDataAccess
    {
        ...
        public static void LoadAll(DataSet ADataSet, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            "p_partner_key_n",
                            "pt_ability_area_name_c"}) + " FROM PUB_um_unit_ability") 
        ...
        public static void LoadByPrimaryKey(DataSet ADataSet, Int64 APartnerKey, String AAbilityAreaName, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            "p_partner_key_n",
                            "pt_ability_area_name_c"}) + " FROM PUB_um_unit_ability WHERE p_partner_key_n = ? AND pt_ability_area_name_c = " +
                    "?") 
        ...
        public static int CountByPrimaryKey(Int64 APartnerKey, String AAbilityAreaName, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[1] = new OdbcParameter("", OdbcType.VarChar, 32);
            ParametersArray[1].Value = ((object)(AAbilityAreaName));
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar("SELECT COUNT(*) FROM PUB_um_unit_ability WHERE p_partner_key_n = ? AND pt_ability" +
                        "_area_name_c = ?", ATransaction, false, ParametersArray));
        }
        ...
        public static void LoadViaPUnit(DataSet ADataSet, Int64 APartnerKey, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            "p_partner_key_n",
                            "pt_ability_area_name_c"}) + " FROM PUB_um_unit_ability WHERE p_partner_key_n = ?") 
                            + GenerateOrderByClause(AOrderBy)), UmUnitAbilityTable.GetTableName(), ATransaction, ParametersArray, AStartRecord, AMaxRecords);
        }
        ...
        public static void LoadViaPUnitTemplate(DataSet ADataSet, PUnitRow ATemplateRow, StringCollection ATemplateOperators, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_um_unit_ability", AFieldList, new string[] {
                            "p_partner_key_n",
                            "pt_ability_area_name_c"}) + " FROM PUB_um_unit_ability, PUB_p_unit WHERE um_unit_ability.p_partner_key_n = p_u" +
                    "nit.p_partner_key_n") 
                            + GenerateWhereClauseLong("PUB_p_unit", PUnitTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)) 
                            + GenerateOrderByClause(AOrderBy)), UmUnitAbilityTable.GetTableName(), ATransaction, GetParametersForWhereClause(ATemplateRow), AStartRecord, AMaxRecords);
        }
        ...
        public static int CountViaPUnitTemplate(PUnitRow ATemplateRow, StringCollection ATemplateOperators, TDBTransaction ATransaction)
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(("SELECT COUNT(*) FROM PUB_um_unit_ability, PUB_p_unit WHERE um_unit_ability.p_part" +
                        "ner_key_n = p_unit.p_partner_key_n" + GenerateWhereClauseLong("PUB_p_unit", PUnitTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, PUnitTable.GetPrimKeyColumnOrdList())));
        }
        ...
        public static void LoadViaPtAbilityArea(DataSet ADataSet, String AAbilityAreaName, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            "p_partner_key_n",
                            "pt_ability_area_name_c"}) + " FROM PUB_um_unit_ability WHERE pt_ability_area_name_c = ?") 
                            + GenerateOrderByClause(AOrderBy)), UmUnitAbilityTable.GetTableName(), ATransaction, ParametersArray, AStartRecord, AMaxRecords);
        }
        ...
        public static void LoadViaPtAbilityAreaTemplate(DataSet ADataSet, PtAbilityAreaRow ATemplateRow, StringCollection ATemplateOperators, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_um_unit_ability", AFieldList, new string[] {
                            "p_partner_key_n",
                            "pt_ability_area_name_c"}) + " FROM PUB_um_unit_ability, PUB_pt_ability_area WHERE um_unit_ability.pt_ability_a" +
                    "rea_name_c = pt_ability_area.pt_ability_area_name_c") 
                            + GenerateWhereClauseLong("PUB_pt_ability_area", PtAbilityAreaTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)) 
                            + GenerateOrderByClause(AOrderBy)), UmUnitAbilityTable.GetTableName(), ATransaction, GetParametersForWhereClause(ATemplateRow), AStartRecord, AMaxRecords);
        }
        ...
        public static int CountViaPtAbilityAreaTemplate(PtAbilityAreaRow ATemplateRow, StringCollection ATemplateOperators, TDBTransaction ATransaction)
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(("SELECT COUNT(*) FROM PUB_um_unit_ability, PUB_pt_ability_area WHERE um_unit_abili" +
                        "ty.pt_ability_area_name_c = pt_ability_area.pt_ability_area_name_c" + GenerateWhereClauseLong("PUB_pt_ability_area", PtAbilityAreaTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, PtAbilityAreaTable.GetPrimKeyColumnOrdList())));
        }
        ...
        public static void LoadViaPtAbilityLevel(DataSet ADataSet, Int32 AAbilityLevel, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            "p_partner_key_n",
                            "pt_ability_area_name_c"}) + " FROM PUB_um_unit_ability WHERE pt_ability_level_i = ?") 
                            + GenerateOrderByClause(AOrderBy)), UmUnitAbilityTable.GetTableName(), ATransaction, ParametersArray, AStartRecord, AMaxRecords);
        }
        ...
        public static void LoadViaPtAbilityLevelTemplate(DataSet ADataSet, PtAbilityLevelRow ATemplateRow, StringCollection ATemplateOperators, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_um_unit_ability", AFieldList, new string[] {
                            "p_partner_key_n",
                            "pt_ability_area_name_c"}) + " FROM PUB_um_unit_ability, PUB_pt_ability_level WHERE um_unit_ability.pt_ability_" +
                    "level_i = pt_ability_level.pt_ability_level_i") 
                            + GenerateWhereClauseLong("PUB_pt_ability_level", PtAbilityLevelTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)) 
                            + GenerateOrderByClause(AOrderBy)), UmUnitAbilityTable.GetTableName(), ATransaction, GetParametersForWhereClause(ATemplateRow), AStartRecord, AMaxRecords);
        }
        ...
        public static int CountViaPtAbilityLevelTemplate(PtAbilityLevelRow ATemplateRow, StringCollection ATemplateOperators, TDBTransaction ATransaction)
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(("SELECT COUNT(*) FROM PUB_um_unit_ability, PUB_pt_ability_level WHERE um_unit_abil" +
                        "ity.pt_ability_level_i = pt_ability_level.pt_ability_level_i" + GenerateWhereClauseLong("PUB_pt_ability_level", PtAbilityLevelTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, PtAbilityLevelTable.GetPrimKeyColumnOrdList())));
        }
        ...
        public static void DeleteByPrimaryKey(Int64 APartnerKey, String AAbilityAreaName, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[1] = new OdbcParameter("", OdbcType.VarChar, 32);
            ParametersArray[1].Value = ((object)(AAbilityAreaName));
            DBAccess.GDBAccessObj.ExecuteNonQuery("DELETE FROM PUB_um_unit_ability WHERE p_partner_key_n = ? AND pt_ability_area_nam" +
                    "e_c = ?", ATransaction, false, ParametersArray);
        }
    ...
    public class UmUnitLanguageAccess : TTypedDataAccess
    {
        ...
        public static void LoadAll(DataSet ADataSet, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            "p_partner_key_n",
                            "p_language_code_c",
                            "pt_language_level_i"}) + " FROM PUB_um_unit_language") 
        ...
        public static void LoadByPrimaryKey(DataSet ADataSet, Int64 APartnerKey, String ALanguageCode, Int32 ALanguageLevel, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            "p_partner_key_n",
                            "p_language_code_c",
                            "pt_language_level_i"}) + " FROM PUB_um_unit_language WHERE p_partner_key_n = ? AND p_language_code_c = ? AN" +
                    "D pt_language_level_i = ?") 
        ...
        public static int CountByPrimaryKey(Int64 APartnerKey, String ALanguageCode, Int32 ALanguageLevel, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[2] = new OdbcParameter("", OdbcType.Int);
            ParametersArray[2].Value = ((object)(ALanguageLevel));
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar("SELECT COUNT(*) FROM PUB_um_unit_language WHERE p_partner_key_n = ? AND p_languag" +
                        "e_code_c = ? AND pt_language_level_i = ?", ATransaction, false, ParametersArray));
        }
        ...
        public static void LoadViaPUnit(DataSet ADataSet, Int64 APartnerKey, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            "p_partner_key_n",
                            "p_language_code_c",
                            "pt_language_level_i"}) + " FROM PUB_um_unit_language WHERE p_partner_key_n = ?") 
                            + GenerateOrderByClause(AOrderBy)), UmUnitLanguageTable.GetTableName(), ATransaction, ParametersArray, AStartRecord, AMaxRecords);
        }
        ...
        public static void LoadViaPUnitTemplate(DataSet ADataSet, PUnitRow ATemplateRow, StringCollection ATemplateOperators, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_um_unit_language", AFieldList, new string[] {
                            "p_partner_key_n",
                            "p_language_code_c",
                            "pt_language_level_i"}) + " FROM PUB_um_unit_language, PUB_p_unit WHERE um_unit_language.p_partner_key_n = p" +
        ...
        public static int CountViaPUnitTemplate(PUnitRow ATemplateRow, StringCollection ATemplateOperators, TDBTransaction ATransaction)
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(("SELECT COUNT(*) FROM PUB_um_unit_language, PUB_p_unit WHERE um_unit_language.p_pa" +
        ...
        public static void LoadViaPLanguage(DataSet ADataSet, String ALanguageCode, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            "p_partner_key_n",
                            "p_language_code_c",
                            "pt_language_level_i"}) + " FROM PUB_um_unit_language WHERE p_language_code_c = ?") 
                            + GenerateOrderByClause(AOrderBy)), UmUnitLanguageTable.GetTableName(), ATransaction, ParametersArray, AStartRecord, AMaxRecords);
        }
        ...
        public static void LoadViaPLanguageTemplate(DataSet ADataSet, PLanguageRow ATemplateRow, StringCollection ATemplateOperators, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_um_unit_language", AFieldList, new string[] {
                            "p_partner_key_n",
                            "p_language_code_c",
                            "pt_language_level_i"}) + " FROM PUB_um_unit_language, PUB_p_language WHERE um_unit_language.p_language_code" +
                    "_c = p_language.p_language_code_c") 
                            + GenerateWhereClauseLong("PUB_p_language", PLanguageTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)) 
                            + GenerateOrderByClause(AOrderBy)), UmUnitLanguageTable.GetTableName(), ATransaction, GetParametersForWhereClause(ATemplateRow), AStartRecord, AMaxRecords);
        }
        ...
        public static int CountViaPLanguageTemplate(PLanguageRow ATemplateRow, StringCollection ATemplateOperators, TDBTransaction ATransaction)
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(("SELECT COUNT(*) FROM PUB_um_unit_language, PUB_p_language WHERE um_unit_language." +
                        "p_language_code_c = p_language.p_language_code_c" + GenerateWhereClauseLong("PUB_p_language", PLanguageTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, PLanguageTable.GetPrimKeyColumnOrdList())));
        }
        ...
        public static void LoadViaPtLanguageLevel(DataSet ADataSet, Int32 ALanguageLevel, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            "p_partner_key_n",
                            "p_language_code_c",
                            "pt_language_level_i"}) + " FROM PUB_um_unit_language WHERE pt_language_level_i = ?") 
                            + GenerateOrderByClause(AOrderBy)), UmUnitLanguageTable.GetTableName(), ATransaction, ParametersArray, AStartRecord, AMaxRecords);
        }
        ...
        public static void LoadViaPtLanguageLevelTemplate(DataSet ADataSet, PtLanguageLevelRow ATemplateRow, StringCollection ATemplateOperators, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_um_unit_language", AFieldList, new string[] {
                            "p_partner_key_n",
                            "p_language_code_c",
                            "pt_language_level_i"}) + " FROM PUB_um_unit_language, PUB_pt_language_level WHERE um_unit_language.pt_langu" +
                    "age_level_i = pt_language_level.pt_language_level_i") 
                            + GenerateWhereClauseLong("PUB_pt_language_level", PtLanguageLevelTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)) 
                            + GenerateOrderByClause(AOrderBy)), UmUnitLanguageTable.GetTableName(), ATransaction, GetParametersForWhereClause(ATemplateRow), AStartRecord, AMaxRecords);
        }
        ...
        public static int CountViaPtLanguageLevelTemplate(PtLanguageLevelRow ATemplateRow, StringCollection ATemplateOperators, TDBTransaction ATransaction)
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(("SELECT COUNT(*) FROM PUB_um_unit_language, PUB_pt_language_level WHERE um_unit_la" +
                        "nguage.pt_language_level_i = pt_language_level.pt_language_level_i" + GenerateWhereClauseLong("PUB_pt_language_level", PtLanguageLevelTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, PtLanguageLevelTable.GetPrimKeyColumnOrdList())));
        }
        ...
        public static void DeleteByPrimaryKey(Int64 APartnerKey, String ALanguageCode, Int32 ALanguageLevel, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[2] = new OdbcParameter("", OdbcType.Int);
            ParametersArray[2].Value = ((object)(ALanguageLevel));
            DBAccess.GDBAccessObj.ExecuteNonQuery("DELETE FROM PUB_um_unit_language WHERE p_partner_key_n = ? AND p_language_code_c " +
                    "= ? AND pt_language_level_i = ?", ATransaction, false, ParametersArray);
        }
    ...
    public class UmUnitVisionAccess : TTypedDataAccess
    {
        ...
        public static void LoadAll(DataSet ADataSet, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            "p_partner_key_n",
                            "pt_vision_area_name_c"}) + " FROM PUB_um_unit_vision") 
        ...
        public static void LoadByPrimaryKey(DataSet ADataSet, Int64 APartnerKey, String AVisionAreaName, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            "p_partner_key_n",
                            "pt_vision_area_name_c"}) + " FROM PUB_um_unit_vision WHERE p_partner_key_n = ? AND pt_vision_area_name_c = ?") 
        ...
        public static int CountByPrimaryKey(Int64 APartnerKey, String AVisionAreaName, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[1] = new OdbcParameter("", OdbcType.VarChar, 32);
            ParametersArray[1].Value = ((object)(AVisionAreaName));
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar("SELECT COUNT(*) FROM PUB_um_unit_vision WHERE p_partner_key_n = ? AND pt_vision_a" +
                        "rea_name_c = ?", ATransaction, false, ParametersArray));
        }
        ...
        public static void LoadViaPUnit(DataSet ADataSet, Int64 APartnerKey, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            "p_partner_key_n",
                            "pt_vision_area_name_c"}) + " FROM PUB_um_unit_vision WHERE p_partner_key_n = ?") 
                            + GenerateOrderByClause(AOrderBy)), UmUnitVisionTable.GetTableName(), ATransaction, ParametersArray, AStartRecord, AMaxRecords);
        }
        ...
        public static void LoadViaPUnitTemplate(DataSet ADataSet, PUnitRow ATemplateRow, StringCollection ATemplateOperators, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_um_unit_vision", AFieldList, new string[] {
                            "p_partner_key_n",
                            "pt_vision_area_name_c"}) + " FROM PUB_um_unit_vision, PUB_p_unit WHERE um_unit_vision.p_partner_key_n = p_uni" +
                    "t.p_partner_key_n") 
                            + GenerateWhereClauseLong("PUB_p_unit", PUnitTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)) 
                            + GenerateOrderByClause(AOrderBy)), UmUnitVisionTable.GetTableName(), ATransaction, GetParametersForWhereClause(ATemplateRow), AStartRecord, AMaxRecords);
        }
        ...
        public static int CountViaPUnitTemplate(PUnitRow ATemplateRow, StringCollection ATemplateOperators, TDBTransaction ATransaction)
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(("SELECT COUNT(*) FROM PUB_um_unit_vision, PUB_p_unit WHERE um_unit_vision.p_partne" +
                        "r_key_n = p_unit.p_partner_key_n" + GenerateWhereClauseLong("PUB_p_unit", PUnitTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, PUnitTable.GetPrimKeyColumnOrdList())));
        }
        ...
        public static void LoadViaPtVisionArea(DataSet ADataSet, String AVisionAreaName, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            "p_partner_key_n",
                            "pt_vision_area_name_c"}) + " FROM PUB_um_unit_vision WHERE pt_vision_area_name_c = ?") 
                            + GenerateOrderByClause(AOrderBy)), UmUnitVisionTable.GetTableName(), ATransaction, ParametersArray, AStartRecord, AMaxRecords);
        }
        ...
        public static void LoadViaPtVisionAreaTemplate(DataSet ADataSet, PtVisionAreaRow ATemplateRow, StringCollection ATemplateOperators, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_um_unit_vision", AFieldList, new string[] {
                            "p_partner_key_n",
                            "pt_vision_area_name_c"}) + " FROM PUB_um_unit_vision, PUB_pt_vision_area WHERE um_unit_vision.pt_vision_area_" +
                    "name_c = pt_vision_area.pt_vision_area_name_c") 
                            + GenerateWhereClauseLong("PUB_pt_vision_area", PtVisionAreaTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)) 
                            + GenerateOrderByClause(AOrderBy)), UmUnitVisionTable.GetTableName(), ATransaction, GetParametersForWhereClause(ATemplateRow), AStartRecord, AMaxRecords);
        }
        ...
        public static int CountViaPtVisionAreaTemplate(PtVisionAreaRow ATemplateRow, StringCollection ATemplateOperators, TDBTransaction ATransaction)
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(("SELECT COUNT(*) FROM PUB_um_unit_vision, PUB_pt_vision_area WHERE um_unit_vision." +
                        "pt_vision_area_name_c = pt_vision_area.pt_vision_area_name_c" + GenerateWhereClauseLong("PUB_pt_vision_area", PtVisionAreaTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, PtVisionAreaTable.GetPrimKeyColumnOrdList())));
        }
        ...
        public static void LoadViaPtVisionLevel(DataSet ADataSet, Int32 AVisionLevel, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            "p_partner_key_n",
                            "pt_vision_area_name_c"}) + " FROM PUB_um_unit_vision WHERE pt_vision_level_i = ?") 
                            + GenerateOrderByClause(AOrderBy)), UmUnitVisionTable.GetTableName(), ATransaction, ParametersArray, AStartRecord, AMaxRecords);
        }
        ...
        public static void LoadViaPtVisionLevelTemplate(DataSet ADataSet, PtVisionLevelRow ATemplateRow, StringCollection ATemplateOperators, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_um_unit_vision", AFieldList, new string[] {
                            "p_partner_key_n",
                            "pt_vision_area_name_c"}) + " FROM PUB_um_unit_vision, PUB_pt_vision_level WHERE um_unit_vision.pt_vision_leve" +
                    "l_i = pt_vision_level.pt_vision_level_i") 
                            + GenerateWhereClauseLong("PUB_pt_vision_level", PtVisionLevelTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)) 
                            + GenerateOrderByClause(AOrderBy)), UmUnitVisionTable.GetTableName(), ATransaction, GetParametersForWhereClause(ATemplateRow), AStartRecord, AMaxRecords);
        }
        ...
        public static int CountViaPtVisionLevelTemplate(PtVisionLevelRow ATemplateRow, StringCollection ATemplateOperators, TDBTransaction ATransaction)
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(("SELECT COUNT(*) FROM PUB_um_unit_vision, PUB_pt_vision_level WHERE um_unit_vision" +
                        ".pt_vision_level_i = pt_vision_level.pt_vision_level_i" + GenerateWhereClauseLong("PUB_pt_vision_level", PtVisionLevelTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, PtVisionLevelTable.GetPrimKeyColumnOrdList())));
        }
        ...
        public static void DeleteByPrimaryKey(Int64 APartnerKey, String AVisionAreaName, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[1] = new OdbcParameter("", OdbcType.VarChar, 32);
            ParametersArray[1].Value = ((object)(AVisionAreaName));
            DBAccess.GDBAccessObj.ExecuteNonQuery("DELETE FROM PUB_um_unit_vision WHERE p_partner_key_n = ? AND pt_vision_area_name_" +
                    "c = ?", ATransaction, false, ParametersArray);
        }
    ...
    public class UmUnitCostAccess : TTypedDataAccess
    {
        ...
        public static void LoadAll(DataSet ADataSet, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            "p_partner_key_n",
                            "um_valid_from_date_d"}) + " FROM PUB_um_unit_cost") 
        ...
        public static void LoadByPrimaryKey(DataSet ADataSet, Int64 APartnerKey, System.DateTime AValidFromDate, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            "p_partner_key_n",
                            "um_valid_from_date_d"}) + " FROM PUB_um_unit_cost WHERE p_partner_key_n = ? AND um_valid_from_date_d = ?") 
        ...
        public static int CountByPrimaryKey(Int64 APartnerKey, System.DateTime AValidFromDate, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[1] = new OdbcParameter("", OdbcType.Date);
            ParametersArray[1].Value = ((object)(AValidFromDate));
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar("SELECT COUNT(*) FROM PUB_um_unit_cost WHERE p_partner_key_n = ? AND um_valid_from" +
                        "_date_d = ?", ATransaction, false, ParametersArray));
        }
        ...
        public static void LoadViaPUnit(DataSet ADataSet, Int64 APartnerKey, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            "p_partner_key_n",
                            "um_valid_from_date_d"}) + " FROM PUB_um_unit_cost WHERE p_partner_key_n = ?") 
                            + GenerateOrderByClause(AOrderBy)), UmUnitCostTable.GetTableName(), ATransaction, ParametersArray, AStartRecord, AMaxRecords);
        }
        ...
        public static void LoadViaPUnitTemplate(DataSet ADataSet, PUnitRow ATemplateRow, StringCollection ATemplateOperators, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_um_unit_cost", AFieldList, new string[] {
                            "p_partner_key_n",
                            "um_valid_from_date_d"}) + " FROM PUB_um_unit_cost, PUB_p_unit WHERE um_unit_cost.p_partner_key_n = p_unit.p_" +
                    "partner_key_n") 
                            + GenerateWhereClauseLong("PUB_p_unit", PUnitTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)) 
                            + GenerateOrderByClause(AOrderBy)), UmUnitCostTable.GetTableName(), ATransaction, GetParametersForWhereClause(ATemplateRow), AStartRecord, AMaxRecords);
        }
        ...
        public static int CountViaPUnitTemplate(PUnitRow ATemplateRow, StringCollection ATemplateOperators, TDBTransaction ATransaction)
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(("SELECT COUNT(*) FROM PUB_um_unit_cost, PUB_p_unit WHERE um_unit_cost.p_partner_ke" +
                        "y_n = p_unit.p_partner_key_n" + GenerateWhereClauseLong("PUB_p_unit", PUnitTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, PUnitTable.GetPrimKeyColumnOrdList())));
        }
        ...
        public static void LoadViaACurrency(DataSet ADataSet, String ACurrencyCode, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            "p_partner_key_n",
                            "um_valid_from_date_d"}) + " FROM PUB_um_unit_cost WHERE a_local_currency_code_c = ?") 
                            + GenerateOrderByClause(AOrderBy)), UmUnitCostTable.GetTableName(), ATransaction, ParametersArray, AStartRecord, AMaxRecords);
        }
        ...
        public static void LoadViaACurrencyTemplate(DataSet ADataSet, ACurrencyRow ATemplateRow, StringCollection ATemplateOperators, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_um_unit_cost", AFieldList, new string[] {
                            "p_partner_key_n",
                            "um_valid_from_date_d"}) + " FROM PUB_um_unit_cost, PUB_a_currency WHERE um_unit_cost.a_local_currency_code_c" +
                    " = a_currency.a_currency_code_c") 
        ...
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(("SELECT COUNT(*) FROM PUB_um_unit_cost, PUB_a_currency WHERE um_unit_cost.a_local_" +
                        "currency_code_c = a_currency.a_currency_code_c" + GenerateWhereClauseLong("PUB_a_currency", ACurrencyTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, ACurrencyTable.GetPrimKeyColumnOrdList())));
        }
        ...
        public static void DeleteByPrimaryKey(Int64 APartnerKey, System.DateTime AValidFromDate, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[1] = new OdbcParameter("", OdbcType.Date);
            ParametersArray[1].Value = ((object)(AValidFromDate));
            DBAccess.GDBAccessObj.ExecuteNonQuery("DELETE FROM PUB_um_unit_cost WHERE p_partner_key_n = ? AND um_valid_from_date_d =" +
                    " ?", ATransaction, false, ParametersArray);
        }
    ...
    public class UmUnitEvaluationAccess : TTypedDataAccess
    {
        ...
        public static void LoadAll(DataSet ADataSet, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            ...
                            "um_evaluation_number_n"}) + " FROM PUB_um_unit_evaluation") 
        ...
        public static void LoadByPrimaryKey(DataSet ADataSet, Int64 APartnerKey, System.DateTime ADateOfEvaluation, Decimal AEvaluationNumber, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            "p_partner_key_n",
                            "um_date_of_evaluation_d",
                            "um_evaluation_number_n"}) + " FROM PUB_um_unit_evaluation WHERE p_partner_key_n = ? AND um_date_of_evaluation_" +
                    "d = ? AND um_evaluation_number_n = ?") 
        ...
        public static int CountByPrimaryKey(Int64 APartnerKey, System.DateTime ADateOfEvaluation, Decimal AEvaluationNumber, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[2] = new OdbcParameter("", OdbcType.Decimal, 14);
            ParametersArray[2].Value = ((object)(AEvaluationNumber));
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar("SELECT COUNT(*) FROM PUB_um_unit_evaluation WHERE p_partner_key_n = ? AND um_date" +
                        "_of_evaluation_d = ? AND um_evaluation_number_n = ?", ATransaction, false, ParametersArray));
        }
        ...
        public static void LoadViaPUnit(DataSet ADataSet, Int64 APartnerKey, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ...
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, ((GenerateSelectClause(AFieldList, new string[] {
                            "p_partner_key_n",
                            "um_date_of_evaluation_d",
                            "um_evaluation_number_n"}) + " FROM PUB_um_unit_evaluation WHERE p_partner_key_n = ?") 
                            + GenerateOrderByClause(AOrderBy)), UmUnitEvaluationTable.GetTableName(), ATransaction, ParametersArray, AStartRecord, AMaxRecords);
        }
        ...
        public static void LoadViaPUnitTemplate(DataSet ADataSet, PUnitRow ATemplateRow, StringCollection ATemplateOperators, StringCollection AFieldList, TDBTransaction ATransaction, StringCollection AOrderBy, int AStartRecord, int AMaxRecords)
        {
            ADataSet = DBAccess.GDBAccessObj.Select(ADataSet, (((GenerateSelectClauseLong("PUB_um_unit_evaluation", AFieldList, new string[] {
                            "p_partner_key_n",
                            "um_date_of_evaluation_d",
                            "um_evaluation_number_n"}) + " FROM PUB_um_unit_evaluation, PUB_p_unit WHERE um_unit_evaluation.p_partner_key_n" +
        ...
        public static int CountViaPUnitTemplate(PUnitRow ATemplateRow, StringCollection ATemplateOperators, TDBTransaction ATransaction)
        {
            return Convert.ToInt32(DBAccess.GDBAccessObj.ExecuteScalar(("SELECT COUNT(*) FROM PUB_um_unit_evaluation, PUB_p_unit WHERE um_unit_evaluation." +
                        "p_partner_key_n = p_unit.p_partner_key_n" + GenerateWhereClauseLong("PUB_p_unit", PUnitTable.GetColumnStringList(), ATemplateRow, ATemplateOperators)), ATransaction, false, GetParametersForWhereClause(ATemplateRow, PUnitTable.GetPrimKeyColumnOrdList())));
        }
        ...
        public static void DeleteByPrimaryKey(Int64 APartnerKey, System.DateTime ADateOfEvaluation, Decimal AEvaluationNumber, TDBTransaction ATransaction)
        {
            ...
            ParametersArray[2] = new OdbcParameter("", OdbcType.Decimal, 14);
            ParametersArray[2].Value = ((object)(AEvaluationNumber));
            DBAccess.GDBAccessObj.ExecuteNonQuery("DELETE FROM PUB_um_unit_evaluation WHERE p_partner_key_n = ? AND um_date_of_evalu" +
                    "ation_d = ? AND um_evaluation_number_n = ?", ATransaction, false, ParametersArray);
        }
