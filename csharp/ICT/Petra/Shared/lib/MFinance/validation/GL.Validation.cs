...
namespace Ict.Petra.Shared.MFinance.Validation
{
    ...
    public static partial class TSharedFinanceValidation_GL
    {
        ...
        /// <param name="AEndDateLastForwardingPeriod">If the caller knows this value it can be supplied. Otherwise the server will supply the value for the ledger. <see cref="DataRow" /> which holds the the data against which the validation is run.</param>
