...
namespace Ict.Petra.Server.MPersonnel.Person
{
    /// <summary>
    ...
    public class TPersonnelCacheable : TCacheableTablesLoader
    {
        ...
        #region TMPersonnel_Person_Cacheable
         ...
         *
         */
        public DataTable GetStandardCacheableTable(TCacheablePersonDataElementsTablesEnum ACacheableTable,
            String AHashCode,
            ...
            out System.Type AType)
        {
            ...
            TableName = Enum.GetName(typeof(TCacheablePersonDataElementsTablesEnum), ACacheableTable);
#if DEBUGMODE
            if (TSrvSetting.DL >= 7)
            {
                ...
                try
                {
                    switch (ACacheableTable)
                    {
                        case TCacheablePersonDataElementsTablesEnum.DocumentTypeList:
                            TmpTable = PmDocumentTypeAccess.LoadAll(ReadTransaction);
                        ...
                        case TCacheablePersonDataElementsTablesEnum.CommitmentStatusList:
                            TmpTable = PmCommitmentStatusAccess.LoadAll(ReadTransaction);
                            DomainManager.GCacheableTablesManager.AddOrRefreshCachedTable(TableName, TmpTable, DomainManager.GClientID);
                        ...
                        default:
                            ...
                            Enum.GetName(typeof(TCacheablePersonDataElementsTablesEnum),
