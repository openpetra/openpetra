...
{
    /// <summary>
    /// query finds all family members (persons) of families given in a base extract
    /// </summary>
    public class QueryFamilyMembersExtract : Ict.Petra.Server.MCommon.queries.ExtractQueryBase
    {
        /// <summary>
