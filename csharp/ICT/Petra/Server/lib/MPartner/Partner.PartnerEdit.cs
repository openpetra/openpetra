...
namespace Ict.Petra.Server.MPartner.Partner.UIConnectors
{
    ...
    public class TPartnerEditUIConnector : TConfigurableMBRObject, IPartnerUIConnectorsPartnerEdit
    {
        ...
        {
            return Ict.Petra.Server.MFinance.Setup.HasPartnerCostCentreLink(FPartnerKey, out ACostCentreCode);
        }
        ...
        {
            return Ict.Petra.Server.MFinance.Setup.HasPartnerCostCentreLink(APartnerKey, out ACostCentreCode);
        }
