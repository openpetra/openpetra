...
namespace Ict.Petra.Server.MPartner.Instantiator.ImportExport.WebConnectors
{
    ...
    public class TImportExportWebConnectorsNamespace : MarshalByRefObject, IImportExportWebConnectorsNamespace
    {
        ...
        {
            TModuleAccessManager.CheckUserPermissionsForMethod(typeof(Ict.Petra.Server.MPartner.ImportExport.WebConnectors.TImportExportWebConnector), "ImportPartnersFromYml", "stringTVerificationResultCollection");
        ...
        public PartnerImportExportTDS ImportFromCSVFile(string AXmlPartnerData,
                                                        out TVerificationResultCollection AVerificationResult)
        {
            TModuleAccessManager.CheckUserPermissionsForMethod(typeof(Ict.Petra.Server.MPartner.ImportExport.WebConnectors.TImportExportWebConnector), "ImportFromCSVFile", "stringTVerificationResultCollection");
...
namespace Ict.Petra.Server.MPartner.Instantiator.Mailing.WebConnectors
{
    ...
    public class TMailingWebConnectorsNamespace : MarshalByRefObject, IMailingWebConnectorsNamespace
    {
        ...
        {
            TModuleAccessManager.CheckUserPermissionsForMethod(typeof(Ict.Petra.Server.MPartner.Mailing.WebConnectors.TAddressWebConnector), "GetBestAddress", "Int64PLocationTablestringstring");
        ...
        {
            TModuleAccessManager.CheckUserPermissionsForMethod(typeof(Ict.Petra.Server.MPartner.Mailing.WebConnectors.TAddressWebConnector), "AddPostalAddress", "DataTableDataColumnbool");
        ...
        {
            TModuleAccessManager.CheckUserPermissionsForMethod(typeof(Ict.Petra.Server.MPartner.Mailing.WebConnectors.TAddressWebConnector), "CreateExtractFromBestAddressTable", "StringStringInt32BooleanTVerificationResultCollectionBestAddressTDSLocationTablebool");
...
namespace Ict.Petra.Server.MPartner.Instantiator.Partner.WebConnectors
{
    ...
    public class TPartnerWebConnectorsNamespace : MarshalByRefObject, IPartnerWebConnectorsNamespace
    {
        ...
        public bool AddContact(List <Int64>APartnerKeys,
                               ...
                               out TVerificationResultCollection AVerificationResults)
        {
            TModuleAccessManager.CheckUserPermissionsForMethod(typeof(Ict.Petra.Server.MPartner.Partner.WebConnectors.TContactsWebConnector), "AddContact", "List <Int64>DateTimestringstringstringstringTVerificationResultCollection");
        ...
        public PPartnerContactTable FindContacts(string AContactor,
                                                 ...
                                                 string AMailingCode)
        {
            TModuleAccessManager.CheckUserPermissionsForMethod(typeof(Ict.Petra.Server.MPartner.Partner.WebConnectors.TContactsWebConnector), "FindContacts", "stringDateTime?stringstringstringstring");
        ...
        public bool DeleteContacts(PPartnerContactTable APartnerContacts,
                                   out TVerificationResultCollection AVerificationResults)
        {
            TModuleAccessManager.CheckUserPermissionsForMethod(typeof(Ict.Petra.Server.MPartner.Partner.WebConnectors.TContactsWebConnector), "DeleteContacts", "PPartnerContactTableTVerificationResultCollection");
        ...
        {
            TModuleAccessManager.CheckUserPermissionsForMethod(typeof(Ict.Petra.Server.MPartner.Partner.WebConnectors.TSimplePartnerEditWebConnector), "NewPartnerKey", "Int64");
        ...
        {
            TModuleAccessManager.CheckUserPermissionsForMethod(typeof(Ict.Petra.Server.MPartner.Partner.WebConnectors.TSimplePartnerEditWebConnector), "GetPartnerDetails", "Int64boolboolbool");
        ...
        public bool SavePartner(PartnerEditTDS AMainDS,
                                out TVerificationResultCollection AVerificationResult)
        {
            TModuleAccessManager.CheckUserPermissionsForMethod(typeof(Ict.Petra.Server.MPartner.Partner.WebConnectors.TSimplePartnerEditWebConnector), "SavePartner", "PartnerEditTDSTVerificationResultCollection");
        ...
        {
            TModuleAccessManager.CheckUserPermissionsForMethod(typeof(Ict.Petra.Server.MPartner.Partner.WebConnectors.TSimplePartnerFindWebConnector), "FindPartners", "stringstringstringStringCollection");
...
namespace Ict.Petra.Server.MPartner.Instantiator.TableMaintenance.WebConnectors
{
    ...
    public class TTableMaintenanceWebConnectorsNamespace : MarshalByRefObject, ITableMaintenanceWebConnectorsNamespace
    {
        ...
        public TSubmitChangesResult SavePartnerMaintenanceTables(ref PartnerSetupTDS AInspectDS,
                                                                 out TVerificationResultCollection AVerificationResult)
        {
            TModuleAccessManager.CheckUserPermissionsForMethod(typeof(Ict.Petra.Server.MPartner.TableMaintenance.WebConnectors.TPartnerSetupWebConnector), "SavePartnerMaintenanceTables", "PartnerSetupTDSTVerificationResultCollection");
