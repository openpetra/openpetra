...
namespace Ict.Petra.Server.MFinance.Gift.WebConnectors
{
	...
	public class TTransactionWebConnector
	{
		...
		public static AGiftBatchRow CreateANewGiftBatchRow(ref GiftBatchTDS MainDS, ref TDBTransaction Transaction, ref ALedgerTable LedgerTable, Int32 ALedgerNumber, DateTime ADateEffective)
		{
