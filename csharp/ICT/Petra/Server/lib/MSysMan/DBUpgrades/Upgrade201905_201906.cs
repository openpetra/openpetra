...
namespace Ict.Petra.Server.MSysMan.DBUpgrades
{
    ...
    {
        /// Upgrade to version 2019-06
        public static bool UpgradeDatabase201905_201906()
        {
            // new table s_session
            ...
            db.WriteTransaction(ref SubmitChangesTransaction,
                ...
                delegate
                {
                    string[] SqlStmts = TDataBase.ReadSqlFile("Upgrade201905_201906.sql").Split(new char[]{';'});
