        ...
        public static bool UpgradeDatabase202110_202202(TDataBase ADataBase)
        {
            ...
            ADataBase.WriteTransaction(ref SubmitChangesTransaction,
                ...
                delegate
                {
                    ...
                    {
                        sql = "INSERT INTO PUB_p_type( p_type_code_c, p_type_description_c, p_system_type_l) VALUES('THANKYOU_NO_RECEIPT','Receives no gift receipt but a thank you letter',1)";
