...
namespace Ict.Petra.Server.MSysMan.DBUpgrades
{
    ...
    {
        /// Upgrade to version 2020-03
        public static bool UpgradeDatabase202002_202003(TDataBase ADataBase)
        {
            // modify text fields in some tables
            ...
            ADataBase.WriteTransaction(ref SubmitChangesTransaction,
                ...
                delegate
                {
                    string[] SqlStmts = TDataBase.ReadSqlFile("Upgrade202002_202003.sql").Split(new char[]{';'});
