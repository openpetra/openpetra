...
At present Ict.Tools.CodeChecker has no command line arguments and runs a fixed set of hard-coded Regular Expressions.
...
CodeChecker returns a result value to the Console (-1 if Exceptions were encountered, 0 if no RegEx matches were found, 
