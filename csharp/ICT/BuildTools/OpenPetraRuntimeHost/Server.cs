...
namespace Ict.Tools.OpenPetraRuntimeHost
{
    ...
    public class Server : MarshalByRefObject
    {
        ...
        /// </summary>
        public Server(int port, string virtualPath, string physicalPath, string defaultPage, bool allowRemoteConnection, bool logPageRequests)
        {
            _port = port;
            ...
            _logPageRequests = logPageRequests;
        }
            ...
            if (host == null)
            {
                lock (this) {
                    ...
                    if (host == null)
                    {
                        ...
                        host.Configure(this, _port, _virtualPath, _physicalPath, _defaultPage, _allowRemoteConnection, _logPageRequests);
                        _host = host;
                    }
                }
            }
