    ...
    public class TPartnerContactDetails : TFixData
    {
        ...
        public static class BestAddressHelper
        {
            ...
            public static DataTable GetNewPPartnerLocationTableInstance()
            {
                ...
                ReturnValue.PrimaryKey = new DataColumn[] { ReturnValue.Columns["p_site_key_n"], ReturnValue.Columns["p_location_key_i"] };
            ...
            public static bool DetermineBestAddress(DataTable APartnerLocationsDT, out Int64 ASiteKey, out int ALocationKey)
            {
                ...
                object[] MethodArguments = new object[] {APartnerLocationsDT, ASiteKey, ALocationKey };
                
                ReturnValue =
                    Convert.ToBoolean(FRemoteClass.InvokeMember("DetermineBestAddress", (BindingFlags.Public | BindingFlags.Static | BindingFlags.InvokeMethod),
            ...
            StreamWriter AWriterTest)
        {
            ...
            foreach (var PPartnerLoctationRec in FPartnerLocationRecords) 
            {
                ...
                else
                {
                    ...
                    {
                        TLogging.Log(
                            String.Format("'Best Address' for the p_parter_location records of Partner with PartnerKey {0} which has {1} p_partner_locations:   p_parter_location SiteKey: {2}; p_parter_location LocationKey: {3}",
                    ...
                    {
                        List<PPartnerAttributeRecord> PPARecordsSingleLocation = ConstructPPartnerAttributeRecords(PartnerKey, SortedRecordsDV[Counter].Row);
