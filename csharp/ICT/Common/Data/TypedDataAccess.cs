    ...
    public class TTypedDataAccess
    {
            ...
            bool ATreatRowAsAdded = false)
        {
            String SqlString = "SELECT " + MODIFICATION_ID + ", " + MODIFIED_BY + ", " + MODIFIED_DATE +
                               ...
                               " WHERE ";
            Boolean First = true;
            TDataBase db = ATransaction.DataBaseObj;
            ...
            DataTable table = db.SelectDT(SqlString, TTypedDataTable.GetTableNameSQL(
            ...
            String ACurrentUser)
        {
            ...
            if (0 == db.ExecuteNonQuery(GenerateUpdateClause("PUB_" + DBTableName,
                        Columns,
                        ADataRow,
                    ...
                    GetParametersForUpdateClause(ATableId, ref ADataRow, PrimKeyColumnOrdList, Columns.Length, ACurrentUser)))
            {
                ...
                if (LastModificationId != MODIFICATION_ID_DELETEDROW_INDICATOR)
                {
                    ...
                    int RowsChanged = db.ExecuteNonQuery(GenerateUpdateClause("PUB_" + DBTableName,
                            Columns,
                            ADataRow,
                            PrimKeyColumnOrdList), ATransaction,
                        GetParametersForUpdateClause(ATableId, ref ADataRow, PrimKeyColumnOrdList, Columns.Length, ACurrentUser));
