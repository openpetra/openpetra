...
namespace Ict.Common
{
    ...
    /// The 'password hash strength' is set to <see cref="PasswordHash.Strength.MediumSlow"/>.
    /// /// IMPORTANT: The name of the Class MUST end with '_V' followed by 3 (gets evaluated in Method
    /// 'GetPasswordSchemeVersionNumber' of Class TPasswordHelper)!!!
    /// </remarks>
    internal class TPasswordHashingScheme_V3 : TPasswordHashingScheme_V2
    {
        /// <summary>
        ...
        /// that gets passed to the PasswordHash.ScryptHashBinary Method (here:  PasswordHash.Strength.MediumSlow)
        ...
        {
            byte[] Hash =
                PasswordHash.ScryptHashBinary(Encoding.Unicode.GetBytes(APassword), ASalt, PasswordHash.Strength.MediumSlow);

            //TPasswordHelper.LogByteArrayContents(Hash, "TPasswordHashingScheme_V3 - Password Hash");
