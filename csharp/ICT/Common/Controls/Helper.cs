...
//                MessageBox.Show("Runtime Mode");
    ...
    public class TIndividualFilterFindPanel
    {
            ...
            string ATag)
        {
            ...
            FFilterComparison = GetFilterComparison(ADBColumnName, ADBColumnDataType);
        ...
        private static string GetFilterComparison(string ADBColumnName, string ADBColumnDataType)
        {
            ...
            else if (ADBColumnDataType == "varchar")
            {
                // text
                return " LIKE '%{0}%'";
            }
    ...
    {
        /// <summary>
        /// A base filter string that is set externally by the host screen to be applied when the Filter Panel is shown
        /// </summary>
        private string FBaseOnFilter = String.Empty;

        /// <summary>
        /// A base filter string that is set externally by the host screen to be applied when the Filter Panel is hidden
        /// </summary>
        private string FBaseOffFilter = String.Empty;
        ...
        public string BaseOnFilter
        {
            ...
            get
            {
                return FBaseOnFilter;
            }
        }

        /// <summary>
        /// Set this value to a filter string that you want to include as part of the overall filter string generated by the users selection of filter controls
        /// while the filter panel is not shown
        /// </summary>
        public string BaseOffFilter
        {
            set
            {
                FBaseOffFilter = value;
            }
            get
            {
                return FBaseOffFilter;
            }
        }
