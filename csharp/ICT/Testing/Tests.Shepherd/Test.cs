...
namespace Ict.Petra.Client.CommonForms.Logic
{
	...
	public class Test
	{
		...
		public void TestTPetraShepherdParseYAMLFileElementsMethod()
		{
			...
			Tests.Shepherd.TestLogicInterface testShepherdInterface = new TestLogicInterface(); 
		...
		{
			Tests.Shepherd.TestLogicInterface thisIsAtest = new TestLogicInterface(); 
		...
		{
			Tests.Shepherd.TestLogicInterface test = new TestLogicInterface(); 
		...
		{
			Tests.Shepherd.TestLogicInterface TestLogicInterface = new Tests.Shepherd.TestLogicInterface(); 
		...
		{
			Tests.Shepherd.TestLogicInterface TestLogicInterface = new TestLogicInterface();
