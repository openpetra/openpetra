...
{
    /// <summary>
    /// test for our own NumericUpDown
    /// </summary>
    public class NumericUpDownTester : ControlTester <NumericUpDown, NumericUpDownTester>
    {
        ...
        /// constructor
        public NumericUpDownTester(string name, string formName) : base(name, formName)
        {
        }

        /// constructor
        public NumericUpDownTester(string name) : base(name)
        {
        }

        /// constructor
        public NumericUpDownTester(NumericUpDownTester tester, int index) : base(tester, index)
        {
        }
        ...
        public new NumericUpDown Properties
        {
            get
            {
                return (NumericUpDown) base.TheObject;
            }
        }
    }
}