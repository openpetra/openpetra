...
namespace Tests.MFinance.Server.Reporting
{
    ...
    public class TAccountDetailTest
    {
        ...
        public void TestAccountDetail()
        {
            ...
            Parameters.Add("param_start_date", new TVariant(new DateTime(DateTime.Today.Year, 1, 1)));
            Parameters.Add("param_end_date", new TVariant(new DateTime(DateTime.Today.Year, 1, 31)));
