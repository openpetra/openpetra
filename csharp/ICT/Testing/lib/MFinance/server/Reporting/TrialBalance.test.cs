...
namespace Tests.MFinance.Server.Reporting
{
    ...
    [TestFixture]
    public class TTrialBalanceTest
    {
        /// <summary>
        ...
        /// </summary>
        [Test]
        public void TestTrialBalanceSelectedAccount()
        {
            string testFile = "../../js-client/src/forms/Finance/GeneralLedger/Reports/TrialBalance.json";
            string resultFile = "../../csharp/ICT/Testing/lib/MFinance/server/Reporting/TestData/TrialBalanceSelectedAccount.Results.html";
            int LedgerNumber = 43;
            TParameterList SpecificParameters = new TParameterList();
