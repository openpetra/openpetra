...
INSERT INTO a_gift_batch (a_ledger_number_i, a_bank_account_code_c, a_batch_number_i, a_batch_description_c, a_batch_year_i, a_currency_code_c, a_bank_cost_centre_c, a_gl_effective_date_d, a_exchange_rate_to_Base_n, a_batch_total_n, a_batch_status_c)
   VALUES (9997, '0100', 15, 'NUnit Batch 15', 0, 'EUR', '5555', '2000-08-01', 0.5155000000, 25000, 'Posted');
INSERT INTO a_gift_batch (a_ledger_number_i, a_bank_account_code_c, a_batch_number_i, a_batch_description_c, a_batch_year_i, a_currency_code_c, a_bank_cost_centre_c, a_gl_effective_date_d, a_exchange_rate_to_Base_n, a_batch_total_n, a_batch_status_c)
   VALUES (9997, '0100', 16, 'NUnit Batch 16', 0, 'EUR', '5555', '2000-08-08', 0.5155000000, 30000, 'Posted');
   
   -- Next two are same date/rate so will result in '2 usages' for gift, and also same date/rate/time as a Journal
INSERT INTO a_gift_batch (a_ledger_number_i, a_bank_account_code_c, a_batch_number_i, a_batch_description_c, a_batch_year_i, a_currency_code_c, a_bank_cost_centre_c, a_gl_effective_date_d, a_exchange_rate_to_Base_n, a_batch_total_n, a_batch_status_c)
   VALUES (9997, '0100', 17, 'NUnit Batch 17', 0, 'EUR', '5555', '2000-08-28', 0.5155000000, 15000, 'Posted');
INSERT INTO a_gift_batch (a_ledger_number_i, a_bank_account_code_c, a_batch_number_i, a_batch_description_c, a_batch_year_i, a_currency_code_c, a_bank_cost_centre_c, a_gl_effective_date_d, a_exchange_rate_to_Base_n, a_batch_total_n, a_batch_status_c)
   VALUES (9997, '0100', 18, 'NUnit Batch 18', 0, 'EUR', '5555', '2000-08-28', 0.5155000000, 15000, 'Posted');
   
   -- The next two are same date but different rates.  No journal
INSERT INTO a_gift_batch (a_ledger_number_i, a_bank_account_code_c, a_batch_number_i, a_batch_description_c, a_batch_year_i, a_currency_code_c, a_bank_cost_centre_c, a_gl_effective_date_d, a_exchange_rate_to_Base_n, a_batch_total_n, a_batch_status_c)
   VALUES (9997, '0100', 19, 'NUnit Batch 19', 0, 'EUR', '5555', '2000-08-30', 0.5185000000, 15000, 'Posted');
INSERT INTO a_gift_batch (a_ledger_number_i, a_bank_account_code_c, a_batch_number_i, a_batch_description_c, a_batch_year_i, a_currency_code_c, a_bank_cost_centre_c, a_gl_effective_date_d, a_exchange_rate_to_Base_n, a_batch_total_n, a_batch_status_c)
   VALUES (9997, '0100', 20, 'NUnit Batch 20', 0, 'EUR', '5555', '2000-08-30', 0.5195000000, 15000, 'Posted');


-- Insert unposted gift batch data
   -- Standalone gift batch using the rate we have used before but a different date
INSERT INTO a_gift_batch (a_ledger_number_i, a_bank_account_code_c, a_batch_number_i, a_batch_description_c, a_batch_year_i, a_currency_code_c, a_bank_cost_centre_c, a_gl_effective_date_d, a_exchange_rate_to_Base_n, a_batch_total_n, a_batch_status_c)
   VALUES (9997, '0100', 21, 'NUnit Batch 21', 0, 'EUR', '5555', '2000-10-01', 0.5155000000, 25000, 'Unposted');

   -- This matches an entry in DER
INSERT INTO a_gift_batch (a_ledger_number_i, a_bank_account_code_c, a_batch_number_i, a_batch_description_c, a_batch_year_i, a_currency_code_c, a_bank_cost_centre_c, a_gl_effective_date_d, a_exchange_rate_to_Base_n, a_batch_total_n, a_batch_status_c)
   VALUES (9997, '0100', 22, 'NUnit Batch 22', 0, 'EUR', '5555', '2000-10-05', 0.5225000000, 25000, 'Unposted');
   
--INSERT INTO a_gift_batch (a_ledger_number_i, a_bank_account_code_c, a_batch_number_i, a_batch_description_c, a_batch_year_i, a_currency_code_c, a_bank_cost_centre_c, a_gl_effective_date_d, a_exchange_rate_to_Base_n, a_batch_total_n, a_batch_status_c)
--   VALUES (9997, '0100', 23, 'NUnit Batch 23', 0, 'EUR', '5555', '2000-10-09', 0.5225000000, 25000, 'Unposted');
--INSERT INTO a_gift_batch (a_ledger_number_i, a_bank_account_code_c, a_batch_number_i, a_batch_description_c, a_batch_year_i, a_currency_code_c, a_bank_cost_centre_c, a_gl_effective_date_d, a_exchange_rate_to_Base_n, a_batch_total_n, a_batch_status_c)
--   VALUES (9997, '0100', 24, 'NUnit Batch 24', 0, 'EUR', '5555', '2000-10-15', 0.5225000000, 25000, 'Unposted');
...
INSERT INTO a_journal (a_ledger_number_i, a_batch_number_i, a_journal_number_i, a_journal_description_c, a_sub_system_code_c, a_transaction_currency_c, a_base_currency_c, a_date_effective_d, a_exchange_rate_to_base_n, a_journal_status_c)
   VALUES (9997, 101, 1, 'GL Batch 101 + J1', 'GR', 'EUR', 'BEF', '2000-08-01', 0.5155000000, 'Posted');

   -- The next two are stand-alone journal entries with same rate but different dates
INSERT INTO a_journal (a_ledger_number_i, a_batch_number_i, a_journal_number_i, a_journal_description_c, a_sub_system_code_c, a_transaction_currency_c, a_base_currency_c, a_date_effective_d, a_exchange_rate_to_base_n, a_journal_status_c)
   VALUES (9997, 102, 1, 'GL Batch 102 + J1 has a much longer description', 'GR', 'EUR', 'BEF', '2000-08-08', 0.5155000000, 'Posted');
INSERT INTO a_journal (a_ledger_number_i, a_batch_number_i, a_journal_number_i, a_journal_description_c, a_sub_system_code_c, a_transaction_currency_c, a_base_currency_c, a_date_effective_d, a_exchange_rate_to_base_n, a_journal_status_c)
   VALUES (9997, 103, 1, 'GL Batch 103 + J1', 'GR', 'EUR', 'BEF', '2000-08-28', 0.5155000000, 'Posted');
...
INSERT INTO a_journal (a_ledger_number_i, a_batch_number_i, a_journal_number_i, a_journal_description_c, a_sub_system_code_c, a_transaction_currency_c, a_base_currency_c, a_date_effective_d, a_exchange_rate_to_base_n, a_journal_status_c)
   VALUES (9997, 111, 1, 'GL Batch 111 + J1', 'GL', 'EUR', 'BEF', '2000-10-22', 0.5225000000, 'Unposted');
   
   -- standalone entry using same rate but different date
INSERT INTO a_journal (a_ledger_number_i, a_batch_number_i, a_journal_number_i, a_journal_description_c, a_sub_system_code_c, a_transaction_currency_c, a_base_currency_c, a_date_effective_d, a_exchange_rate_to_base_n, a_journal_status_c)
   VALUES (9997, 112, 1, 'GL Batch 112 + J1', 'GL', 'EUR', 'BEF', '2000-10-26', 0.5225000000, 'Unposted');

   -- Same rate/date, different journals and same time
INSERT INTO a_journal (a_ledger_number_i, a_batch_number_i, a_journal_number_i, a_journal_description_c, a_sub_system_code_c, a_transaction_currency_c, a_base_currency_c, a_date_effective_d, a_exchange_rate_to_base_n, a_journal_status_c)
   VALUES (9997, 113, 1, 'GL Batch 113 + J1', 'GL', 'EUR', 'BEF', '2000-10-27', 0.5225000000, 'Unposted');
INSERT INTO a_journal (a_ledger_number_i, a_batch_number_i, a_journal_number_i, a_journal_description_c, a_sub_system_code_c, a_transaction_currency_c, a_base_currency_c, a_date_effective_d, a_exchange_rate_to_base_n, a_journal_status_c)
   VALUES (9997, 113, 2, 'GL Batch 113 + J2', 'GL', 'EUR', 'BEF', '2000-10-27', 0.5225000000, 'Unposted');
...
INSERT INTO a_journal (a_ledger_number_i, a_batch_number_i, a_journal_number_i, a_journal_description_c, a_sub_system_code_c, a_transaction_currency_c, a_base_currency_c, a_date_effective_d, a_exchange_rate_time_i, a_exchange_rate_to_base_n, a_journal_status_c)
   VALUES (9997, 114, 1, 'GL Batch 114 + J1', 'GL', 'EUR', 'BEF', '2000-10-28', 7200, 0.5225000000, 'Unposted');
INSERT INTO a_journal (a_ledger_number_i, a_batch_number_i, a_journal_number_i, a_journal_description_c, a_sub_system_code_c, a_transaction_currency_c, a_base_currency_c, a_date_effective_d, a_exchange_rate_time_i, a_exchange_rate_to_base_n, a_journal_status_c)
   VALUES (9997, 114, 2, 'GL Batch 114 + J2', 'GL', 'EUR', 'BEF', '2000-10-28', 14400, 0.5225000000, 'Unposted');

   -- Two different rates on the same date and same time
INSERT INTO a_journal (a_ledger_number_i, a_batch_number_i, a_journal_number_i, a_journal_description_c, a_sub_system_code_c, a_transaction_currency_c, a_base_currency_c, a_date_effective_d, a_exchange_rate_to_base_n, a_journal_status_c)
   VALUES (9997, 115, 1, 'GL Batch 115 + J1', 'GL', 'EUR', 'BEF', '2000-10-30', 0.5245000000, 'Unposted');
INSERT INTO a_journal (a_ledger_number_i, a_batch_number_i, a_journal_number_i, a_journal_description_c, a_sub_system_code_c, a_transaction_currency_c, a_base_currency_c, a_date_effective_d, a_exchange_rate_to_base_n, a_journal_status_c)
   VALUES (9997, 115, 2, 'GL Batch 115 + J2', 'GL', 'EUR', 'BEF', '2000-10-30', 0.5275000000, 'Unposted');
