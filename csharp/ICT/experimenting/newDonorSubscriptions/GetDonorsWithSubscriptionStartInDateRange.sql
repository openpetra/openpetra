...
AND PUB_p_subscription.p_publication_code_c = "MAGAZINE"
...
AND PUB_m_extract_master.m_extract_name_c = "MAGAZINE"
...
ORDER BY PUB_p_partner.p_partner_short_name_c, PUB_a_gift_batch.a_gl_effective_date_d