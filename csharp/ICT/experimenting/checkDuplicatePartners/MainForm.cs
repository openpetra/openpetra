...
namespace Ict.Petra.Client.MPartner.Gui
{
  ...
  /// auto generated: Check Duplicate Partners
  public partial class TFrmMainForm: System.Windows.Forms.Form, Ict.Petra.Client.CommonForms.IFrmPetra
  {
    ...
    public TFrmMainForm(IntPtr AParentFormHandle) : base()
    {
      ...
      this.tbbRunCheck.Text = Catalog.GetString("Run Check");
      this.tbbCancel.Text = Catalog.GetString("Cancel");
      ...
      this.Text = Catalog.GetString("Check Duplicate Partners");
      #endregion
...
#region Action Handling
    ...
    {
        if (e.ActionName == "actRunCheck")
        {
            tbbRunCheck.Enabled = e.Enabled;
        }
        if (e.ActionName == "actCancel")
        {
            tbbCancel.Enabled = e.Enabled;
        }
