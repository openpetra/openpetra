...
class Program
{
    ...
    /// <summary>
    /// sample call: mono anniversaries.exe -username:*** -password:*** -startdate:01/06/2009 -enddate:30/06/2009 -specialbirthdays:50,60,70,75,80,85,90,95,100,105,110,115 -specialanniversary:20,25,30,35,40,45,50,55 -Server.RDBMSType:Progress
    // -Server.ODBC_DSN:petra2_2
    /// /// </summary>
