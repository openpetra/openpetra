  ...
  <include name=""{0}.dll""/>"                                                            ;
        ...
        private void WriteNantFiles()
        {
            ...
            foreach (AssemblyData assembly in _assembly2data.Values)
            {
                ...
                {
                    refs += string.Format(NANT_FILE_REFERENCE_INC_TEMPLATE, used);
                }
            ...
            if (!referenceAdded)   // references were not added, but nant need them
            {
                targets = @"
...
"                                                                  + targets;
            ...
            swRefs.Write(string.Format(NANT_FILE_REFS_DEPS_TEMPLATE, DATE_TIME_STRING, nsDefault, targets));
            swRefs.Close();
        }
