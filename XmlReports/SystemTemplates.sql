...
');
INSERT INTO s_report_template (s_template_id_i,s_report_type_c,s_report_variant_c,s_author_c,s_default_l,s_readonly_l,s_xml_text_c)
VALUES(4,'Cost Centre Hierarchy','Cost Centre Hierarchy template','System',True,True,
'<?xml version="1.0" encoding="utf-8"?>
<Report ScriptLanguage="CSharp" DoublePass="true" ReportInfo.Created="11/05/2013 15:46:27" ReportInfo.Modified="06/27/2014 10:23:00" ReportInfo.CreatorVersion="2014.2.1.0">
  <ScriptText>using System;
using System.Collections;
using System.Collections.Generic;
using System.ComponentModel;
...
namespace FastReport
{
  public class ReportScript
  {
    ...
    private void Data_BeforePrint(object sender, EventArgs e)
    {
      CCCode.Left = Units.Millimeters * (((Int32)Report.GetColumnValue(&quot;CostCentreHierarchy.CostCentreLevel&quot;)) * 5);
      CCName.Left = Units.Millimeters * (((Int32)Report.GetColumnValue(&quot;CostCentreHierarchy.CostCentreLevel&quot;)) * 5)
        + CCCode.Width;
    }
  ...
  <ReportPage Name="Page1">
    ...
    <DataBand Name="list" Top="41.13" Width="718.2" Height="18.9" CanGrow="true" BeforePrintEvent="Data_BeforePrint" KeepChild="true" DataSource="CostCentreHierarchy" KeepDetail="true">
      <TextObject Name="CCCode" Left="18.9" Width="122.85" Height="18.9" CanBreak="false" Text="[CostCentreHierarchy.a_cost_centre_code_c]" AutoShrink="FontSize" AutoShrinkMinSize="5" WordWrap="false" Font="Arial, 9pt">
        <Highlight>
          <Condition Expression="[CostCentreHierarchy.a_posting_cost_centre_flag_l]" Font="Arial, 9.75pt, style=Bold" ApplyTextFill="false" ApplyFont="true"/>
      ...
      <TextObject Name="CCName" Left="141.75" Width="264.6" Height="18.9" CanBreak="false" Text="[CostCentreHierarchy.a_cost_centre_name_c]" AutoShrink="FontSize" AutoShrinkMinSize="5" WordWrap="false" Font="Arial, 9pt">
        <Highlight>
          <Condition Expression="[CostCentreHierarchy.a_posting_cost_centre_flag_l]" Font="Arial, 9.75pt, style=Bold" ApplyTextFill="false" ApplyFont="true"/>
          <Condition Expression="![CostCentreHierarchy.a_posting_cost_centre_flag_l]" Border.Lines="Bottom" Fill.Color="LightGray" ApplyFill="true" ApplyTextFill="false"/>
        </Highlight>
    ...
    <PageFooterBand Name="PageFooter1" Top="63.37" Width="718.2" Height="18.9">
      <TextObject Name="Text17" Left="548.1" Width="170.1" Height="18.9" Text="[PageNofM]" HorzAlign="Right" Font="Arial, 9pt, style=Bold"/>
    </PageFooterBand>
  </ReportPage>
</Report>
');
INSERT INTO s_report_template (s_template_id_i,s_report_type_c,s_report_variant_c,s_author_c,s_default_l,s_readonly_l,s_xml_text_c)
VALUES(5,'Account Hierarchy','Account Hierarchy template','System',True,True,
'﻿<?xml version="1.0" encoding="utf-8"?>
<Report ScriptLanguage="CSharp" DoublePass="true" ReportInfo.Created="11/05/2013 15:46:27" ReportInfo.Modified="06/27/2014 15:13:28" ReportInfo.CreatorVersion="2014.2.1.0">
  <ScriptText>using System;
using System.Collections;
using System.Collections.Generic;
using System.ComponentModel;
...
namespace FastReport
{
  public class ReportScript
  {
    ...
    private void Data_BeforePrint(object sender, EventArgs e)
    {
      AccountCode.Left = Units.Millimeters * (((Int32)Report.GetColumnValue(&quot;AccountHierarchy.AccountLevel&quot;)) * 5);
      AccountName.Left = Units.Millimeters * (((Int32)Report.GetColumnValue(&quot;AccountHierarchy.AccountLevel&quot;)) * 5)
        + AccountCode.Width;
    }
  ...
  <ReportPage Name="Page1">
    ...
    <DataBand Name="list" Top="41.13" Width="718.2" Height="18.9" CanGrow="true" BeforePrintEvent="Data_BeforePrint" KeepChild="true" DataSource="AccountHierarchy" KeepDetail="true">
      <TextObject Name="AccountCode" Left="18.9" Width="122.85" Height="18.9" CanBreak="false" Text="[AccountHierarchy.a_account_code_c]" AutoShrink="FontSize" AutoShrinkMinSize="5" WordWrap="false" Font="Arial, 9pt">
        <Highlight>
          <Condition Expression="[AccountHierarchy.a_posting_status_l]" Font="Arial, 9.75pt, style=Bold" ApplyTextFill="false" ApplyFont="true"/>
      ...
      <TextObject Name="AccountName" Left="141.75" Width="264.6" Height="18.9" CanBreak="false" Text="[AccountHierarchy.a_account_code_short_desc_c]" AutoShrink="FontSize" AutoShrinkMinSize="5" WordWrap="false" Font="Arial, 9pt" Trimming="EllipsisWord">
        <Highlight>
          <Condition Expression="[AccountHierarchy.a_posting_status_l]" Font="Arial, 9.75pt, style=Bold" ApplyTextFill="false" ApplyFont="true"/>
          <Condition Expression="![AccountHierarchy.a_posting_status_l]" Border.Lines="Bottom" Fill.Color="LightGray" ApplyFill="true" ApplyTextFill="false"/>
        </Highlight>
      </TextObject>
      <ChildBand Name="Child1" Top="63.37" Width="718.2" Height="15.12">
        <TextObject Name="Text2" Left="368.55" Width="245.7" Height="15.12" CanBreak="false" Text="[AccountHierarchy.AnalysisAttribute.a_analysis_type_code_c]" Padding="0, 0, 0, 0" AutoShrink="FontSize" AutoShrinkMinSize="5" WordWrap="false" Font="Arial, 8pt" TextFill.Color="ForestGreen" Trimming="EllipsisWord"/>
      </ChildBand>
    </DataBand>
    <PageFooterBand Name="PageFooter1" Top="81.82" Width="718.2" Height="18.9">
      <TextObject Name="Text17" Left="548.1" Width="170.1" Height="18.9" Text="[PageNofM]" HorzAlign="Right" Font="Arial, 9pt, style=Bold"/>
    </PageFooterBand>
  </ReportPage>
</Report>
