...
class AnnualReportWithoutAnnualReceiptRecipients {
	constructor() {
	}
	...
	calculate_report() {
		...
		reports.calculate_report_common("forms/Partner/Reports/PartnerReports/AnnualReportWithoutAnnualReceiptRecipients.json", params);
	}
...
export default new AnnualReportWithoutAnnualReceiptRecipients();
