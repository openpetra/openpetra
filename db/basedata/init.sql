...
COPY p_type_category FROM '{#ABSOLUTEBASEDATAPATH}/p_type_category.csv' WITH DELIMITER AS ',' NULL AS '?' CSV QUOTE AS '"' ESCAPE AS '"';
...
COPY p_consent_channel FROM '{#ABSOLUTEBASEDATAPATH}/p_consent_channel.csv' WITH DELIMITER AS ',' NULL AS '?' CSV QUOTE AS '"' ESCAPE AS '"';
COPY p_consent_purpose FROM '{#ABSOLUTEBASEDATAPATH}/p_consent_purpose.csv' WITH DELIMITER AS ',' NULL AS '?' CSV QUOTE AS '"' ESCAPE AS '"';
