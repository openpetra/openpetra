...
DELETE FROM pm_application_forms_file;
...
DELETE FROM a_thisyearold_trans_anal_attrib;
DELETE FROM a_this_year_old_transaction;
DELETE FROM a_prev_year_trans_anal_attrib;
DELETE FROM a_previous_year_transaction;
...
DELETE FROM pm_long_term_support_figures;
DELETE FROM pm_passport_details;
DELETE FROM pm_document;
DELETE FROM pm_application_forms;
...
DELETE FROM a_this_year_old_journal;
DELETE FROM a_previous_year_journal;
...
DELETE FROM p_form_letter_insert;
...
DELETE FROM pt_reports;
DELETE FROM pm_commitment_status;
DELETE FROM pt_vision_level;
DELETE FROM pt_vision_area;
...
DELETE FROM pt_office_specific_data_labels;
...
DELETE FROM a_this_year_old_batch;
DELETE FROM a_prev_year_corp_ex_rate;
DELETE FROM a_previous_year_batch;
...
DELETE FROM p_label;
DELETE FROM p_form_letter_design;
DELETE FROM p_form_letter_body;
...
DELETE FROM s_error_message;
DELETE FROM s_batch_job;
DELETE FROM s_system_defaults;
DELETE FROM s_user_defaults;
DELETE FROM s_system_status_log;
DELETE FROM s_system_status;
DELETE FROM s_selected_output_destination;
DELETE FROM s_report_options;
DELETE FROM s_report_file;
