...
namespace Ict.Tools.Mantis.CloseResolvedBugs
{
    ...
    class MantisCloseResolvedBugs
    {
        ...
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine("call: MantisCloseResolvedBugs.exe -sf-username:pokorra -sf-pwd:xyz -bugs-csv-file:resolvedbugs.csv -version-fixed-in-earlier-than:\"Alpha 0.2.20\"");
                return;
            }
