...
try
{
    ...
    {
        string LimitToPath = TAppSettingsManager.GetValue("Server.PathData") + Path.DirectorySeparatorChar;
        string Filename = LimitToPath + HttpContext.Current.Request.Params["directory"] + Path.DirectorySeparatorChar + Path.GetFileName(HttpContext.Current.Request.Params["id"]);
        Filename = Path.GetFullPath(Filename);
        if (!Filename.StartsWith(Path.GetFullPath(LimitToPath)))
        {
            throw new Exception("violation of path rules");
        }
